 ...
 */
@RequestMapping("/shipping/engine/description")
@RestController
public class ShippingEngineDescriptionController extends BaseRestController {
		...
		try {
			...
			return new ResponseEntity<>(
				new JSONObject(
					...
					"description",
					getLanguageProperty(locale, "shipping-engine-description")
				).toString(),
				HttpStatus.OK);
		}
	...
	private static final Log _log = LogFactory.getLog(
		ShippingEngineDescriptionController.class);
