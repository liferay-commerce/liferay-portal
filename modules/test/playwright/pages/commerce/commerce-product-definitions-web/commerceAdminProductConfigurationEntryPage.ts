...
export class CommerceAdminProductConfigurationEntryPage {
	...
	constructor(page: Page) {
		...
		this.allowedOrderQuantitiesInput = this.iframe.getByTestId('allowedOrderQuantitiesInput');
		this.backOrdersInput = this.iframe.getByTestId('backOrdersInput');
		this.commerceAvailabilityEstimateIdInput = this.iframe.getByTestId('commerceAvailabilityEstimateIdInput');
		this.CPDefinitionInventoryEngineInput = this.iframe.getByTestId('CPDefinitionInventoryEngineInput');
		this.CPTaxCategoryIdInput = this.iframe.getByTestId('CPTaxCategoryIdInput');
		this.depthInput = this.iframe.getByTestId('depthInput');
		this.displayAvailabilityInput = this.iframe.getByTestId('displayAvailabilityInput');
		this.displayStockQuantityInput = this.iframe.getByTestId('displayStockQuantityInput');
		this.freeShippingInput = this.iframe.getByTestId('freeShippingInput');
		this.heightInput = this.iframe.getByTestId('heightInput');
		this.lowStockActivityInput = this.iframe.getByTestId('lowStockActivityInput');
		this.maxOrderQuantityInput = this.iframe.getByTestId('maxOrderQuantityInput');
		this.minOrderQuantityInput = this.iframe.getByTestId('minOrderQuantityInput');
		this.minStockQuantityInput = this.iframe.getByTestId('minStockQuantityInput');
		this.multipleOrderQuantityInput = this.iframe.getByTestId('multipleOrderQuantityInput');
		...
		this.shipSeparatelyInput = this.iframe.getByTestId('shipSeparatelyInput');
