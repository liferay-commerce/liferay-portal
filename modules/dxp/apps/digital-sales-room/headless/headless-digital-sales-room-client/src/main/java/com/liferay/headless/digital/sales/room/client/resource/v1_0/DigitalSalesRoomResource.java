...
public interface DigitalSalesRoomResource {
	...
	public HttpInvoker.HttpResponse deleteDigitalSalesRoomHttpResponse(
	...
	public HttpInvoker.HttpResponse
			getDigitalSalesRoomTemplateDigitalSalesRoomsPageHttpResponse(
				Long digitalSalesRoomTemplateId)
		throws Exception;
	...
	public HttpInvoker.HttpResponse patchDigitalSalesRoomHttpResponse(
			Long digitalSalesRoomId, DigitalSalesRoom digitalSalesRoom)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			patchDigitalSalesRoomByExternalReferenceCodeHttpResponse(
				String externalReferenceCode, DigitalSalesRoom digitalSalesRoom)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postDigitalSalesRoomTemplateDigitalSalesRoomHttpResponse(
				Long digitalSalesRoomTemplateId,
				DigitalSalesRoom digitalSalesRoom)
		throws Exception;
	...
	public static class DigitalSalesRoomResourceImpl
		...
		public void deleteDigitalSalesRoom(Long digitalSalesRoomId)
			...
			HttpInvoker.HttpResponse httpResponse =
				deleteDigitalSalesRoomHttpResponse(digitalSalesRoomId);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-digital-sales-room/v1.0/digital-sales-rooms/by-external-reference-code/{externalReferenceCode}");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-digital-sales-room/v1.0/digital-sales-room-templates/{digitalSalesRoomTemplateId}/digital-sales-rooms");
		...
		public DigitalSalesRoom patchDigitalSalesRoom(
			...
			HttpInvoker.HttpResponse httpResponse =
				patchDigitalSalesRoomHttpResponse(
		...
		public DigitalSalesRoom patchDigitalSalesRoomByExternalReferenceCode(
			...
			HttpInvoker.HttpResponse httpResponse =
				patchDigitalSalesRoomByExternalReferenceCodeHttpResponse(
					externalReferenceCode, digitalSalesRoom);
