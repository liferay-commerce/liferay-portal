...
public class DownloadObjectEntryFolderServletTest {
	...
	private ObjectDefinition _getObjectDefinitionByExternalReferenceCode()
		throws Exception {
	...
	private ObjectEntryFolder _getParentObjectEntryFolder() throws Exception {
	...
	private void _testDownloadBulkActionWithBulkActionItems() throws Exception {
		...
		ObjectDefinition objectDefinition =
			_getObjectDefinitionByExternalReferenceCode();
