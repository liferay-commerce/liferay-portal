...
@Sync
public class BulkActionTaskReportDisplayContextTest
	...
	private Object _getSectionDisplayContext(
		...
		Object bulkActionTaskReportDisplayContext =
			httpServletRequest.getAttribute(
				"com.liferay.site.cms.site.initializer.internal.display." +
					"context.BulkActionTaskReportDisplayContext");

		Assert.assertNotNull(bulkActionTaskReportDisplayContext);

		return bulkActionTaskReportDisplayContext;
	}

	@Inject(
		filter = "component.name=com.liferay.site.cms.site.initializer.internal.fragment.renderer.BulkActionTaskReportFragmentRenderer"
	)
