...
public class ObjectFieldInfoFieldConverter {
	...
	public ObjectFieldInfoFieldConverter(
		...
		this(
			ddmExpressionFactory, listTypeEntryLocalService,
			objectConfiguration, objectDefinitionLocalService,
			objectFieldLocalService, objectFieldSettingLocalService,
			objectRelationshipLocalService, objectScopeProviderRegistry,
			objectStateFlowLocalService, objectStateLocalService, portal,
			restContextPathResolverRegistry, null, userLocalService);
	}
