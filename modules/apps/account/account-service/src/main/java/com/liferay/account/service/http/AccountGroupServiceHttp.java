...
public class AccountGroupServiceHttp {
	...
	public static java.util.List<com.liferay.account.model.AccountGroup>
		...
		try {
			MethodKey methodKey = new MethodKey(
				AccountGroupServiceUtil.class, "getAccountGroupsByAccountId",
				_getAccountGroupsByAccountIdParameterTypes5);
	...
	public static int getAccountGroupsByAccountIdCount(
		...
		try {
			MethodKey methodKey = new MethodKey(
				AccountGroupServiceUtil.class,
				"getAccountGroupsByAccountIdCount",
				_getAccountGroupsByAccountIdCountParameterTypes6);
	...
	private static final Class<?>[] _getAccountGroupParameterTypes4 =
		new Class[] {long.class};
	private static final Class<?>[]
		_getAccountGroupsByAccountIdParameterTypes5 = new Class[] {
			long.class, int.class, int.class
		};
	private static final Class<?>[]
		_getAccountGroupsByAccountIdCountParameterTypes6 = new Class[] {
			long.class
		};
