...
public class MoveDefinitionSerDes {
	...
	public static String toJSON(MoveDefinition moveDefinition) {
		...
		if (moveDefinition.getCmsEntryDefinitions() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			for (int i = 0; i < moveDefinition.getCmsEntryDefinitions().length;
				 i++) {

				sb.append(
					String.valueOf(moveDefinition.getCmsEntryDefinitions()[i]));

				if ((i + 1) < moveDefinition.getCmsEntryDefinitions().length) {
					sb.append(", ");
				}
			}
	...
	public static Map<String, String> toMap(MoveDefinition moveDefinition) {
		...
		if (moveDefinition.getCmsEntryDefinitions() == null) {
			...
			map.put(
				"cmsEntryDefinitions",
				String.valueOf(moveDefinition.getCmsEntryDefinitions()));
		}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "objectEntryFolderId")) {
				...
				if (jsonParserFieldValue != null) {
					...
					moveDefinition.setCmsEntryDefinitions(
