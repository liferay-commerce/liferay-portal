...
public class BulkActionTaskSerDes {
	...
	public static String toJSON(BulkActionTask bulkActionTask) {
		...
		if (bulkActionTask.getBulkActionTaskId() != null) {
			...
			sb.append(bulkActionTask.getBulkActionTaskId());
		}
	...
	public static Map<String, String> toMap(BulkActionTask bulkActionTask) {
		...
		if (bulkActionTask.getBulkActionTaskId() == null) {
			map.put("bulkActionTaskId", null);
		}
		else {
			map.put(
				"bulkActionTaskId",
				String.valueOf(bulkActionTask.getBulkActionTaskId()));
		}
	...
	public static class BulkActionTaskJSONParser
		...
		protected boolean parseMaps(String jsonParserFieldName) {
			if (Objects.equals(jsonParserFieldName, "bulkActionTaskId")) {
				return false;
			}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "bulkActionTaskId")) {
				if (jsonParserFieldValue != null) {
					bulkActionTask.setBulkActionTaskId(
