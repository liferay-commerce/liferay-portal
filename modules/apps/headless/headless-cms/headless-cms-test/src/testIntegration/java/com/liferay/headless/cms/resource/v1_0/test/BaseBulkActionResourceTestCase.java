...
public abstract class BaseBulkActionResourceTestCase {
	...
	protected void assertContains(Object bulkAction, List<Object> bulkActions) {
		boolean contains = false;

		for (Object item : bulkActions) {
	...
	protected void assertEquals(Object bulkAction1, Object bulkAction2) {
		Assert.assertTrue(
	...
	protected void assertEquals(
		List<Object> bulkActions1, List<Object> bulkActions2) {

		Assert.assertEquals(bulkActions1.size(), bulkActions2.size());

		for (int i = 0; i < bulkActions1.size(); i++) {
			Object bulkAction1 = bulkActions1.get(i);
			Object bulkAction2 = bulkActions2.get(i);
	...
	protected void assertEqualsIgnoringOrder(
		...
		for (Object bulkAction1 : bulkActions1) {
			boolean contains = false;

			for (Object bulkAction2 : bulkActions2) {
	...
	protected void assertValid(Object bulkAction) throws Exception {
		boolean valid = true;
	...
	protected void assertValid(
		...
		java.util.Collection<Object> bulkActions = page.getItems();
	...
	protected void assertValid(BulkActionTask bulkActionTask) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("bulkActionTaskId", additionalAssertFieldName)) {
				if (bulkActionTask.getBulkActionTaskId() == null) {
					valid = false;
				}
	...
	protected boolean equals(Object bulkAction1, Object bulkAction2) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("bulkActionTaskId", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						bulkActionTask1.getBulkActionTaskId(),
						bulkActionTask2.getBulkActionTaskId())) {
	...
	protected String getFilterString(
		EntityField entityField, String operator, Object bulkAction) {
	...
	protected BulkActionTask randomBulkActionTask() throws Exception {
		return new BulkActionTask() {
			{
				bulkActionTaskId = RandomTestUtil.randomLong();
			}
		};
	}
