...
public class BulkActionTask implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The bulk action task ID."
	)
	public Long getBulkActionTaskId() {
		if (_bulkActionTaskIdSupplier != null) {
			bulkActionTaskId = _bulkActionTaskIdSupplier.get();

			_bulkActionTaskIdSupplier = null;
		}
	...
	public void setBulkActionTaskId(
		...
		_bulkActionTaskIdSupplier = () -> {
			try {
				return bulkActionTaskIdUnsafeSupplier.get();
			}
	...
	@GraphQLField(description = "The bulk action task ID.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected Long bulkActionTaskId;

	@JsonIgnore
	private Supplier<Long> _bulkActionTaskIdSupplier;
	...
	public String toString() {
		...
		Long bulkActionTaskId = getBulkActionTaskId();

		if (bulkActionTaskId != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}

			sb.append("\"bulkActionTaskId\": ");
