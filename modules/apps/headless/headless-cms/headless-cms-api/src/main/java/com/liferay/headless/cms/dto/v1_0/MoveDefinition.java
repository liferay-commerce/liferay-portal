 ...
 */
@Generated("")
@GraphQLName("MoveDefinition")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "MoveDefinition")
public class MoveDefinition
	extends BulkActionDefinition implements Serializable {

	public static MoveDefinition toDTO(String json) {
		return ObjectMapperUtil.readValue(MoveDefinition.class, json);
	}

	public static MoveDefinition unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(MoveDefinition.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.cms.dto.v1_0.MoveDefinition",
		name = "x-class-name"
	)
