 ...
 */
@Generated("")
@GraphQLName("PermissionDefinition")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "PermissionDefinition")
public class PermissionDefinition
	extends BulkActionDefinition implements Serializable {

	public static PermissionDefinition toDTO(String json) {
		return ObjectMapperUtil.readValue(PermissionDefinition.class, json);
	}

	public static PermissionDefinition unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			PermissionDefinition.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.cms.dto.v1_0.PermissionDefinition",
		name = "x-class-name"
	)
