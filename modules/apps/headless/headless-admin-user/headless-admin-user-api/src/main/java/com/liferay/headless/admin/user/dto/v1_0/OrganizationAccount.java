...
public class OrganizationAccount implements Serializable {
	...
	@Schema(
		...
		defaultValue = "com.liferay.headless.admin.user.dto.v1_0.OrganizationAccount",
		name = "x-class-name"
	)
