...
public abstract class BaseAccountGroupResourceTestCase {
	...
	public void testGetAccountGroupsPageWithFilterDoubleEquals()
		...
		for (EntityField entityField : entityFields) {
			Page<AccountGroup> page = accountGroupResource.getAccountGroupsPage(
				null, getFilterString(entityField, "eq", accountGroup1),
				Pagination.of(1, 2), null);
	...
	public void testGetAccountByExternalReferenceCodeAccountGroupsPage()
		...
		String accountExternalReferenceCode =
			testGetAccountByExternalReferenceCodeAccountGroupsPage_getAccountExternalReferenceCode();
		String irrelevantAccountExternalReferenceCode =
			testGetAccountByExternalReferenceCodeAccountGroupsPage_getIrrelevantAccountExternalReferenceCode();
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("description")) {
			sb.append("'");
			sb.append(String.valueOf(accountGroup.getDescription()));
			sb.append("'");
