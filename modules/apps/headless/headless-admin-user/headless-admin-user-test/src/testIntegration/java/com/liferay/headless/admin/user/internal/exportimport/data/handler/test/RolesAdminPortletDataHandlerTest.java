...
public class RolesAdminPortletDataHandlerTest {
	...
	@Test
	public void testExportImportRolesWithReprovisionedObjectDefinition()
		throws Exception {
	...
	private void _deleteObjectDefinition() throws Exception {
		_objectDefinitionLocalService.deleteObjectDefinition(
			_objectDefinition.getObjectDefinitionId());
	...
	private void _deleteRole() throws Exception {
		_roleLocalService.deleteRole(_role.getRoleId());

		_role = null;
	}

	private File _exportRoles() throws Exception {
				...
				addDraftExportImportConfiguration(
					...
					ExportImportConfigurationSettingsMapFactoryUtil.
						buildExportLayoutSettingsMap(
							...
							false, new long[0], _getParameterMap())));
	}
