...
public abstract class BaseUserAccountResourceTestCase {
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		Assert.assertEquals(regex, userAccount.getLanguage());
	...
	protected boolean equals(
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("language", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						userAccount1.getLanguage(),
						userAccount2.getLanguage())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("language")) {
			Object object = userAccount.getLanguage();
