...
public abstract class BaseUserAccountResourceTestCase {
	...
	public void testPatchAccountByExternalReferenceCodeUserAccountByExternalReferenceCode()
		...
		@SuppressWarnings("PMD.UnusedLocalVariable")
		UserAccount userAccount =
			testPatchAccountByExternalReferenceCodeUserAccountByExternalReferenceCode_addUserAccount();

		assertHttpResponseStatusCode(
			204,
			userAccountResource.
				patchAccountByExternalReferenceCodeUserAccountByExternalReferenceCodeHttpResponse(
					null, userAccount.getExternalReferenceCode(), userAccount));
	...
	public void testPatchAccountUserAccount() throws Exception {
		@SuppressWarnings("PMD.UnusedLocalVariable")
		UserAccount userAccount = testPatchAccountUserAccount_addUserAccount();

		assertHttpResponseStatusCode(
			204,
			userAccountResource.patchAccountUserAccountHttpResponse(
				null, userAccount.getId(), userAccount));
	...
	protected UserAccount testPatchAccountUserAccount_addUserAccount()
		throws Exception {
