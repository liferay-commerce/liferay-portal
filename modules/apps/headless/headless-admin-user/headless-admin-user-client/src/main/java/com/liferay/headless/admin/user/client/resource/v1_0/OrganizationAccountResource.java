 ...
 */
@Generated("")
public interface OrganizationAccountResource {
	...
	public static class Builder {
		...
		public OrganizationAccountResource build() {
			return new OrganizationAccountResourceImpl(this);
		}
	...
	public static class OrganizationAccountResourceImpl
		implements OrganizationAccountResource {
		...
		public Page<OrganizationAccount> getOrganizationAccountsPage(
			...
			try {
				return Page.of(content, OrganizationAccountSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private OrganizationAccountResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			OrganizationAccountResource.class.getName());
