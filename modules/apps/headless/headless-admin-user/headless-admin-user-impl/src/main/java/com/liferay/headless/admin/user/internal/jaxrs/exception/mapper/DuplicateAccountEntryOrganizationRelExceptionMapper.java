...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.DuplicateAccountEntryOrganizationRelExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class DuplicateAccountEntryOrganizationRelExceptionMapper
	extends BaseExceptionMapper<DuplicateAccountEntryOrganizationRelException> {
