...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Admin.User.UserAccountScreenNameMustValidateExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class UserAccountScreenNameMustValidateExceptionMapper
	extends BaseExceptionMapper<UserScreenNameException.MustValidate> {
