...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Admin.User.UserAccountScreenNameMustNotBeReservedExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class UserAccountScreenNameMustNotBeReservedExceptionMapper
	extends BaseExceptionMapper<UserScreenNameException.MustNotBeReserved> {
