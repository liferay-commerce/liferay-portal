...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Admin.User.OrganizationNameMustNotExceedMaximumLengthExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class OrganizationNameMustNotExceedMaximumLengthExceptionMapper
