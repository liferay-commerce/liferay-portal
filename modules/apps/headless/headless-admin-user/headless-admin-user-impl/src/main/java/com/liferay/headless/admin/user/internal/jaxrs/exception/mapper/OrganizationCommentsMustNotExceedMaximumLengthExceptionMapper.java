...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Admin.User.OrganizationCommentsMustNotExceedMaximumLengthExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class OrganizationCommentsMustNotExceedMaximumLengthExceptionMapper
	extends BaseExceptionMapper
		<OrganizationCommentsException.MustNotExceedMaximumLength> {
