...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Admin.User.UserAccountScreenNameMustNotBeNumericExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class UserAccountScreenNameMustNotBeNumericExceptionMapper
	extends BaseExceptionMapper<UserScreenNameException.MustNotBeNumeric> {
