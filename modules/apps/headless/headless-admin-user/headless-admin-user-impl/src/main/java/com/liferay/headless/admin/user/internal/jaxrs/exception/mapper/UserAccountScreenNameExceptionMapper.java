...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Admin.User.UserAccountScreenNameExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class UserAccountScreenNameExceptionMapper
	extends BaseExceptionMapper<UserScreenNameException> {

	@Override
	protected Problem getProblem(
		UserScreenNameException userScreenNameException) {
