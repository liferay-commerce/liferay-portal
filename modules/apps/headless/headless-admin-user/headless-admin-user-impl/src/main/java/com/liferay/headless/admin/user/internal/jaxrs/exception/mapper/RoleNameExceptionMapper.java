...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Admin.User.RoleNameExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class RoleNameExceptionMapper
	extends BaseExceptionMapper<RoleNameException> {

	@Override
	protected Problem getProblem(RoleNameException roleNameException) {
		return new Problem(
