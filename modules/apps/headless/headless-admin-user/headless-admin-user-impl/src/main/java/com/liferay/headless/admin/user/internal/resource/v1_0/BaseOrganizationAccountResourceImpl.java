...
@Generated("")
@Path("/v1.0")
public abstract class BaseOrganizationAccountResourceImpl
	implements EntityModelResource, OrganizationAccountResource,
			   VulcanBatchEngineTaskItemDelegate<OrganizationAccount> {
	...
	@Tags(value = {@Tag(name = "OrganizationAccount")})
	...
	@Override
	public Page<OrganizationAccount> read(
