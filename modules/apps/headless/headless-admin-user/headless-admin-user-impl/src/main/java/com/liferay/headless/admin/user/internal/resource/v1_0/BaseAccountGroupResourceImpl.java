...
public abstract class BaseAccountGroupResourceImpl
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-admin-user/v1.0/accountGroups/by-external-reference-code/{externalReferenceCode}/accounts/by-external-reference-code/{accountExternalReferenceCode}'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path(
		"/accountGroups/by-external-reference-code/{externalReferenceCode}/accounts/by-external-reference-code/{accountExternalReferenceCode}"
	)
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public void
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-admin-user/v1.0/accountGroups/by-external-reference-code/{externalReferenceCode}/accounts/by-external-reference-code/{accountExternalReferenceCode}'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
