...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Admin.User.UserAccountEmailAddressMustValidateExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class UserAccountEmailAddressMustValidateExceptionMapper
