...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Admin.User.UserAccountScreenNameMustNotBeReservedForAnonymousExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class UserAccountScreenNameMustNotBeReservedForAnonymousExceptionMapper
