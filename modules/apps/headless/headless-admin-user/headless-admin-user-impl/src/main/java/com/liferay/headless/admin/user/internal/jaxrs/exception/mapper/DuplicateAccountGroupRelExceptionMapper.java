...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.DuplicateAccountGroupRelExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class DuplicateAccountGroupRelExceptionMapper
	extends BaseExceptionMapper<DuplicateAccountGroupRelException> {

	@Override
	protected Problem getProblem(
		DuplicateAccountGroupRelException duplicateAccountGroupRelException) {
