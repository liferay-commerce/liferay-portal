...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Admin.User.UserAccountPasswordMustNotBeNullExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class UserAccountPasswordMustNotBeNullExceptionMapper
	extends BaseExceptionMapper<UserPasswordException.MustNotBeNull> {
