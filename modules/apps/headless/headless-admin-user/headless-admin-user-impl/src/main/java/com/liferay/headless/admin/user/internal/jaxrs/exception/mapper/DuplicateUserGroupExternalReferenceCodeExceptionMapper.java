...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Admin.User.DuplicateUserGroupExternalReferenceCodeExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class DuplicateUserGroupExternalReferenceCodeExceptionMapper
	...
	protected Problem getProblem(
		...
		return new Problem(
			...
			_language.get(
				...
				"a-user-group-already-exists-with-the-same-external-" +
					"reference-code"));
	}
