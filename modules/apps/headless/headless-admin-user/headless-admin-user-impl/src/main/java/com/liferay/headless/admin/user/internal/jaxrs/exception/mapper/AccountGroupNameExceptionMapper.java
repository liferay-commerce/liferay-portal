...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Admin.User.AccountGroupNameExceptionMapper"
	},
...
public class AccountGroupNameExceptionMapper
	...
	protected Problem getProblem(
		AccountGroupNameException accountGroupNameException) {

		return new Problem(
			Response.Status.BAD_REQUEST,
			_language.get(
				_acceptLanguage.getPreferredLocale(),
				"the-account-group-name-is-invalid"));
	}
