...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Admin.User.UserAccountMustHaveFirstNameExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class UserAccountMustHaveFirstNameExceptionMapper
	extends BaseExceptionMapper<ContactNameException.MustHaveFirstName> {
