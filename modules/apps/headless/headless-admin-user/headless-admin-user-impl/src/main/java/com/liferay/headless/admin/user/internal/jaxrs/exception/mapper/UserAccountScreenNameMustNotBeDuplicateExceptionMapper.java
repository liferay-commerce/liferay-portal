...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Admin.User.UserAccountScreenNameMustNotBeDuplicateExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class UserAccountScreenNameMustNotBeDuplicateExceptionMapper
	extends BaseExceptionMapper<UserScreenNameException.MustNotBeDuplicate> {
