...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Admin.User.UserAccountScreenNameMustProduceValidFriendlyURLExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class UserAccountScreenNameMustProduceValidFriendlyURLExceptionMapper
