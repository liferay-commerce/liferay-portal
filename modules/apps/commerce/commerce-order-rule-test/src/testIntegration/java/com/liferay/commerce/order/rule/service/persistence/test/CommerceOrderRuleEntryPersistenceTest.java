...
public class CommerceOrderRuleEntryPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newCommerceOrderRuleEntry.setExclusive(RandomTestUtil.randomBoolean());
		...
		Assert.assertEquals(
			existingCommerceOrderRuleEntry.isExclusive(),
			newCommerceOrderRuleEntry.isExclusive());
		Assert.assertEquals(
	...
	protected OrderByComparator<CommerceOrderRuleEntry> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"CommerceOrderRuleEntry", "commerceOrderRuleEntryId", true,
			"companyId", true, "userId", true, "userName", true, "createDate",
			true, "modifiedDate", true, "active", true, "description", true,
			"exclusive", true, "name", true, "priority", true, "type", true,
			"typeSettings", true, "displayDate", true, "expirationDate", true,
	...
	protected CommerceOrderRuleEntry addCommerceOrderRuleEntry()
		...
		commerceOrderRuleEntry.setExclusive(RandomTestUtil.randomBoolean());
