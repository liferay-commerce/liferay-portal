...
public class CommerceDiscountUtil {
	 ...
	 * @throws NoSuchDiscountException if a matching commerce discount could not be found
	 */
	public static CommerceDiscount findByC_A_C(
			long companyId, boolean active, String couponCode)
		throws com.liferay.commerce.discount.exception.NoSuchDiscountException {

		return getPersistence().findByC_A_C(companyId, active, couponCode);
	}
	 ...
	 */
	public static CommerceDiscount fetchByC_A_C(
		long companyId, boolean active, String couponCode) {

		return getPersistence().fetchByC_A_C(companyId, active, couponCode);
	}
	...
	public static CommerceDiscount fetchByC_A_C(
		...
		return getPersistence().fetchByC_A_C(
			companyId, active, couponCode, useFinderCache);
	}
	 ...
	 */
	public static CommerceDiscount removeByC_A_C(
			long companyId, boolean active, String couponCode)
		throws com.liferay.commerce.discount.exception.NoSuchDiscountException {

		return getPersistence().removeByC_A_C(companyId, active, couponCode);
	}
	...
	public static int countByC_A_C(
		...
		return getPersistence().countByC_A_C(companyId, active, couponCode);
	}
	 ...
	 * @return the matching commerce discounts
	 */
	public static List<CommerceDiscount> findByC_A_L_S(
		long companyId, boolean active, String level, int status) {

		return getPersistence().findByC_A_L_S(companyId, active, level, status);
	}
	...
	public static List<CommerceDiscount> findByC_A_L_S(
		...
		return getPersistence().findByC_A_L_S(
	 ...
	 * @throws NoSuchDiscountException if a matching commerce discount could not be found
	 */
	public static CommerceDiscount findByC_A_L_S_First(
			long companyId, boolean active, String level, int status,
			OrderByComparator<CommerceDiscount> orderByComparator)
		throws com.liferay.commerce.discount.exception.NoSuchDiscountException {

		return getPersistence().findByC_A_L_S_First(
	 ...
	 * @return the first matching commerce discount, or <code>null</code> if a matching commerce discount could not be found
	 */
	public static CommerceDiscount fetchByC_A_L_S_First(
		long companyId, boolean active, String level, int status,
		OrderByComparator<CommerceDiscount> orderByComparator) {

		return getPersistence().fetchByC_A_L_S_First(
			companyId, active, level, status, orderByComparator);
	}
	 ...
	 * @throws NoSuchDiscountException if a matching commerce discount could not be found
	 */
	public static CommerceDiscount findByC_A_L_S_Last(
			long companyId, boolean active, String level, int status,
			OrderByComparator<CommerceDiscount> orderByComparator)
		throws com.liferay.commerce.discount.exception.NoSuchDiscountException {

		return getPersistence().findByC_A_L_S_Last(
			companyId, active, level, status, orderByComparator);
	}
	 ...
	 * @return the last matching commerce discount, or <code>null</code> if a matching commerce discount could not be found
	 */
	public static CommerceDiscount fetchByC_A_L_S_Last(
		long companyId, boolean active, String level, int status,
		OrderByComparator<CommerceDiscount> orderByComparator) {

		return getPersistence().fetchByC_A_L_S_Last(
			companyId, active, level, status, orderByComparator);
	}
	 ...
	 * @throws NoSuchDiscountException if a commerce discount with the primary key could not be found
	 */
	public static CommerceDiscount[] findByC_A_L_S_PrevAndNext(
			long commerceDiscountId, long companyId, boolean active,
			String level, int status,
			OrderByComparator<CommerceDiscount> orderByComparator)
		throws com.liferay.commerce.discount.exception.NoSuchDiscountException {

		return getPersistence().findByC_A_L_S_PrevAndNext(
	 ...
	 * @return the matching commerce discounts that the user has permission to view
	 */
	public static List<CommerceDiscount> filterFindByC_A_L_S(
		long companyId, boolean active, String level, int status) {

		return getPersistence().filterFindByC_A_L_S(
	 ...
	 * @throws NoSuchDiscountException if a commerce discount with the primary key could not be found
	 */
	public static CommerceDiscount[] filterFindByC_A_L_S_PrevAndNext(
			long commerceDiscountId, long companyId, boolean active,
			String level, int status,
			OrderByComparator<CommerceDiscount> orderByComparator)
		throws com.liferay.commerce.discount.exception.NoSuchDiscountException {

		return getPersistence().filterFindByC_A_L_S_PrevAndNext(
			commerceDiscountId, companyId, active, level, status,
			orderByComparator);
	}
	 ...
	 * @param status the status
	 */
	public static void removeByC_A_L_S(
		long companyId, boolean active, String level, int status) {

		getPersistence().removeByC_A_L_S(companyId, active, level, status);
	}
	 ...
	 * @return the number of matching commerce discounts
	 */
	public static int countByC_A_L_S(
		long companyId, boolean active, String level, int status) {

		return getPersistence().countByC_A_L_S(
			companyId, active, level, status);
	}
	 ...
	 * @return the number of matching commerce discounts that the user has permission to view
	 */
	public static int filterCountByC_A_L_S(
		long companyId, boolean active, String level, int status) {

		return getPersistence().filterCountByC_A_L_S(
			companyId, active, level, status);
	}
