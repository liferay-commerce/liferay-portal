 ...
 */
@Component(
	property = "frontend.data.set.name=" + CommerceShippingFixedOptionFDSNames.ACCOUNT_ENTRY_SHIPPING_OPTIONS,
	service = FDSView.class
)
public class
	ShippingOptionCommerceChannelAccountEntryRelTableFDSViewTableFDSView
