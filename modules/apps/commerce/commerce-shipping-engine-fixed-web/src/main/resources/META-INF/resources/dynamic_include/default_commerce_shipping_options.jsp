		...
		<div class="form-group-item">
			<div class="sheet-text">
				<frontend-data-set:classic-display
					...
					%>'
					dataProviderKey="<%= CommerceShippingFixedOptionFDSNames.ACCOUNT_ENTRY_SHIPPING_OPTIONS %>"
					id="<%= CommerceShippingFixedOptionFDSNames.ACCOUNT_ENTRY_SHIPPING_OPTIONS %>"
					itemsPerPage="<%= 10 %>"
				/>
			</div>
		</div>
