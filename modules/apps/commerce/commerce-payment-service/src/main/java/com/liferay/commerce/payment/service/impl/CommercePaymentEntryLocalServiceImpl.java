...
public class CommercePaymentEntryLocalServiceImpl
	...
	public CommercePaymentEntry addCommercePaymentEntry(
		...
		_validate(classNameId, commercePaymentEntryRefundType, reasonKey, type);
	...
	public CommercePaymentEntry updateCommercePaymentEntry(
		...
		_validate(
			...
			commercePaymentEntryRefundType, reasonKey, type);
	...
	public CommercePaymentEntry updateCommercePaymentEntryReasonKey(
		...
		_validate(
			commercePaymentEntry.getClassNameId(),
			commercePaymentEntryRefundType, reasonKey,
