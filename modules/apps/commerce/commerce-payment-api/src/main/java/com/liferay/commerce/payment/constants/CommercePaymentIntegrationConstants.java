...
public class CommercePaymentIntegrationConstants {
	...
	public static final int TYPE_CLIENT_EXTENSION_OFFLINE = 5;

	public static final int TYPE_CLIENT_EXTENSION_ONLINE_REDIRECT = 4;

	public static final int TYPE_CLIENT_EXTENSION_ONLINE_STANDARD = 3;
	...
	public static final int[] TYPES_CLIENT_EXTENSION = {
		TYPE_CLIENT_EXTENSION_OFFLINE, TYPE_CLIENT_EXTENSION_ONLINE_REDIRECT,
		TYPE_CLIENT_EXTENSION_ONLINE_STANDARD
	};
