...
public class CommercePaymentEntryTable
	...
	public final Column<CommercePaymentEntryTable, Long> channelId =
		createColumn(
	...
	public final Column<CommercePaymentEntryTable, String> paymentMethodKey =
		createColumn(
			"paymentMethodKey", String.class, Types.VARCHAR,
			Column.FLAG_DEFAULT);
	public final Column<CommercePaymentEntryTable, Integer> paymentMethodType =
		createColumn(
			"paymentMethodType", Integer.class, Types.INTEGER,
			Column.FLAG_DEFAULT);
