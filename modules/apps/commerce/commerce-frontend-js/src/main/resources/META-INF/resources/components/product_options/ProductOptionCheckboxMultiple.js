			...
			(productOptionValue) => {
				...
				if (isFromMiniCart) {
					...
					if (productOptionValue.preselected) {
						preselected = true;
						selected = true;
						skuOptionValueName = [productOptionValue.name];
		...
		if (currentSkuOption) {
			...
			currentSkuOptions = [
				...currentSkuOptions,
				{
					...
					skuOptionKey: productOption.key,
					skuOptionName: productOption.name,
					skuOptionValueName: [curProductOptionValue.name],
					value: [value],
				},
			];
		}
