...
@Component(
	...
	service = CommercePricingClassPortletResourcePermissionRegistrar.class
)
public class CommercePricingClassPortletResourcePermissionRegistrar {
	...
	protected void activate(BundleContext bundleContext) {
		...
		properties.put(
			"resource.name", CommercePricingClassConstants.RESOURCE_NAME);
