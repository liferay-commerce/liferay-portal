...
public class CommerceOrderServiceHttp {
	...
	public static void deleteAttachment(
		...
		try {
			MethodKey methodKey = new MethodKey(
				CommerceOrderServiceUtil.class, "deleteAttachment",
				_deleteAttachmentParameterTypes5);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, attachmentId, commerceOrderId);
	...
	private static final Class<?>[] _deleteAttachmentParameterTypes5 =
