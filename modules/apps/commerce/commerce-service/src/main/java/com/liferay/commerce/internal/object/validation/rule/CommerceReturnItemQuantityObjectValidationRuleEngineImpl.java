...
public class CommerceReturnItemQuantityObjectValidationRuleEngineImpl
	...
	public static final String QUANTITY_VALIDATION_RULE_ENGINE =
		"commerce-return-item-quantity-validation-rule-engine";
	...
	public String getKey() {
		return ObjectValidationRuleConstants.ENGINE_TYPE_JAVA_DELEGATE_PREFIX +
			QUANTITY_VALIDATION_RULE_ENGINE;
	}

	@Override
	public String getLabel(Locale locale) {
		return _language.get(locale, QUANTITY_VALIDATION_RULE_ENGINE);
	}
