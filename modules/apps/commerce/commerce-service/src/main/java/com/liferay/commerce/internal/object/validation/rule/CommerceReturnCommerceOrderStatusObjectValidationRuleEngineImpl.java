...
public class CommerceReturnCommerceOrderStatusObjectValidationRuleEngineImpl
	...
	public static final String COMMERCE_ORDER_STATUS_VALIDATION_RULE_ENGINE =
	...
	public String getKey() {
		return ObjectValidationRuleConstants.ENGINE_TYPE_JAVA_DELEGATE_PREFIX +
			COMMERCE_ORDER_STATUS_VALIDATION_RULE_ENGINE;
	}

	@Override
	public String getLabel(Locale locale) {
		return _language.get(
			locale, COMMERCE_ORDER_STATUS_VALIDATION_RULE_ENGINE);
	}
