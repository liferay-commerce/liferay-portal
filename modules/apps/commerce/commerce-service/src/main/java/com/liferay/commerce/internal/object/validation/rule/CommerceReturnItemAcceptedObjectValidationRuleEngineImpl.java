...
public class CommerceReturnItemAcceptedObjectValidationRuleEngineImpl
	implements ObjectDefinitionScoped, ObjectValidationRuleEngine {

	public static final String ACCEPTED_VALIDATION_RULE_ENGINE =
		"commerce-return-item-accepted-validation-rule-engine";
		...
		return HashMapBuilder.<String, Object>put(
			...
			() -> {
				...
				return BigDecimalUtil.lte(
					BigDecimal.valueOf(
						GetterUtil.getLong(properties.get("accepted"))),
					BigDecimal.valueOf(
	...
	public String getKey() {
		return ObjectValidationRuleConstants.ENGINE_TYPE_JAVA_DELEGATE_PREFIX +
			ACCEPTED_VALIDATION_RULE_ENGINE;
	}

	@Override
	public String getLabel(Locale locale) {
		return _language.get(locale, ACCEPTED_VALIDATION_RULE_ENGINE);
	}
