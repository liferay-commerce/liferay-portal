...
public class CommerceReturnItemAccountEntryIdObjectValidationRuleEngineImpl
	...
	public static final String ACCOUNT_ENTRY_ID_VALIDATION_RULE_ENGINE =
		"commerce-return-item-account-entry-id-validation-rule-engine";
	...
	public String getKey() {
		return ObjectValidationRuleConstants.ENGINE_TYPE_JAVA_DELEGATE_PREFIX +
			ACCOUNT_ENTRY_ID_VALIDATION_RULE_ENGINE;
	}

	@Override
	public String getLabel(Locale locale) {
		return _language.get(locale, ACCOUNT_ENTRY_ID_VALIDATION_RULE_ENGINE);
	}
