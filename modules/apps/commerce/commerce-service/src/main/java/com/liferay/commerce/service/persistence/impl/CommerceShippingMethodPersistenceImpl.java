...
public class CommerceShippingMethodPersistenceImpl
	 ...
	 */
	@Override
	public List<CommerceShippingMethod> filterFindByGroupId(long groupId) {
	 ...
	 */
	@Override
	public List<CommerceShippingMethod> filterFindByGroupId(
		long groupId, int start, int end) {
	...
	public List<CommerceShippingMethod> filterFindByGroupId(
		...
		if (getDB().isSupportsInlineDistinct()) {
			sb.append(_FILTER_SQL_SELECT_COMMERCESHIPPINGMETHOD_WHERE);
		}
		else {
			sb.append(
				_FILTER_SQL_SELECT_COMMERCESHIPPINGMETHOD_NO_INLINE_DISTINCT_WHERE_1);
		}
		...
		if (!getDB().isSupportsInlineDistinct()) {
			sb.append(
				_FILTER_SQL_SELECT_COMMERCESHIPPINGMETHOD_NO_INLINE_DISTINCT_WHERE_2);
		}
		...
		if (orderByComparator != null) {
			...
			if (getDB().isSupportsInlineDistinct()) {
				...
				sb.append(CommerceShippingMethodModelImpl.ORDER_BY_SQL);
			}
		}

		String sql = InlineSQLHelperUtil.replacePermissionCheck(
			sb.toString(), CommerceShippingMethod.class.getName(),
		...
		try {
			...
			if (getDB().isSupportsInlineDistinct()) {
				sqlQuery.addEntity(
					_FILTER_ENTITY_ALIAS, CommerceShippingMethodImpl.class);
			}
			else {
				sqlQuery.addEntity(
					_FILTER_ENTITY_TABLE, CommerceShippingMethodImpl.class);
			}
			...
			return (List<CommerceShippingMethod>)QueryUtil.list(
	 ...
	 */
	@Override
	public CommerceShippingMethod[] filterFindByGroupId_PrevAndNext(
			long commerceShippingMethodId, long groupId,
			OrderByComparator<CommerceShippingMethod> orderByComparator)
		throws NoSuchShippingMethodException {
	...
	protected CommerceShippingMethod filterGetByGroupId_PrevAndNext(
		Session session, CommerceShippingMethod commerceShippingMethod,
		long groupId,
		OrderByComparator<CommerceShippingMethod> orderByComparator,
		boolean previous) {
		...
		List<CommerceShippingMethod> list = sqlQuery.list();
	...
	public int filterCountByGroupId(long groupId) {
		...
		sb.append(_FILTER_SQL_COUNT_COMMERCESHIPPINGMETHOD_WHERE);
	 ...
	 */
	@Override
	public List<CommerceShippingMethod> filterFindByG_A(
		long groupId, boolean active) {
	 ...
	 */
	@Override
	public CommerceShippingMethod[] filterFindByG_A_PrevAndNext(
			long commerceShippingMethodId, long groupId, boolean active,
			OrderByComparator<CommerceShippingMethod> orderByComparator)
		throws NoSuchShippingMethodException {
	...
	protected CommerceShippingMethod filterGetByG_A_PrevAndNext(
		Session session, CommerceShippingMethod commerceShippingMethod,
		long groupId, boolean active,
		OrderByComparator<CommerceShippingMethod> orderByComparator,
		boolean previous) {
	...
	private static final String _FINDER_COLUMN_G_A_ACTIVE_2_SQL =
		"commerceShippingMethod.active_ = ?";
	...
	private static final String _FILTER_ENTITY_TABLE_FILTER_PK_COLUMN =
		"commerceShippingMethod.commerceShippingMethodId";

	private static final String
		_FILTER_SQL_SELECT_COMMERCESHIPPINGMETHOD_WHERE =
			"SELECT DISTINCT {commerceShippingMethod.*} FROM CommerceShippingMethod commerceShippingMethod WHERE ";

	private static final String
		_FILTER_SQL_SELECT_COMMERCESHIPPINGMETHOD_NO_INLINE_DISTINCT_WHERE_1 =
			"SELECT {CommerceShippingMethod.*} FROM (SELECT DISTINCT commerceShippingMethod.commerceShippingMethodId FROM CommerceShippingMethod commerceShippingMethod WHERE ";

	private static final String
		_FILTER_SQL_SELECT_COMMERCESHIPPINGMETHOD_NO_INLINE_DISTINCT_WHERE_2 =
			") TEMP_TABLE INNER JOIN CommerceShippingMethod ON TEMP_TABLE.commerceShippingMethodId = CommerceShippingMethod.commerceShippingMethodId";

	private static final String _FILTER_SQL_COUNT_COMMERCESHIPPINGMETHOD_WHERE =
		"SELECT COUNT(DISTINCT commerceShippingMethod.commerceShippingMethodId) AS COUNT_VALUE FROM CommerceShippingMethod commerceShippingMethod WHERE ";

	private static final String _FILTER_ENTITY_ALIAS = "commerceShippingMethod";

	private static final String _FILTER_ENTITY_TABLE = "CommerceShippingMethod";
