...
/**
 * Provides the local service interface for CPSOListTypeDefinitionRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Marco Leo
 * @see CPSOListTypeDefinitionRelLocalServiceUtil
 * @generated
 */
@CTAware
@ProviderType
...
public interface CPSOListTypeDefinitionRelLocalService
	extends BaseLocalService, CTService<CPSOListTypeDefinitionRel>,
			PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.commerce.product.service.impl.CPSOListTypeDefinitionRelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the cpso list type definition rel local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CPSOListTypeDefinitionRelLocalServiceUtil} if injection and service tracking are not available.
	 */
