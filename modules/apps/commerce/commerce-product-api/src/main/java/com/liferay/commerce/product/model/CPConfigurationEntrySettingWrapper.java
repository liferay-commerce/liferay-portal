...
public class CPConfigurationEntrySettingWrapper
	...
	public Map<String, Object> getModelAttributes() {
		...
		attributes.put("setting", getSetting());
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		String setting = (String)attributes.get("setting");
	...
	/**
	 * Returns the setting of this cp configuration entry setting.
	 *
	 * @return the setting of this cp configuration entry setting
	 */
	@Override
	...
	/**
	 * Sets the setting of this cp configuration entry setting.
	 *
	 * @param setting the setting of this cp configuration entry setting
	 */
	@Override
