...
/**
 * The base model interface for the CPSOListTypeDefinitionRel service. Represents a row in the &quot;CPSOListTypeDefinitionRel&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.liferay.commerce.product.model.impl.CPSOListTypeDefinitionRelModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.liferay.commerce.product.model.impl.CPSOListTypeDefinitionRelImpl</code>.
 * </p>
 *
 * @author Marco Leo
 ...
 */
@ProviderType
public interface CPSOListTypeDefinitionRelModel
	extends BaseModel<CPSOListTypeDefinitionRel>,
			CTModel<CPSOListTypeDefinitionRel>, MVCCModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a cpso list type definition rel model instance should use the {@link CPSOListTypeDefinitionRel} interface instead.
	 */
