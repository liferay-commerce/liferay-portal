...
public class CommercePriceListServiceHttp {
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				CommercePriceListServiceUtil.class, "findCommercePriceLists",
				_findCommercePriceListsParameterTypes7);
	...
	public static com.liferay.commerce.price.list.model.CommercePriceList
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getCommercePriceListParameterTypes8);
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getCommercePriceListsParameterTypes9);
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				CommercePriceListServiceUtil.class, "getCommercePriceLists",
				_getCommercePriceListsParameterTypes10);
	...
	public static int getCommercePriceListsCount(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getCommercePriceListsCountParameterTypes11);
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				CommercePriceListServiceUtil.class,
				"searchByCommercePricingClassId",
				_searchByCommercePricingClassIdParameterTypes13);
	...
	public static com.liferay.portal.kernel.search.BaseModelSearchResult
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_searchCommercePriceListsParameterTypes14);
	...
	public static int searchCommercePriceListsCount(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_searchCommercePriceListsCountParameterTypes15);
	...
	public static void setCatalogBasePriceList(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_setCatalogBasePriceListParameterTypes16);
	...
	private static final Class<?>[] _fetchCommercePriceListParameterTypes6 =
		new Class[] {long.class};
	private static final Class<?>[] _findCommercePriceListsParameterTypes7 =
		new Class[] {
			long.class, String.class, int.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	private static final Class<?>[] _getCommercePriceListParameterTypes8 =
		new Class[] {long.class};
	private static final Class<?>[] _getCommercePriceListsParameterTypes9 =
		new Class[] {
			long.class, int.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	private static final Class<?>[] _getCommercePriceListsParameterTypes10 =
		new Class[] {
			long.class, String.class, int.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	private static final Class<?>[]
		_getCommercePriceListsCountParameterTypes11 = new Class[] {
	...
	private static final Class<?>[]
		_searchByCommercePricingClassIdParameterTypes13 = new Class[] {
			long.class, String.class, int.class, int.class
		};
	private static final Class<?>[] _searchCommercePriceListsParameterTypes14 =
		new Class[] {
			long.class, String.class, int.class, int.class, int.class,
			com.liferay.portal.kernel.search.Sort.class
		};
	private static final Class<?>[]
		_searchCommercePriceListsCountParameterTypes15 = new Class[] {
			long.class, String.class, int.class
		};
	private static final Class<?>[] _setCatalogBasePriceListParameterTypes16 =
