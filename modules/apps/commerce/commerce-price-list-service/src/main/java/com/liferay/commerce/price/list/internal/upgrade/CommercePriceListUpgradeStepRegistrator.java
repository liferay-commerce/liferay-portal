...
import com.liferay.commerce.price.list.internal.upgrade.v2_1_4.CommercePriceListModelResourcePermissionUpgradeProcess;
...
public class CommercePriceListUpgradeStepRegistrator
	...
	public void register(Registry registry) {
		...
		registry.register(
			"2.1.3", "2.1.4",
			new CommercePriceListModelResourcePermissionUpgradeProcess());
