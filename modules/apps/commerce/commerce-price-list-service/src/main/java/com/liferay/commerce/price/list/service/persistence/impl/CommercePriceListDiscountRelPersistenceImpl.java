...
public class CommercePriceListDiscountRelPersistenceImpl
	...
	protected void clearUniqueFindersCache(
		...
		if ((commercePriceListDiscountRelModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				commercePriceListDiscountRelModelImpl.getColumnOriginalValue(
					"commerceDiscountId"),
				commercePriceListDiscountRelModelImpl.getColumnOriginalValue(
					"commercePriceListId")
			};
	...
	public CommercePriceListDiscountRel updateImpl(
		...
		try {
			...
			if (commercePriceListDiscountRel.isNew()) {
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(
			...
			CommercePriceListDiscountRelModelImpl.getColumnBitmask("uuid_") |
