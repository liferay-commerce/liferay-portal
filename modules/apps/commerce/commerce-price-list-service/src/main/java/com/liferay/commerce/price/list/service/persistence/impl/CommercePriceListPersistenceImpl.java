...
public class CommercePriceListPersistenceImpl
	 ...
	 */
	@Override
	public List<CommercePriceList> findByG_C_T(
	 ...
	 */
	@Override
	public CommercePriceList findByG_C_T_First(
			long groupId, boolean catalogBasePriceList, String type,
			OrderByComparator<CommercePriceList> orderByComparator)
		throws NoSuchPriceListException {

		CommercePriceList commercePriceList = fetchByG_C_T_First(
	 ...
	 */
	@Override
	public CommercePriceList fetchByG_C_T_First(
		long groupId, boolean catalogBasePriceList, String type,
		OrderByComparator<CommercePriceList> orderByComparator) {

		List<CommercePriceList> list = findByG_C_T(
	 ...
	 */
	@Override
	public CommercePriceList findByG_C_T_Last(
			long groupId, boolean catalogBasePriceList, String type,
			OrderByComparator<CommercePriceList> orderByComparator)
		throws NoSuchPriceListException {

		CommercePriceList commercePriceList = fetchByG_C_T_Last(
			groupId, catalogBasePriceList, type, orderByComparator);
	 ...
	 */
	@Override
	public CommercePriceList fetchByG_C_T_Last(
		long groupId, boolean catalogBasePriceList, String type,
		OrderByComparator<CommercePriceList> orderByComparator) {

		int count = countByG_C_T(groupId, catalogBasePriceList, type);
	 ...
	 */
	@Override
	public CommercePriceList[] findByG_C_T_PrevAndNext(
			long commercePriceListId, long groupId,
	...
	protected CommercePriceList getByG_C_T_PrevAndNext(
		Session session, CommercePriceList commercePriceList, long groupId,
		boolean catalogBasePriceList, String type,
		OrderByComparator<CommercePriceList> orderByComparator,
		boolean previous) {
	 ...
	 */
	@Override
	public List<CommercePriceList> filterFindByG_C_T(
		long groupId, boolean catalogBasePriceList, String type) {
	...
	public List<CommercePriceList> filterFindByG_C_T(
		...
		if (type.isEmpty()) {
			sb.append(_FINDER_COLUMN_G_C_T_TYPE_3_SQL);
		}
		else {
			bindType = true;

			sb.append(_FINDER_COLUMN_G_C_T_TYPE_2_SQL);
		}
	 ...
	 */
	@Override
	public CommercePriceList[] filterFindByG_C_T_PrevAndNext(
			long commercePriceListId, long groupId,
			boolean catalogBasePriceList, String type,
			OrderByComparator<CommercePriceList> orderByComparator)
		throws NoSuchPriceListException {
	...
	protected CommercePriceList filterGetByG_C_T_PrevAndNext(
		Session session, CommercePriceList commercePriceList, long groupId,
		boolean catalogBasePriceList, String type,
		OrderByComparator<CommercePriceList> orderByComparator,
		boolean previous) {
	...
	public int filterCountByG_C_T(
		...
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_C_T(groupId, catalogBasePriceList, type);
		}

		if (isPermissionsInMemoryFilterEnabled()) {
			List<CommercePriceList> commercePriceLists = findByG_C_T(
				groupId, catalogBasePriceList, type);
	...
	private static final String _FINDER_COLUMN_G_C_T_TYPE_2_SQL =
		"commercePriceList.type_ = ?";

	private static final String _FINDER_COLUMN_G_C_T_TYPE_3_SQL =
