 ...
 */
@Component(
	property = "commerce.currency.contributor.key=" + CommerceCurrencyConstantsContributor.COMMERCE_PRICE_LIST,
	service = CommerceCurrencyContributor.class
)
public class CommercePriceListCommerceCurrencyContributor
	...
	public void check(CommerceCurrency commerceCurrency)
		...
		int commercePriceListsCount =
			_commercePriceListLocalService.getCommercePriceListsCount(
				commerceCurrency.getCommerceCurrencyId());

		if (commercePriceListsCount > 0) {
