...
<div class="pt-4">
	<aui:form action="<%= portletURL.toString() %>" cssClass="container-fluid-1280" method="post" name="fm">
		...
		<clay:headless-data-set-display
			...
			clayDataSetActionDropdownItems="<%= commercePromotionDisplayContext.getDiscountClayDataSetActionDropdownItems() %>"
			creationMenu="<%= commercePromotionDisplayContext.getDiscountCreationMenu() %>"
			formId="fm"
			id="<%= CommercePricingDataSetConstants.COMMERCE_DATA_SET_KEY_PROMOTIONS %>"
			itemsPerPage="<%= 10 %>"
