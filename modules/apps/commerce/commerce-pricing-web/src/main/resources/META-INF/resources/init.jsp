...
page import="com.liferay.commerce.pricing.web.internal.constants.CommercePromotionScreenNavigationConstants" %><%@
...
page import="com.liferay.commerce.pricing.web.internal.display.context.CommercePricingClassPromotionDisplayContext" %><%@
page import="com.liferay.commerce.pricing.web.internal.display.context.CommercePromotionDisplayContext" %><%@
page import="com.liferay.commerce.pricing.web.internal.display.context.CommercePromotionQualifiersDisplayContext" %><%@
page import="com.liferay.commerce.pricing.web.internal.display.context.CommercePromotionRuleDisplayContext" %><%@
