...
@Component(
	...
	service = CommerceCurrencyPortletResourcePermissionRegistrar.class
)
public class CommerceCurrencyPortletResourcePermissionRegistrar {
	...
	protected void activate(BundleContext bundleContext) {
		...
		properties.put(
			"resource.name", CommerceCurrencyConstants.RESOURCE_NAME);
