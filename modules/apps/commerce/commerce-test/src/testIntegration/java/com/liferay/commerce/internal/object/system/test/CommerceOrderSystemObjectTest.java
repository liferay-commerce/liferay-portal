...
@Sync
public class CommerceOrderSystemObjectTest {
	...
	@Test
	public void testCommerceOrderSystemObject() throws Exception {
		...
		Assert.assertEquals(
			String.valueOf(commerceCurrency.getCode()),
			variables.get("currencyCode"));
