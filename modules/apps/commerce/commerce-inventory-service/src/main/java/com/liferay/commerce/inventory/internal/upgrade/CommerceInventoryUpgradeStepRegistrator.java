...
import com.liferay.commerce.inventory.internal.upgrade.v2_1_1.CommerceInventoryModelResourcePermissionUpgradeProcess;
...
public class CommerceInventoryUpgradeStepRegistrator
	...
	public void register(Registry registry) {
		...
		registry.register(
			"2.1.0", "2.1.1",
			new CommerceInventoryModelResourcePermissionUpgradeProcess());
