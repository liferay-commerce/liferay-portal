 ...
 */
@Component(
	property = "commerce.inventory.audit.type.key=" + CommerceInventoryConstants.AUDIT_TYPE_RESTOCK_QUANTITY,
	service = CommerceInventoryAuditType.class
)
public class RestockQuantityCommerceInventoryAuditTypeImpl
	...
	public String formatLog(long userId, String context, Locale locale)
		...
		return _language.format(
			locale, "x-restocked-the-quantity-from-order-item-x",
			new Object[] {
				user.getFullName(),
				jsonObject.get(
	...
	public String getType() {
		return CommerceInventoryConstants.AUDIT_TYPE_RESTOCK_QUANTITY;
	}
