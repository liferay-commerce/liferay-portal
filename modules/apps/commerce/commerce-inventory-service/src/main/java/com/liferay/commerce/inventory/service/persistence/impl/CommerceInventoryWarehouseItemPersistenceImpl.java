...
public class CommerceInventoryWarehouseItemPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByCIWI_S;
	private FinderPath _finderPathWithoutPaginationFindByCIWI_S;
	private FinderPath _finderPathCountByCIWI_S;
	 ...
	 */
	@Override
	public List<CommerceInventoryWarehouseItem> findByCIWI_S(
		long commerceInventoryWarehouseId, String sku) {

		return findByCIWI_S(
			commerceInventoryWarehouseId, sku, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<CommerceInventoryWarehouseItem> findByCIWI_S(
		...
		return findByCIWI_S(
			commerceInventoryWarehouseId, sku, start, end, null);
	}
	...
	public List<CommerceInventoryWarehouseItem> findByCIWI_S(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByCIWI_S;
				finderArgs = new Object[] {commerceInventoryWarehouseId, sku};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByCIWI_S;
			finderArgs = new Object[] {
				commerceInventoryWarehouseId, sku, start, end, orderByComparator
			};
		}
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_CIWI_S_COMMERCEINVENTORYWAREHOUSEID_2);

			boolean bindSku = false;

			if (sku.isEmpty()) {
				sb.append(_FINDER_COLUMN_CIWI_S_SKU_3);
			}
			else {
				bindSku = true;

				sb.append(_FINDER_COLUMN_CIWI_S_SKU_2);
			}
	 ...
	 */
	@Override
	public CommerceInventoryWarehouseItem findByCIWI_S_First(
			long commerceInventoryWarehouseId, String sku,
			OrderByComparator<CommerceInventoryWarehouseItem> orderByComparator)
		throws NoSuchInventoryWarehouseItemException {
	 ...
	 */
	@Override
	public CommerceInventoryWarehouseItem fetchByCIWI_S_First(
		long commerceInventoryWarehouseId, String sku,
		OrderByComparator<CommerceInventoryWarehouseItem> orderByComparator) {

		List<CommerceInventoryWarehouseItem> list = findByCIWI_S(
			commerceInventoryWarehouseId, sku, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public CommerceInventoryWarehouseItem findByCIWI_S_Last(
			long commerceInventoryWarehouseId, String sku,
			OrderByComparator<CommerceInventoryWarehouseItem> orderByComparator)
		throws NoSuchInventoryWarehouseItemException {
	 ...
	 */
	@Override
	public CommerceInventoryWarehouseItem fetchByCIWI_S_Last(
		long commerceInventoryWarehouseId, String sku,
		OrderByComparator<CommerceInventoryWarehouseItem> orderByComparator) {

		int count = countByCIWI_S(commerceInventoryWarehouseId, sku);
		...
		List<CommerceInventoryWarehouseItem> list = findByCIWI_S(
			commerceInventoryWarehouseId, sku, count - 1, count,
			orderByComparator);
	 ...
	 */
	@Override
	public CommerceInventoryWarehouseItem[] findByCIWI_S_PrevAndNext(
			long commerceInventoryWarehouseItemId,
			long commerceInventoryWarehouseId, String sku,
			OrderByComparator<CommerceInventoryWarehouseItem> orderByComparator)
		throws NoSuchInventoryWarehouseItemException {
		...
		try {
			...
			array[0] = getByCIWI_S_PrevAndNext(
				session, commerceInventoryWarehouseItem,
				commerceInventoryWarehouseId, sku, orderByComparator, true);

			array[1] = commerceInventoryWarehouseItem;

			array[2] = getByCIWI_S_PrevAndNext(
				session, commerceInventoryWarehouseItem,
				commerceInventoryWarehouseId, sku, orderByComparator, false);
	...
	protected CommerceInventoryWarehouseItem getByCIWI_S_PrevAndNext(
		Session session,
		CommerceInventoryWarehouseItem commerceInventoryWarehouseItem,
		long commerceInventoryWarehouseId, String sku,
		OrderByComparator<CommerceInventoryWarehouseItem> orderByComparator,
	 ...
	 */
	@Override
	public void removeByCIWI_S(long commerceInventoryWarehouseId, String sku) {
		for (CommerceInventoryWarehouseItem commerceInventoryWarehouseItem :
				findByCIWI_S(
					commerceInventoryWarehouseId, sku, QueryUtil.ALL_POS,
					QueryUtil.ALL_POS, null)) {
	 ...
	 */
	@Override
	public int countByCIWI_S(long commerceInventoryWarehouseId, String sku) {
		sku = Objects.toString(sku, "");

		FinderPath finderPath = _finderPathCountByCIWI_S;
	...
	private static final String
		_FINDER_COLUMN_CIWI_S_COMMERCEINVENTORYWAREHOUSEID_2 =
			"commerceInventoryWarehouseItem.commerceInventoryWarehouseId = ? AND ";

	private static final String _FINDER_COLUMN_CIWI_S_SKU_2 =
		"commerceInventoryWarehouseItem.sku = ?";

	private static final String _FINDER_COLUMN_CIWI_S_SKU_3 =
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByCIWI_S = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByCIWI_S",
			new String[] {
		...
		_finderPathWithoutPaginationFindByCIWI_S = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByCIWI_S",
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"commerceInventoryWarehouseId", "sku"}, true);

		_finderPathCountByCIWI_S = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByCIWI_S",
			new String[] {Long.class.getName(), String.class.getName()},
