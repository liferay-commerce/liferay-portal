...
create index IX_7FAB2E1E on CPDefinitionLink (CPDefinitionId, status, type_[$COLUMN_LENGTH:75$], ctCollectionId);
...
create index IX_8F54E412 on CPDefinitionLink (CProductId, status, type_[$COLUMN_LENGTH:75$], ctCollectionId);
