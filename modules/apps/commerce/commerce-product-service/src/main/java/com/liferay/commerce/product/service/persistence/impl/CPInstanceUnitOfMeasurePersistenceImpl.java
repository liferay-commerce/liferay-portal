...
public class CPInstanceUnitOfMeasurePersistenceImpl
	...
	public List<CPInstanceUnitOfMeasure> findByK_SKU(
		...
		if (useFinderCache && productionMode) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (CPInstanceUnitOfMeasure cpInstanceUnitOfMeasure : list) {
					if (!key.equals(cpInstanceUnitOfMeasure.getKey()) ||
						!sku.equals(cpInstanceUnitOfMeasure.getSku())) {
	...
	private FinderPath _finderPathWithPaginationFindByC_K_SKU;
	private FinderPath _finderPathWithoutPaginationFindByC_K_SKU;
	private FinderPath _finderPathCountByC_K_SKU;
	 ...
	 */
	@Override
	public List<CPInstanceUnitOfMeasure> findByC_K_SKU(
		long companyId, String key, String sku) {

		return findByC_K_SKU(
	...
	public List<CPInstanceUnitOfMeasure> findByC_K_SKU(
		...
		return findByC_K_SKU(companyId, key, sku, start, end, null);
	}
	...
	public List<CPInstanceUnitOfMeasure> findByC_K_SKU(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache && productionMode) {
				finderPath = _finderPathWithoutPaginationFindByC_K_SKU;
				finderArgs = new Object[] {companyId, key, sku};
			}
		}
		else if (useFinderCache && productionMode) {
			finderPath = _finderPathWithPaginationFindByC_K_SKU;
			finderArgs = new Object[] {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_C_K_SKU_COMPANYID_2);

			boolean bindKey = false;

			if (key.isEmpty()) {
				sb.append(_FINDER_COLUMN_C_K_SKU_KEY_3);
			}
			else {
				bindKey = true;

				sb.append(_FINDER_COLUMN_C_K_SKU_KEY_2);
			}

			boolean bindSku = false;

			if (sku.isEmpty()) {
				sb.append(_FINDER_COLUMN_C_K_SKU_SKU_3);
			}
			else {
				bindSku = true;

				sb.append(_FINDER_COLUMN_C_K_SKU_SKU_2);
			}
	 ...
	 */
	@Override
	public CPInstanceUnitOfMeasure findByC_K_SKU_First(
			long companyId, String key, String sku,
			OrderByComparator<CPInstanceUnitOfMeasure> orderByComparator)
		throws NoSuchCPInstanceUnitOfMeasureException {

		CPInstanceUnitOfMeasure cpInstanceUnitOfMeasure = fetchByC_K_SKU_First(
	 ...
	 */
	@Override
	public CPInstanceUnitOfMeasure fetchByC_K_SKU_First(
		long companyId, String key, String sku,
		OrderByComparator<CPInstanceUnitOfMeasure> orderByComparator) {

		List<CPInstanceUnitOfMeasure> list = findByC_K_SKU(
	 ...
	 */
	@Override
	public CPInstanceUnitOfMeasure findByC_K_SKU_Last(
			long companyId, String key, String sku,
			OrderByComparator<CPInstanceUnitOfMeasure> orderByComparator)
		throws NoSuchCPInstanceUnitOfMeasureException {

		CPInstanceUnitOfMeasure cpInstanceUnitOfMeasure = fetchByC_K_SKU_Last(
			companyId, key, sku, orderByComparator);
	 ...
	 */
	@Override
	public CPInstanceUnitOfMeasure fetchByC_K_SKU_Last(
		long companyId, String key, String sku,
		OrderByComparator<CPInstanceUnitOfMeasure> orderByComparator) {

		int count = countByC_K_SKU(companyId, key, sku);
	 ...
	 */
	@Override
	public CPInstanceUnitOfMeasure[] findByC_K_SKU_PrevAndNext(
		...
		try {
			...
			array[0] = getByC_K_SKU_PrevAndNext(
				session, cpInstanceUnitOfMeasure, companyId, key, sku,
				orderByComparator, true);

			array[1] = cpInstanceUnitOfMeasure;

			array[2] = getByC_K_SKU_PrevAndNext(
				session, cpInstanceUnitOfMeasure, companyId, key, sku,
				orderByComparator, false);
	...
	protected CPInstanceUnitOfMeasure getByC_K_SKU_PrevAndNext(
		Session session, CPInstanceUnitOfMeasure cpInstanceUnitOfMeasure,
		long companyId, String key, String sku,
		OrderByComparator<CPInstanceUnitOfMeasure> orderByComparator,
		boolean previous) {
	 ...
	 */
	@Override
	public void removeByC_K_SKU(long companyId, String key, String sku) {
		for (CPInstanceUnitOfMeasure cpInstanceUnitOfMeasure :
				findByC_K_SKU(
	 ...
	 */
	@Override
	public int countByC_K_SKU(long companyId, String key, String sku) {
		key = Objects.toString(key, "");
		sku = Objects.toString(sku, "");
		...
		if (productionMode) {
			finderPath = _finderPathCountByC_K_SKU;
	...
	private static final String _FINDER_COLUMN_C_K_SKU_COMPANYID_2 =
		"cpInstanceUnitOfMeasure.companyId = ? AND ";

	private static final String _FINDER_COLUMN_C_K_SKU_KEY_2 =
		"cpInstanceUnitOfMeasure.key = ? AND ";

	private static final String _FINDER_COLUMN_C_K_SKU_KEY_3 =
		"(cpInstanceUnitOfMeasure.key IS NULL OR cpInstanceUnitOfMeasure.key = '') AND ";

	private static final String _FINDER_COLUMN_C_K_SKU_SKU_2 =
		"cpInstanceUnitOfMeasure.sku = ?";

	private static final String _FINDER_COLUMN_C_K_SKU_SKU_3 =
		"(cpInstanceUnitOfMeasure.sku IS NULL OR cpInstanceUnitOfMeasure.sku = '')";

	private FinderPath _finderPathWithPaginationFindByC_P_SKU;
	private FinderPath _finderPathWithoutPaginationFindByC_P_SKU;
	private FinderPath _finderPathCountByC_P_SKU;

	/**
	 * Returns all the cp instance unit of measures where companyId = &#63; and primary = &#63; and sku = &#63;.
	 *
	 * @param companyId the company ID
	 ...
	 */
	@Override
	public List<CPInstanceUnitOfMeasure> findByC_P_SKU(
		long companyId, boolean primary, String sku) {

		return findByC_P_SKU(
			companyId, primary, sku, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null);
	}

	/**
	 * Returns a range of all the cp instance unit of measures where companyId = &#63; and primary = &#63; and sku = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>CPInstanceUnitOfMeasureModelImpl</code>.
	 * </p>
	...
	@Override
	public List<CPInstanceUnitOfMeasure> findByC_P_SKU(
		long companyId, boolean primary, String sku, int start, int end) {

		return findByC_P_SKU(companyId, primary, sku, start, end, null);
	}

	/**
	 * Returns an ordered range of all the cp instance unit of measures where companyId = &#63; and primary = &#63; and sku = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>CPInstanceUnitOfMeasureModelImpl</code>.
	 * </p>
	...
	public List<CPInstanceUnitOfMeasure> findByC_P_SKU(
		...
		return findByC_P_SKU(
			companyId, primary, sku, start, end, orderByComparator, true);
	}
	...
	public List<CPInstanceUnitOfMeasure> findByC_P_SKU(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache && productionMode) {
				finderPath = _finderPathWithoutPaginationFindByC_P_SKU;
				finderArgs = new Object[] {companyId, primary, sku};
			}
		}
		else if (useFinderCache && productionMode) {
			finderPath = _finderPathWithPaginationFindByC_P_SKU;
			finderArgs = new Object[] {
				companyId, primary, sku, start, end, orderByComparator
			};
		}
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_C_P_SKU_COMPANYID_2);

			sb.append(_FINDER_COLUMN_C_P_SKU_PRIMARY_2);

			boolean bindSku = false;

			if (sku.isEmpty()) {
				sb.append(_FINDER_COLUMN_C_P_SKU_SKU_3);
			}
			else {
				bindSku = true;

				sb.append(_FINDER_COLUMN_C_P_SKU_SKU_2);
			}
	...
	/**
	 * Returns the first cp instance unit of measure in the ordered set where companyId = &#63; and primary = &#63; and sku = &#63;.
	 *
	 * @param companyId the company ID
	 * @param primary the primary
	 * @param sku the sku
	 ...
	 */
	@Override
	public CPInstanceUnitOfMeasure findByC_P_SKU_First(
			long companyId, boolean primary, String sku,
			OrderByComparator<CPInstanceUnitOfMeasure> orderByComparator)
		throws NoSuchCPInstanceUnitOfMeasureException {

		CPInstanceUnitOfMeasure cpInstanceUnitOfMeasure = fetchByC_P_SKU_First(
			companyId, primary, sku, orderByComparator);
	 ...
	 */
	@Override
	public CPInstanceUnitOfMeasure fetchByC_P_SKU_First(
		long companyId, boolean primary, String sku,
		OrderByComparator<CPInstanceUnitOfMeasure> orderByComparator) {

		List<CPInstanceUnitOfMeasure> list = findByC_P_SKU(
			companyId, primary, sku, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last cp instance unit of measure in the ordered set where companyId = &#63; and primary = &#63; and sku = &#63;.
	 *
	 * @param companyId the company ID
	 * @param primary the primary
	 * @param sku the sku
	 ...
	 */
	@Override
	public CPInstanceUnitOfMeasure findByC_P_SKU_Last(
			long companyId, boolean primary, String sku,
			OrderByComparator<CPInstanceUnitOfMeasure> orderByComparator)
		throws NoSuchCPInstanceUnitOfMeasureException {

		CPInstanceUnitOfMeasure cpInstanceUnitOfMeasure = fetchByC_P_SKU_Last(
			companyId, primary, sku, orderByComparator);
	 ...
	 */
	@Override
	public CPInstanceUnitOfMeasure fetchByC_P_SKU_Last(
		long companyId, boolean primary, String sku,
		OrderByComparator<CPInstanceUnitOfMeasure> orderByComparator) {

		int count = countByC_P_SKU(companyId, primary, sku);
		...
		List<CPInstanceUnitOfMeasure> list = findByC_P_SKU(
			companyId, primary, sku, count - 1, count, orderByComparator);
	...
	/**
	 * Returns the cp instance unit of measures before and after the current cp instance unit of measure in the ordered set where companyId = &#63; and primary = &#63; and sku = &#63;.
	 *
	 * @param CPInstanceUnitOfMeasureId the primary key of the current cp instance unit of measure
	 * @param companyId the company ID
	 * @param primary the primary
	 ...
	 */
	@Override
	public CPInstanceUnitOfMeasure[] findByC_P_SKU_PrevAndNext(
			long CPInstanceUnitOfMeasureId, long companyId, boolean primary,
			String sku,
			OrderByComparator<CPInstanceUnitOfMeasure> orderByComparator)
		throws NoSuchCPInstanceUnitOfMeasureException {
		...
		try {
			...
			array[0] = getByC_P_SKU_PrevAndNext(
				session, cpInstanceUnitOfMeasure, companyId, primary, sku,
				orderByComparator, true);

			array[1] = cpInstanceUnitOfMeasure;

			array[2] = getByC_P_SKU_PrevAndNext(
				session, cpInstanceUnitOfMeasure, companyId, primary, sku,
				orderByComparator, false);
	...
	protected CPInstanceUnitOfMeasure getByC_P_SKU_PrevAndNext(
		Session session, CPInstanceUnitOfMeasure cpInstanceUnitOfMeasure,
		long companyId, boolean primary, String sku,
		OrderByComparator<CPInstanceUnitOfMeasure> orderByComparator,
		boolean previous) {
	...
	/**
	 * Removes all the cp instance unit of measures where companyId = &#63; and primary = &#63; and sku = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @param primary the primary
	 * @param sku the sku
	 */
	@Override
	public void removeByC_P_SKU(long companyId, boolean primary, String sku) {
		for (CPInstanceUnitOfMeasure cpInstanceUnitOfMeasure :
				findByC_P_SKU(
					companyId, primary, sku, QueryUtil.ALL_POS,
	...
	/**
	 * Returns the number of cp instance unit of measures where companyId = &#63; and primary = &#63; and sku = &#63;.
	 *
	 * @param companyId the company ID
	 * @param primary the primary
	 * @param sku the sku
	 ...
	 */
	@Override
	public int countByC_P_SKU(long companyId, boolean primary, String sku) {
		sku = Objects.toString(sku, "");
		...
		if (productionMode) {
			finderPath = _finderPathCountByC_P_SKU;
	...
	private static final String _FINDER_COLUMN_C_P_SKU_COMPANYID_2 =
		"cpInstanceUnitOfMeasure.companyId = ? AND ";

	private static final String _FINDER_COLUMN_C_P_SKU_PRIMARY_2 =
		"cpInstanceUnitOfMeasure.primary = ? AND ";

	private static final String _FINDER_COLUMN_C_P_SKU_SKU_2 =
		"cpInstanceUnitOfMeasure.sku = ?";

	private static final String _FINDER_COLUMN_C_P_SKU_SKU_3 =
		"(cpInstanceUnitOfMeasure.sku IS NULL OR cpInstanceUnitOfMeasure.sku = '')";
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByC_K_SKU = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_K_SKU",
			new String[] {
				Long.class.getName(), String.class.getName(),
				String.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByC_K_SKU = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_K_SKU",
			new String[] {
				Long.class.getName(), String.class.getName(),
		...
		_finderPathCountByC_K_SKU = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_K_SKU",
			new String[] {
				Long.class.getName(), String.class.getName(),
				String.class.getName()
			},
		...
		_finderPathWithPaginationFindByC_P_SKU = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_P_SKU",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				String.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
			new String[] {"companyId", "primary_", "sku"}, true);

		_finderPathWithoutPaginationFindByC_P_SKU = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_P_SKU",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				String.class.getName()
			},
		...
		_finderPathCountByC_P_SKU = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_P_SKU",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				String.class.getName()
			},
			new String[] {"companyId", "primary_", "sku"}, false);
