...
public class CommerceChannelRelServiceHttp {
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				CommerceChannelRelServiceUtil.class,
				"getCommerceChannelCommerceCurrencies",
				_getCommerceChannelCommerceCurrenciesParameterTypes7);
	...
	public static int getCommerceChannelCommerceCurrenciesCount(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getCommerceChannelCommerceCurrenciesCountParameterTypes8);
	...
	private static final Class<?>[]
		_getCommerceChannelCommerceCurrenciesParameterTypes7 = new Class[] {
			long.class, String.class, int.class, int.class
		};
	private static final Class<?>[]
		_getCommerceChannelCommerceCurrenciesCountParameterTypes8 =
