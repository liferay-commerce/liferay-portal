...
public class CommerceChannelAccountEntryRelServiceHttp {
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				CommerceChannelAccountEntryRelServiceUtil.class,
				"getCommerceChannelAccountEntryRels",
				_getCommerceChannelAccountEntryRelsParameterTypes3);
	...
	public static int getCommerceChannelAccountEntryRelsCount(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getCommerceChannelAccountEntryRelsCountParameterTypes4);
	...
	public static
		...
		try {
			MethodKey methodKey = new MethodKey(
				CommerceChannelAccountEntryRelServiceUtil.class,
				"updateCommerceChannelAccountEntryRel",
				_updateCommerceChannelAccountEntryRelParameterTypes5);
	...
	private static final Class<?>[]
		_getCommerceChannelAccountEntryRelsParameterTypes3 = new Class[] {
			long.class, int.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	private static final Class<?>[]
		_getCommerceChannelAccountEntryRelsCountParameterTypes4 = new Class[] {
			long.class, int.class
		};
	private static final Class<?>[]
		_updateCommerceChannelAccountEntryRelParameterTypes5 = new Class[] {
			long.class, long.class, boolean.class, double.class
		};
