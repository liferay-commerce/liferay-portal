...
public class CPInstanceUnitOfMeasureServiceImpl
	...
	public CPInstanceUnitOfMeasure addCPInstanceUnitOfMeasure(
		...
		_checkCommerceCatalogByCPInstanceId(cpInstanceId, ActionKeys.UPDATE);
	...
	public CPInstanceUnitOfMeasure fetchCPInstanceUnitOfMeasure(
		...
		_checkCommerceCatalogByCPInstanceId(cpInstanceId, ActionKeys.VIEW);
	...
	private void _checkCommerceCatalogByCPInstanceId(
			long cpInstanceId, String actionId)
		throws PortalException {
