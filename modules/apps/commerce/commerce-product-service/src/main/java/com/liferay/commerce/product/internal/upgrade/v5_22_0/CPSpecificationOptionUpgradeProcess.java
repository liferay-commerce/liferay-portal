...
import com.liferay.commerce.product.internal.upgrade.v5_22_0.util.CPSOListTypeDefinitionRelTable;
...
public class CPSpecificationOptionUpgradeProcess extends UpgradeProcess {
	...
	protected UpgradeStep[] getPreUpgradeSteps() {
		return new UpgradeStep[] {CPSOListTypeDefinitionRelTable.create()};
	}
