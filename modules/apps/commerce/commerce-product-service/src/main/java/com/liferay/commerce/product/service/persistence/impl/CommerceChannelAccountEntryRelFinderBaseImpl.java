 ...
 * @generated
 */
public abstract class CommerceChannelAccountEntryRelFinderBaseImpl
	extends BasePersistenceImpl<CommerceChannelAccountEntryRel> {

	public CommerceChannelAccountEntryRelFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return commerceChannelAccountEntryRelPersistence.getBadColumnNames();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CommerceChannelAccountEntryRelFinderBaseImpl.class);
