 ...
 */
@Component(
	property = "commerce.currency.contributor.key=" + CommerceCurrencyConstantsContributor.COMMERCE_CATALOG,
	service = CommerceCurrencyContributor.class
)
public class CommerceCatalogCommerceCurrencyContributor
	...
	public void check(CommerceCurrency commerceCurrency)
		...
		int commerceCatalogsCount =
			_commerceCatalogLocalService.getCommerceCatalogsCount(
