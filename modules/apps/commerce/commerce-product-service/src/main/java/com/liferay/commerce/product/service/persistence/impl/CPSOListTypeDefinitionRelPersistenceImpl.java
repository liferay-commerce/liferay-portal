...
import com.liferay.commerce.product.model.CPSOListTypeDefinitionRelTable;
import com.liferay.commerce.product.model.impl.CPSOListTypeDefinitionRelImpl;
import com.liferay.commerce.product.model.impl.CPSOListTypeDefinitionRelModelImpl;
...
/**
 * The persistence implementation for the cpso list type definition rel service.
 *
 * <p>
 ...
 * @generated
 */
@Component(service = CPSOListTypeDefinitionRelPersistence.class)
public class CPSOListTypeDefinitionRelPersistenceImpl
	extends BasePersistenceImpl<CPSOListTypeDefinitionRel>
	implements CPSOListTypeDefinitionRelPersistence {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use <code>CPSOListTypeDefinitionRelUtil</code> to access the cpso list type definition rel persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY =
		CPSOListTypeDefinitionRelImpl.class.getName();
	 ...
	 */
	@Override
	public List<CPSOListTypeDefinitionRel> findByCPSpecificationOptionId(
	...
	public List<CPSOListTypeDefinitionRel> findByCPSpecificationOptionId(
		...
		try (SafeCloseable safeCloseable =
				ctPersistenceHelper.setCTCollectionIdWithSafeCloseable(
					CPSOListTypeDefinitionRel.class)) {
			...
			List<CPSOListTypeDefinitionRel> list = null;

			if (useFinderCache) {
				list = (List<CPSOListTypeDefinitionRel>)finderCache.getResult(
					finderPath, finderArgs, this);

				if ((list != null) && !list.isEmpty()) {
					for (CPSOListTypeDefinitionRel cpsoListTypeDefinitionRel :
							list) {
			...
			if (list == null) {
				...
				sb.append(_SQL_SELECT_CPSOLISTTYPEDEFINITIONREL_WHERE);
				...
				if (orderByComparator != null) {
					...
					sb.append(CPSOListTypeDefinitionRelModelImpl.ORDER_BY_JPQL);
				}
				...
				try {
					...
					list = (List<CPSOListTypeDefinitionRel>)QueryUtil.list(
	...
	public CPSOListTypeDefinitionRel findByCPSpecificationOptionId_First(
		...
		throw new NoSuchCPSOListTypeDefinitionRelException(sb.toString());
	}
	...
	public CPSOListTypeDefinitionRel fetchByCPSpecificationOptionId_First(
		...
		List<CPSOListTypeDefinitionRel> list = findByCPSpecificationOptionId(
	...
	public CPSOListTypeDefinitionRel[]
		...
		CPSOListTypeDefinitionRel cpsoListTypeDefinitionRel = findByPrimaryKey(
		...
		try {
			...
			CPSOListTypeDefinitionRel[] array =
				new CPSOListTypeDefinitionRelImpl[3];

			array[0] = getByCPSpecificationOptionId_PrevAndNext(
				session, cpsoListTypeDefinitionRel, CPSpecificationOptionId,
				orderByComparator, true);

			array[1] = cpsoListTypeDefinitionRel;
	...
	protected CPSOListTypeDefinitionRel
		...
		List<CPSOListTypeDefinitionRel> list = query.list();
	...
	public void removeByCPSpecificationOptionId(long CPSpecificationOptionId) {
		for (CPSOListTypeDefinitionRel cpsoListTypeDefinitionRel :
			...
			remove(cpsoListTypeDefinitionRel);
		}
	}
	...
	public int countByCPSpecificationOptionId(long CPSpecificationOptionId) {
		try (SafeCloseable safeCloseable =
			...
			if (count == null) {
				...
				sb.append(_SQL_COUNT_CPSOLISTTYPEDEFINITIONREL_WHERE);
	...
	private static final String
		_FINDER_COLUMN_CPSPECIFICATIONOPTIONID_CPSPECIFICATIONOPTIONID_2 =
			"cpsoListTypeDefinitionRel.CPSpecificationOptionId = ?";
	 ...
	 */
	@Override
	public List<CPSOListTypeDefinitionRel> findByListTypeDefinitionId(
	...
	public CPSOListTypeDefinitionRel fetchByListTypeDefinitionId_First(
		...
		List<CPSOListTypeDefinitionRel> list = findByListTypeDefinitionId(
	...
	public CPSOListTypeDefinitionRel[] findByListTypeDefinitionId_PrevAndNext(
		...
		try {
			...
			array[0] = getByListTypeDefinitionId_PrevAndNext(
				session, cpsoListTypeDefinitionRel, listTypeDefinitionId,
				orderByComparator, true);
	...
	protected CPSOListTypeDefinitionRel getByListTypeDefinitionId_PrevAndNext(
		Session session, CPSOListTypeDefinitionRel cpsoListTypeDefinitionRel,
		long listTypeDefinitionId,
		OrderByComparator<CPSOListTypeDefinitionRel> orderByComparator,
		boolean previous) {
	...
	private static final String
		_FINDER_COLUMN_LISTTYPEDEFINITIONID_LISTTYPEDEFINITIONID_2 =
			"cpsoListTypeDefinitionRel.listTypeDefinitionId = ?";
	...
	public CPSOListTypeDefinitionRel findByC_L(
		...
		CPSOListTypeDefinitionRel cpsoListTypeDefinitionRel = fetchByC_L(
	...
	public CPSOListTypeDefinitionRel fetchByC_L(
		...
		try (SafeCloseable safeCloseable =
			...
			if (result instanceof CPSOListTypeDefinitionRel) {
				CPSOListTypeDefinitionRel cpsoListTypeDefinitionRel =
					(CPSOListTypeDefinitionRel)result;
					...
					if (list.isEmpty()) {
						...
						if (list.size() > 1) {
							...
							if (_log.isWarnEnabled()) {
								...
								_log.warn(
									"CPSOListTypeDefinitionRelPersistenceImpl.fetchByC_L(long, long, boolean) with parameters (" +
						...
						result = cpsoListTypeDefinitionRel;

						cacheResult(cpsoListTypeDefinitionRel);
					}
				}
				catch (Exception exception) {
					throw processException(exception);
			...
			if (result instanceof List<?>) {
				...
				return (CPSOListTypeDefinitionRel)result;
			}
		}
	}
	...
	public CPSOListTypeDefinitionRel removeByC_L(
		...
		CPSOListTypeDefinitionRel cpsoListTypeDefinitionRel = findByC_L(
			CPSpecificationOptionId, listTypeDefinitionId);

		return remove(cpsoListTypeDefinitionRel);
	}
	...
	private static final String _FINDER_COLUMN_C_L_CPSPECIFICATIONOPTIONID_2 =
		"cpsoListTypeDefinitionRel.CPSpecificationOptionId = ? AND ";

	private static final String _FINDER_COLUMN_C_L_LISTTYPEDEFINITIONID_2 =
		"cpsoListTypeDefinitionRel.listTypeDefinitionId = ?";

	public CPSOListTypeDefinitionRelPersistenceImpl() {
		setModelClass(CPSOListTypeDefinitionRel.class);

		setModelImplClass(CPSOListTypeDefinitionRelImpl.class);
		setModelPKClass(long.class);

		setTable(CPSOListTypeDefinitionRelTable.INSTANCE);
	}
	...
	public void cacheResult(
		...
		try (SafeCloseable safeCloseable =
				CTCollectionThreadLocal.setCTCollectionIdWithSafeCloseable(
					cpsoListTypeDefinitionRel.getCtCollectionId())) {

			entityCache.putResult(
				CPSOListTypeDefinitionRelImpl.class,
				cpsoListTypeDefinitionRel.getPrimaryKey(),
				cpsoListTypeDefinitionRel);
	...
	public void cacheResult(
		...
		if ((_valueObjectFinderCacheListThreshold == 0) ||
			((_valueObjectFinderCacheListThreshold > 0) &&
			 (cpsoListTypeDefinitionRels.size() >
		...
		for (CPSOListTypeDefinitionRel cpsoListTypeDefinitionRel :
			...
			try (SafeCloseable safeCloseable =
				...
				if (entityCache.getResult(
						CPSOListTypeDefinitionRelImpl.class,
						cpsoListTypeDefinitionRel.getPrimaryKey()) == null) {
	...
	/**
	 * Clears the cache for all cpso list type definition rels.
	 *
	 * <p>
	...
	public void clearCache() {
		entityCache.clearCache(CPSOListTypeDefinitionRelImpl.class);

		finderCache.clearCache(CPSOListTypeDefinitionRelImpl.class);
	}

	/**
	 * Clears the cache for the cpso list type definition rel.
	 *
	 * <p>
	 * The <code>EntityCache</code> and <code>FinderCache</code> are both cleared by this method.
	 * </p>
	...
	public void clearCache(
		...
		entityCache.removeResult(
			CPSOListTypeDefinitionRelImpl.class, cpsoListTypeDefinitionRel);
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				CPSOListTypeDefinitionRelImpl.class, primaryKey);
		}
	}

	protected void cacheUniqueFindersCache(
		CPSOListTypeDefinitionRelModelImpl cpsoListTypeDefinitionRelModelImpl) {

		try (SafeCloseable safeCloseable =
				CTCollectionThreadLocal.setCTCollectionIdWithSafeCloseable(
					cpsoListTypeDefinitionRelModelImpl.getCtCollectionId())) {

			Object[] args = new Object[] {
				cpsoListTypeDefinitionRelModelImpl.getCPSpecificationOptionId(),
				cpsoListTypeDefinitionRelModelImpl.getListTypeDefinitionId()
			};

			finderCache.putResult(
				_finderPathFetchByC_L, args,
				cpsoListTypeDefinitionRelModelImpl);
		}
	}
	...
	public CPSOListTypeDefinitionRel create(long CPSOListTypeDefinitionRelId) {
		...
		cpsoListTypeDefinitionRel.setNew(true);
		cpsoListTypeDefinitionRel.setPrimaryKey(CPSOListTypeDefinitionRelId);
	...
	public CPSOListTypeDefinitionRel remove(long CPSOListTypeDefinitionRelId)
		...
		return remove((Serializable)CPSOListTypeDefinitionRelId);
	}

	/**
	 * Removes the cpso list type definition rel with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param primaryKey the primary key of the cpso list type definition rel
	 * @return the cpso list type definition rel that was removed
	 * @throws NoSuchCPSOListTypeDefinitionRelException if a cpso list type definition rel with the primary key could not be found
	 */
	@Override
	public CPSOListTypeDefinitionRel remove(Serializable primaryKey)
		throws NoSuchCPSOListTypeDefinitionRelException {
		...
		try {
			...
			CPSOListTypeDefinitionRel cpsoListTypeDefinitionRel =
				(CPSOListTypeDefinitionRel)session.get(
					CPSOListTypeDefinitionRelImpl.class, primaryKey);
			...
			if (cpsoListTypeDefinitionRel == null) {
				...
				throw new NoSuchCPSOListTypeDefinitionRelException(
					_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + primaryKey);
			}

			return remove(cpsoListTypeDefinitionRel);
		}
		catch (NoSuchCPSOListTypeDefinitionRelException noSuchEntityException) {
	...
	@Override
	protected CPSOListTypeDefinitionRel removeImpl(
		CPSOListTypeDefinitionRel cpsoListTypeDefinitionRel) {
		...
		try {
			...
			if (!session.contains(cpsoListTypeDefinitionRel)) {
				cpsoListTypeDefinitionRel =
					(CPSOListTypeDefinitionRel)session.get(
						CPSOListTypeDefinitionRelImpl.class,
						cpsoListTypeDefinitionRel.getPrimaryKeyObj());
			}

			if ((cpsoListTypeDefinitionRel != null) &&
				ctPersistenceHelper.isRemove(cpsoListTypeDefinitionRel)) {

				session.delete(cpsoListTypeDefinitionRel);
			}
		}
		catch (Exception exception) {
			throw processException(exception);
		...
		if (cpsoListTypeDefinitionRel != null) {
			clearCache(cpsoListTypeDefinitionRel);
		}
	...
	public CPSOListTypeDefinitionRel updateImpl(
		...
		boolean isNew = cpsoListTypeDefinitionRel.isNew();

		if (!(cpsoListTypeDefinitionRel instanceof
				CPSOListTypeDefinitionRelModelImpl)) {

			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(cpsoListTypeDefinitionRel.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(
					cpsoListTypeDefinitionRel);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in cpsoListTypeDefinitionRel proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom CPSOListTypeDefinitionRel implementation " +
					cpsoListTypeDefinitionRel.getClass());
		}

		CPSOListTypeDefinitionRelModelImpl cpsoListTypeDefinitionRelModelImpl =
			(CPSOListTypeDefinitionRelModelImpl)cpsoListTypeDefinitionRel;
		...
		try {
			...
			if (ctPersistenceHelper.isInsert(cpsoListTypeDefinitionRel)) {
				if (!isNew) {
					session.evict(
						CPSOListTypeDefinitionRelImpl.class,
						cpsoListTypeDefinitionRel.getPrimaryKeyObj());
				...
				session.save(cpsoListTypeDefinitionRel);
			}
			else {
				cpsoListTypeDefinitionRel =
					(CPSOListTypeDefinitionRel)session.merge(
						cpsoListTypeDefinitionRel);
			}
		}
		catch (Exception exception) {
		...
		entityCache.putResult(
			CPSOListTypeDefinitionRelImpl.class,
			cpsoListTypeDefinitionRelModelImpl, false, true);

		cacheUniqueFindersCache(cpsoListTypeDefinitionRelModelImpl);

		if (isNew) {
			cpsoListTypeDefinitionRel.setNew(false);
		}

		cpsoListTypeDefinitionRel.resetOriginalValues();

		return cpsoListTypeDefinitionRel;
	}

	/**
	 * Returns the cpso list type definition rel with the primary key or throws a <code>com.liferay.portal.kernel.exception.NoSuchModelException</code> if it could not be found.
	 *
	 * @param primaryKey the primary key of the cpso list type definition rel
	 ...
	 */
	@Override
	public CPSOListTypeDefinitionRel findByPrimaryKey(Serializable primaryKey)
		throws NoSuchCPSOListTypeDefinitionRelException {

		CPSOListTypeDefinitionRel cpsoListTypeDefinitionRel = fetchByPrimaryKey(
			primaryKey);
	...
	public CPSOListTypeDefinitionRel findByPrimaryKey(
		...
		return findByPrimaryKey((Serializable)CPSOListTypeDefinitionRelId);
	}
	...
	public CPSOListTypeDefinitionRel fetchByPrimaryKey(
		...
		if (ctPersistenceHelper.isProductionMode(
				CPSOListTypeDefinitionRel.class, primaryKey)) {
		...
		CPSOListTypeDefinitionRel cpsoListTypeDefinitionRel =
			(CPSOListTypeDefinitionRel)entityCache.getResult(
				CPSOListTypeDefinitionRelImpl.class, primaryKey);
		...
		try {
			...
			cpsoListTypeDefinitionRel = (CPSOListTypeDefinitionRel)session.get(
				CPSOListTypeDefinitionRelImpl.class, primaryKey);
	...
	public CPSOListTypeDefinitionRel fetchByPrimaryKey(
		...
		return fetchByPrimaryKey((Serializable)CPSOListTypeDefinitionRelId);
	}

	@Override
	public Map<Serializable, CPSOListTypeDefinitionRel> fetchByPrimaryKeys(
		...
		Map<Serializable, CPSOListTypeDefinitionRel> map =
			new HashMap<Serializable, CPSOListTypeDefinitionRel>();
		...
		if (primaryKeys.size() == 1) {
			...
			if (cpsoListTypeDefinitionRel != null) {
				map.put(primaryKey, cpsoListTypeDefinitionRel);
			}
		...
		try {
			...
			for (CPSOListTypeDefinitionRel cpsoListTypeDefinitionRel :
					(List<CPSOListTypeDefinitionRel>)query.list()) {
	 ...
	 */
	@Override
	public List<CPSOListTypeDefinitionRel> findAll() {
	 ...
	 */
	@Override
	public List<CPSOListTypeDefinitionRel> findAll(int start, int end) {
		...
		try (SafeCloseable safeCloseable =
			...
			if (list == null) {
				...
				if (orderByComparator != null) {
					...
					sb.append(_SQL_SELECT_CPSOLISTTYPEDEFINITIONREL);
					...
					sql = _SQL_SELECT_CPSOLISTTYPEDEFINITIONREL;

					sql = sql.concat(
						CPSOListTypeDefinitionRelModelImpl.ORDER_BY_JPQL);
				}
	...
	public void removeAll() {
		for (CPSOListTypeDefinitionRel cpsoListTypeDefinitionRel : findAll()) {
			remove(cpsoListTypeDefinitionRel);
		}
	}
			...
			if (count == null) {
				...
				try {
					...
					Query query = session.createQuery(
						_SQL_COUNT_CPSOLISTTYPEDEFINITIONREL);
	...
	protected String getSelectSQL() {
		return _SQL_SELECT_CPSOLISTTYPEDEFINITIONREL;
	}
	...
	public Map<String, Integer> getTableColumnsMap() {
		return CPSOListTypeDefinitionRelModelImpl.TABLE_COLUMNS_MAP;
	}
	...
	/**
	 * Initializes the cpso list type definition rel persistence.
	 */
	@Activate
	public void activate() {
		...
		CPSOListTypeDefinitionRelUtil.setPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		CPSOListTypeDefinitionRelUtil.setPersistence(null);

		entityCache.removeCache(CPSOListTypeDefinitionRelImpl.class.getName());
	}
	...
	private static final String _SQL_SELECT_CPSOLISTTYPEDEFINITIONREL =
		"SELECT cpsoListTypeDefinitionRel FROM CPSOListTypeDefinitionRel cpsoListTypeDefinitionRel";

	private static final String _SQL_SELECT_CPSOLISTTYPEDEFINITIONREL_WHERE =
		"SELECT cpsoListTypeDefinitionRel FROM CPSOListTypeDefinitionRel cpsoListTypeDefinitionRel WHERE ";

	private static final String _SQL_COUNT_CPSOLISTTYPEDEFINITIONREL =
		"SELECT COUNT(cpsoListTypeDefinitionRel) FROM CPSOListTypeDefinitionRel cpsoListTypeDefinitionRel";

	private static final String _SQL_COUNT_CPSOLISTTYPEDEFINITIONREL_WHERE =
		"SELECT COUNT(cpsoListTypeDefinitionRel) FROM CPSOListTypeDefinitionRel cpsoListTypeDefinitionRel WHERE ";

	private static final String _ORDER_BY_ENTITY_ALIAS =
		"cpsoListTypeDefinitionRel.";

	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY =
		"No CPSOListTypeDefinitionRel exists with the primary key ";

	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No CPSOListTypeDefinitionRel exists with the key {";

	private static final Log _log = LogFactoryUtil.getLog(
		CPSOListTypeDefinitionRelPersistenceImpl.class);
