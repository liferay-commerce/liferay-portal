...
import com.liferay.commerce.account.internal.upgrade.v2_0_1.CommerceAccountModelResourcePermissionUpgradeProcess;
...
public class CommerceAccountUpgradeStepRegistrator
	...
	public void register(Registry registry) {
		...
		registry.register(
			"2.0.0", "2.0.1",
			new CommerceAccountModelResourcePermissionUpgradeProcess());
