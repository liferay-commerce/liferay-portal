...
String orderTypeQualifiers = ParamUtil.getString(request, "orderTypeQualifiers", cIWarehouseQualifiersDisplayContext.getActiveOrderTypeEligibility());
...
<aui:form action="<%= editCommerceInventoryWarehouseQualifiersActionURL %>" cssClass="pt-4" method="post" name="fm">
	...
	<c:if test='<%= Objects.equals(orderTypeQualifiers, "orderTypes") %>'>
		<%@ include file="/commerce_inventory_warehouse/qualifier/order_types.jspf" %>
	</c:if>
</aui:form>
