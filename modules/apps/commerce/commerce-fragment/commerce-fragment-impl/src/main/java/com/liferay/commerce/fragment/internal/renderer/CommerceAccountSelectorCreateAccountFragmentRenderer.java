...
public class CommerceAccountSelectorCreateAccountFragmentRenderer
	...
	public JSONObject getConfigurationJSONObject(
		...
		try {
			JSONObject jsonObject = _jsonFactory.createJSONObject(
				StringUtil.read(
					getClass(),
					"account_selector_cta/dependencies/configuration.json"));
	...
	public String getLabel(Locale locale) {
		return _language.get(locale, "account-selector-create-account-button");
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CommerceAccountSelectorCreateAccountFragmentRenderer.class);
