...
<aui:form action="<%= editFunctionCommerceShippingMethodActionURL %>" method="post" name="fm">
	...
	<commerce-ui:panel>
		<aui:input autoSize="<%= true %>" id="shipping-method-type-settings" label="type-settings" name="settings--shippingMethodTypeSettings--" style="min-height: 600px;" type="textarea" value='<%= (UnicodeProperties)request.getAttribute("shippingMethodTypeSettings") %>' />
	</commerce-ui:panel>
