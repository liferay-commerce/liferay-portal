...
package com.liferay.commerce.shipping.engine.remote.internal.frontend.taglib.servlet.taglib;

import com.liferay.commerce.model.CommerceShippingMethod;
import com.liferay.commerce.shipping.engine.remote.internal.RemoteCommerceShippingEngine;
...
public class RemoteCommerceShippingMethodConfigurationScreenNavigationCategory
	...
	public boolean isVisible(
		...
		if (engineKey.equals(RemoteCommerceShippingEngine.KEY)) {
			return true;
		}
	...
	public void render(
		...
		httpServletRequest.setAttribute(
			...
			_getRemoteCommerceShippingEngineConfiguration(httpServletRequest));
	...
	@Reference(
		target = "(osgi.web.symbolicname=com.liferay.commerce.shipping.engine.remote)"
	)
