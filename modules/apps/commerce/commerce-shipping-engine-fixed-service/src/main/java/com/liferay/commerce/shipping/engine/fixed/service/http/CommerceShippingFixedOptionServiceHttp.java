...
public class CommerceShippingFixedOptionServiceHttp {
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				CommerceShippingFixedOptionServiceUtil.class,
				"getCommerceChannelCommerceShippingFixedOptions",
				_getCommerceChannelCommerceShippingFixedOptionsParameterTypes4);
	...
	public static int getCommerceChannelCommerceShippingFixedOptionsCount(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getCommerceChannelCommerceShippingFixedOptionsCountParameterTypes7);
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getCommerceShippingFixedOptionsParameterTypes9);
	...
	private static final Class<?>[]
		_getCommerceShippingFixedOptionsParameterTypes9 = new Class[] {
			long.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	private static final Class<?>[]
