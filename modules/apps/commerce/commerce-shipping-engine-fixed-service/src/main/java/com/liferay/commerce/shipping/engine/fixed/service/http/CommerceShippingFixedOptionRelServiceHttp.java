...
public class CommerceShippingFixedOptionRelServiceHttp {
	...
	public static int getCommerceShippingFixedOptionRelsCount(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getCommerceShippingFixedOptionRelsCountParameterTypes5);
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				CommerceShippingFixedOptionRelServiceUtil.class,
				"getCommerceShippingMethodFixedOptionRels",
				_getCommerceShippingMethodFixedOptionRelsParameterTypes6);
	...
	public static int getCommerceShippingMethodFixedOptionRelsCount(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getCommerceShippingMethodFixedOptionRelsCountParameterTypes7);
	...
	public static com.liferay.commerce.shipping.engine.fixed.model.
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_updateCommerceShippingFixedOptionRelParameterTypes8);
	...
	private static final Class<?>[]
		_getCommerceShippingFixedOptionRelsParameterTypes4 = new Class[] {
			long.class, long.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	private static final Class<?>[]
		_getCommerceShippingFixedOptionRelsCountParameterTypes5 = new Class[] {
			long.class, long.class
		};
	private static final Class<?>[]
		_getCommerceShippingMethodFixedOptionRelsParameterTypes6 = new Class[] {
