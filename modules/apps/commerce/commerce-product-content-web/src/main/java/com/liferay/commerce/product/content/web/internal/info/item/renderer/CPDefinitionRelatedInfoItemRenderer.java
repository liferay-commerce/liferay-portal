...
@Component(
	service = {
		CPDefinitionRelatedInfoItemRenderer.class, InfoItemRenderer.class
	}
)
public class CPDefinitionRelatedInfoItemRenderer
	implements InfoItemRenderer<CPDefinition> {

	@Override
	public String getLabel(Locale locale) {
		return _language.get(locale, "related-products");
	}
		...
		try {
			...
			RequestDispatcher requestDispatcher =
				_servletContext.getRequestDispatcher(
					"/info/item/renderer/cp_definition_related/page.jsp");
