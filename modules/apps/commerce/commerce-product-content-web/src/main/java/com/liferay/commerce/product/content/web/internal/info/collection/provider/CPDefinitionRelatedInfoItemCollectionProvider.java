...
public class CPDefinitionRelatedInfoItemCollectionProvider
	...
	public InfoPage<CPDefinition> getCollectionInfoPage(
		...
		try {
			...
			SearchContext searchContext =
				_cpDefinitionHelper.createCPDefinitionLinkSearchContext(
	...
	public String getKey() {
		return CPDefinitionRelatedInfoItemCollectionProvider.class.getName() +
