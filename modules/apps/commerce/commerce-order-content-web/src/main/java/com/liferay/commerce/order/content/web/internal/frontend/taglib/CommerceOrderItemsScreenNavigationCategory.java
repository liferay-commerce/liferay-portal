...
public class CommerceOrderItemsScreenNavigationCategory
	implements ScreenNavigationCategory {

	@Override
	public String getCategoryKey() {
		return CommerceOrderScreenNavigationConstants.CATEGORY_KEY_ORDER_ITEMS;
	}
	...
	public String getLabel(Locale locale) {
		...
		return language.get(resourceBundle, "list");
	}

	@Override
	public String getScreenNavigationKey() {
		return CommerceOrderScreenNavigationConstants.
			SCREEN_NAVIGATION_KEY_COMMERCE_ORDER_ITEMS;
	}
