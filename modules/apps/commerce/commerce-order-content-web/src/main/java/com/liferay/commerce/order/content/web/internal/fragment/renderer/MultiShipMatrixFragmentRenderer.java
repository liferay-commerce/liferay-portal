...
public class MultiShipMatrixFragmentRenderer implements FragmentRenderer {
	...
	public String getLabel(Locale locale) {
		return _language.get(locale, "multi-ship-matrix");
	}
			...
			if ((infoItem == null) || !(infoItem instanceof CommerceOrder)) {
				if (_isEditMode(httpServletRequest)) {
					_printPortletMessageInfo(
						...
						"the-multi-ship-matrix-component-will-be-shown-here");
				}
		...
		try {
			RequestDispatcher requestDispatcher =
				_servletContext.getRequestDispatcher(
					"/fragment/renderer/multi_ship_matrix/page.jsp");
			...
			httpServletRequest.setAttribute(
				"liferay-commerce:multi-ship-matrix:commerce-order-steps",
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MultiShipMatrixFragmentRenderer.class);
