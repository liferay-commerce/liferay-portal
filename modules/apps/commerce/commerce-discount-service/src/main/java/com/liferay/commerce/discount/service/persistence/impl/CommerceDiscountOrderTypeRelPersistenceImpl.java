...
public class CommerceDiscountOrderTypeRelPersistenceImpl
	 ...
	 */
	@Override
	public CommerceDiscountOrderTypeRel findByC_C(
			long commerceDiscountId, long commerceOrderTypeId)
		throws NoSuchDiscountOrderTypeRelException {

		CommerceDiscountOrderTypeRel commerceDiscountOrderTypeRel = fetchByC_C(
	 ...
	 */
	@Override
	public CommerceDiscountOrderTypeRel fetchByC_C(
		long commerceDiscountId, long commerceOrderTypeId) {

		return fetchByC_C(commerceDiscountId, commerceOrderTypeId, true);
	}
	 ...
	 */
	@Override
	public CommerceDiscountOrderTypeRel removeByC_C(
			long commerceDiscountId, long commerceOrderTypeId)
		throws NoSuchDiscountOrderTypeRelException {

		CommerceDiscountOrderTypeRel commerceDiscountOrderTypeRel = findByC_C(
			commerceDiscountId, commerceOrderTypeId);
	 ...
	 */
	@Override
	public int countByC_C(long commerceDiscountId, long commerceOrderTypeId) {
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			_finderPathFetchByC_C, args, commerceDiscountOrderTypeRelModelImpl);
	}
	...
	public void afterPropertiesSet() {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			...
			new CommerceDiscountOrderTypeRelModelArgumentsResolver(),
	...
	private static class CommerceDiscountOrderTypeRelModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					commerceDiscountOrderTypeRelModelImpl, columnNames,
					original);
			}
