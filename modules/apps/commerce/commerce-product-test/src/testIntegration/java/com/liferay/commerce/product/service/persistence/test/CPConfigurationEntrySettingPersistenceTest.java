...
public class CPConfigurationEntrySettingPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newCPConfigurationEntrySetting.setSetting(
			RandomTestUtil.randomString());
		...
		Assert.assertEquals(
			existingCPConfigurationEntrySetting.getSetting(),
			newCPConfigurationEntrySetting.getSetting());
		Assert.assertEquals(
	...
	protected CPConfigurationEntrySetting addCPConfigurationEntrySetting()
		...
		cpConfigurationEntrySetting.setSetting(RandomTestUtil.randomString());
