...
public class CommerceOrderRuleEntryWrapper
	...
	public Map<String, Object> getModelAttributes() {
		...
		attributes.put("exclusive", isExclusive());
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		Boolean exclusive = (Boolean)attributes.get("exclusive");
	...
	/**
	 * Returns the exclusive of this commerce order rule entry.
	 *
	 * @return the exclusive of this commerce order rule entry
	 */
	@Override
	public boolean getExclusive() {
		return model.getExclusive();
	}
	...
	/**
	 * Returns <code>true</code> if this commerce order rule entry is exclusive.
	 *
	 * @return <code>true</code> if this commerce order rule entry is exclusive; <code>false</code> otherwise
	 */
	@Override
	...
	/**
	 * Sets whether this commerce order rule entry is exclusive.
	 *
	 * @param exclusive the exclusive of this commerce order rule entry
	 */
	@Override
	public void setExclusive(boolean exclusive) {
		model.setExclusive(exclusive);
	}
