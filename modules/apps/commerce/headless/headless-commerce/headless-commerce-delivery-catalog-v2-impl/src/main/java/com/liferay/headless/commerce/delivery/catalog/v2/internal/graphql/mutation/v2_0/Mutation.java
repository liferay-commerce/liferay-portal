...
package com.liferay.headless.commerce.delivery.catalog.v2.internal.graphql.mutation.v2_0;
...
public class Mutation {
	...
	public Sku createChannelIdProductSku(
		...
		return _applyComponentServiceObjects(
			...
			skuResource -> skuResource.postChannelIdProductSku(
				id, productId, accountId, quantity, skuOptions));
	}

	@GraphQLField
	public WishList createChannelIdWishList(
			@GraphQLName("id") Long id,
			@GraphQLName("accountId") Long accountId,
		...
		return _applyComponentServiceObjects(
			_wishListResourceComponentServiceObjects,
			this::_populateResourceContext,
			wishListResource -> wishListResource.postChannelIdWishList(
				id, accountId, wishList));
	}

	@GraphQLField(description = "Deletes a wishlist by wishListId.")
	public boolean deleteWishList(@GraphQLName("id") Long id) throws Exception {
		_applyVoidComponentServiceObjects(
			_wishListResourceComponentServiceObjects,
			this::_populateResourceContext,
			wishListResource -> wishListResource.deleteWishList(id));
	...
	public WishList patchWishList(
		...
		return _applyComponentServiceObjects(
			_wishListResourceComponentServiceObjects,
			this::_populateResourceContext,
			wishListResource -> wishListResource.patchWishList(id, wishList));
	}

	@GraphQLField(description = "Deletes a wishlist item by wishListItemId.")
	public boolean deleteWishListItem(@GraphQLName("id") Long id)
		throws Exception {
	...
	@GraphQLField
	public WishListItem createWishlistIdWishListItem(
			@GraphQLName("id") Long id,
			@GraphQLName("accountId") Long accountId,
		...
		return _applyComponentServiceObjects(
			...
			this::_populateResourceContext,
			wishListItemResource ->
				wishListItemResource.postWishlistIdWishListItem(
