...
public abstract class BaseSkuResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-delivery-catalog/v2.0/channels/{id}/products/{productId}/skus'  -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/channels/{id}/products/{productId}/skus")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-delivery-catalog/v2.0/channels/{id}/products/{productId}/skus'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
