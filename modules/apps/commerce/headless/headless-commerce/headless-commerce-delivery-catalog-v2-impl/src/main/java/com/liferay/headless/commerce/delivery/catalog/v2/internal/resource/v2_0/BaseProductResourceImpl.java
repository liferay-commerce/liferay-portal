...
public abstract class BaseProductResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-delivery-catalog/v2.0/channels/{id}/products'  -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/channels/{id}/products")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-delivery-catalog/v2.0/channels/{id}/products/{productId}'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Retrieves products from selected channel."
	)
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/channels/{id}/products/{productId}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
