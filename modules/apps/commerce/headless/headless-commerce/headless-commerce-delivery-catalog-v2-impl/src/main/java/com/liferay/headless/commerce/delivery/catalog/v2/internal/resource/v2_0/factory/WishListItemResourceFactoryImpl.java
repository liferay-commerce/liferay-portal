 ...
 */
@Component(
	property = "resource.locator.key=/headless-commerce-delivery-catalog/v2.0/WishListItem",
	service = WishListItemResource.Factory.class
)
@Generated("")
public class WishListItemResourceFactoryImpl
	implements WishListItemResource.Factory {

	@Override
	public WishListItemResource.Builder create() {
		return new WishListItemResource.Builder() {
			...
			@Override
			public WishListItemResource.Builder checkPermissions(
			...
			@Override
			public WishListItemResource.Builder httpServletRequest(
			...
			@Override
			public WishListItemResource.Builder httpServletResponse(
			...
			@Override
			public WishListItemResource.Builder preferredLocale(
			...
			@Override
			public WishListItemResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, WishListItemResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			WishListItemResource.class.getClassLoader(),
			WishListItemResource.class);

		try {
			Constructor<WishListItemResource> constructor =
				(Constructor<WishListItemResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(wishListItemResource);
