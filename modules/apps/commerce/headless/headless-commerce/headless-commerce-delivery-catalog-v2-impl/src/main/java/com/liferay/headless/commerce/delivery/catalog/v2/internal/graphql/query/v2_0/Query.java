...
package com.liferay.headless.commerce.delivery.catalog.v2.internal.graphql.query.v2_0;

import com.liferay.headless.commerce.delivery.catalog.v2.dto.v2_0.Attachment;
import com.liferay.headless.commerce.delivery.catalog.v2.dto.v2_0.Category;
import com.liferay.headless.commerce.delivery.catalog.v2.dto.v2_0.Channel;
import com.liferay.headless.commerce.delivery.catalog.v2.dto.v2_0.Image;
import com.liferay.headless.commerce.delivery.catalog.v2.dto.v2_0.LinkedProduct;
import com.liferay.headless.commerce.delivery.catalog.v2.dto.v2_0.MappedProduct;
import com.liferay.headless.commerce.delivery.catalog.v2.dto.v2_0.Pin;
import com.liferay.headless.commerce.delivery.catalog.v2.dto.v2_0.Product;
import com.liferay.headless.commerce.delivery.catalog.v2.dto.v2_0.ProductOption;
import com.liferay.headless.commerce.delivery.catalog.v2.dto.v2_0.ProductSpecification;
import com.liferay.headless.commerce.delivery.catalog.v2.dto.v2_0.RelatedProduct;
import com.liferay.headless.commerce.delivery.catalog.v2.dto.v2_0.Sku;
import com.liferay.headless.commerce.delivery.catalog.v2.dto.v2_0.WishList;
import com.liferay.headless.commerce.delivery.catalog.v2.dto.v2_0.WishListItem;
...
public class Query {
	...
	public static void setImageResourceComponentServiceObjects(
		ComponentServiceObjects<ImageResource>
			imageResourceComponentServiceObjects) {
	 ...
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {channelIdProductAttachments(accountId: ___, id: ___, page: ___, pageSize: ___, productId: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	public AttachmentPage channelIdProductAttachments(
		...
		return _applyComponentServiceObjects(
			...
			attachmentResource -> new AttachmentPage(
				attachmentResource.getChannelIdProductAttachmentsPage(
					id, productId, accountId, Pagination.of(page, pageSize))));
	}

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {channelIdProductCategories(id: ___, page: ___, pageSize: ___, productId: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField(description = "Gets a list of Category related to a Product.")
	public CategoryPage channelIdProductCategories(
			@GraphQLName("id") Long id,
			@GraphQLName("productId") Long productId,
			@GraphQLName("pageSize") int pageSize,
			@GraphQLName("page") int page)
		...
		return _applyComponentServiceObjects(
			...
			categoryResource -> new CategoryPage(
				categoryResource.getChannelIdProductCategoriesPage(
					id, productId, Pagination.of(page, pageSize))));
	}
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {channelIdProductImages(accountId: ___, id: ___, page: ___, pageSize: ___, productId: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	public ImagePage channelIdProductImages(
			@GraphQLName("id") Long id,
			@GraphQLName("productId") Long productId,
			@GraphQLName("accountId") Long accountId,
			@GraphQLName("pageSize") int pageSize,
		...
		return _applyComponentServiceObjects(
			_imageResourceComponentServiceObjects,
			this::_populateResourceContext,
			imageResource -> new ImagePage(
				imageResource.getChannelIdProductImagesPage(
					id, productId, accountId, Pagination.of(page, pageSize))));
	}
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {channelIdProductLinkedProducts(accountId: ___, id: ___, page: ___, pageSize: ___, productId: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	public LinkedProductPage channelIdProductLinkedProducts(
			@GraphQLName("id") Long id,
			@GraphQLName("productId") Long productId,
			@GraphQLName("accountId") Long accountId,
			@GraphQLName("pageSize") int pageSize,
		...
		return _applyComponentServiceObjects(
			...
			linkedProductResource -> new LinkedProductPage(
				linkedProductResource.getChannelIdProductLinkedProductsPage(
					id, productId, accountId, Pagination.of(page, pageSize))));
	}
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {channelIdProductMappedProducts(accountId: ___, id: ___, page: ___, pageSize: ___, productId: ___, search: ___, sorts: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	public MappedProductPage channelIdProductMappedProducts(
			@GraphQLName("id") Long id,
			@GraphQLName("productId") Long productId,
			@GraphQLName("accountId") Long accountId,
			@GraphQLName("search") String search,
		...
		return _applyComponentServiceObjects(
			...
			mappedProductResource -> new MappedProductPage(
				mappedProductResource.getChannelIdProductMappedProductsPage(
					id, productId, accountId, search,
					Pagination.of(page, pageSize),
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {channelIdProductPins(accountId: ___, id: ___, page: ___, pageSize: ___, productId: ___, search: ___, sorts: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	public PinPage channelIdProductPins(
			@GraphQLName("id") Long id,
			@GraphQLName("productId") Long productId,
			@GraphQLName("accountId") Long accountId,
			@GraphQLName("search") String search,
		...
		return _applyComponentServiceObjects(
			...
			pinResource -> new PinPage(
				pinResource.getChannelIdProductPinsPage(
					id, productId, accountId, search,
					Pagination.of(page, pageSize),
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {channelIdProducts(accountId: ___, filter: ___, id: ___, page: ___, pageSize: ___, search: ___, sorts: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField(description = "Retrieves products from selected channel.")
	public ProductPage channelIdProducts(
			@GraphQLName("id") Long id,
			@GraphQLName("accountId") Long accountId,
			@GraphQLName("search") String search,
			@GraphQLName("filter") String filterString,
		...
		return _applyComponentServiceObjects(
			...
			productResource -> new ProductPage(
				productResource.getChannelIdProductsPage(
					id, accountId, search,
	...
	public Product channelIdProduct(
		...
		return _applyComponentServiceObjects(
			_productResourceComponentServiceObjects,
			this::_populateResourceContext,
			productResource -> productResource.getChannelIdProduct(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {channelIdProductProductOptions(id: ___, page: ___, pageSize: ___, productId: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	public ProductOptionPage channelIdProductProductOptions(
			@GraphQLName("id") Long id,
			@GraphQLName("productId") Long productId,
			@GraphQLName("pageSize") int pageSize,
			@GraphQLName("page") int page)
		...
		return _applyComponentServiceObjects(
			...
			productOptionResource -> new ProductOptionPage(
				productOptionResource.getChannelIdProductProductOptionsPage(
					id, productId, Pagination.of(page, pageSize))));
	}
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {channelIdProductProductSpecifications(id: ___, page: ___, pageSize: ___, productId: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	public ProductSpecificationPage channelIdProductProductSpecifications(
			@GraphQLName("id") Long id,
			@GraphQLName("productId") Long productId,
			@GraphQLName("pageSize") int pageSize,
			@GraphQLName("page") int page)
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {channelIdProductRelatedProducts(id: ___, page: ___, pageSize: ___, productId: ___, type: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField(description = "Gets a list of Related Products of a Product.")
	public RelatedProductPage channelIdProductRelatedProducts(
			@GraphQLName("id") Long id,
			@GraphQLName("productId") Long productId,
		...
		return _applyComponentServiceObjects(
			...
			relatedProductResource -> new RelatedProductPage(
				relatedProductResource.getChannelIdProductRelatedProductsPage(
					id, productId, type, Pagination.of(page, pageSize))));
	}

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {channelIdProductSkus(accountId: ___, id: ___, page: ___, pageSize: ___, productId: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField(description = "Retrieves products from selected channel.")
	public SkuPage channelIdProductSkus(
			@GraphQLName("id") Long id,
			@GraphQLName("productId") Long productId,
			@GraphQLName("accountId") Long accountId,
			@GraphQLName("pageSize") int pageSize,
		...
		return _applyComponentServiceObjects(
			...
			skuResource -> new SkuPage(
				skuResource.getChannelIdProductSkusPage(
					id, productId, accountId, Pagination.of(page, pageSize))));
	}
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {channelIdWishLists(accountId: ___, id: ___, page: ___, pageSize: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField(description = "Retrieves wishlists for a given channel.")
	public WishListPage channelIdWishLists(
			@GraphQLName("id") Long id,
			@GraphQLName("accountId") Long accountId,
			@GraphQLName("pageSize") int pageSize,
			@GraphQLName("page") int page)
		...
		return _applyComponentServiceObjects(
			...
			wishListResource -> new WishListPage(
				wishListResource.getChannelIdWishListsPage(
					id, accountId, Pagination.of(page, pageSize))));
	}

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {wishList(id: ___){defaultWishList, id, name, wishListItems}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField(description = "Retrieves a wishlist by wishListId.")
	public WishList wishList(@GraphQLName("id") Long id) throws Exception {
		return _applyComponentServiceObjects(
			_wishListResourceComponentServiceObjects,
			this::_populateResourceContext,
			wishListResource -> wishListResource.getWishList(id));
	}

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {wishListItem(accountId: ___, id: ___){finalPrice, friendlyURL, icon, id, productId, productName, skuId}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {wishlistIdWishListItems(accountId: ___, id: ___, page: ___, pageSize: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField(
		description = "Retrieves wishlist items by wishListId for a specific channel and account"
	)
	public WishListItemPage wishlistIdWishListItems(
			@GraphQLName("id") Long id,
			@GraphQLName("accountId") Long accountId,
			@GraphQLName("pageSize") int pageSize,
			@GraphQLName("page") int page)
		...
		return _applyComponentServiceObjects(
			...
			wishListItemResource -> new WishListItemPage(
				wishListItemResource.getWishlistIdWishListItemsPage(
					id, accountId, Pagination.of(page, pageSize))));
	}
	...
	@GraphQLName("ImagePage")
	public class ImagePage {

		public ImagePage(Page imagePage) {
			actions = imagePage.getActions();

			items = imagePage.getItems();
			lastPage = imagePage.getLastPage();
			page = imagePage.getPage();
			pageSize = imagePage.getPageSize();
			totalCount = imagePage.getTotalCount();
		}
		...
		@GraphQLField
		protected java.util.Collection<Image> items;
	...
	private void _populateResourceContext(ImageResource imageResource)
		throws Exception {

		imageResource.setContextAcceptLanguage(_acceptLanguage);
		imageResource.setContextCompany(_company);
		imageResource.setContextHttpServletRequest(_httpServletRequest);
		imageResource.setContextHttpServletResponse(_httpServletResponse);
		imageResource.setContextUriInfo(_uriInfo);
		imageResource.setContextUser(_user);
		imageResource.setGroupLocalService(_groupLocalService);
		imageResource.setRoleLocalService(_roleLocalService);
	}
	...
	private static ComponentServiceObjects<ChannelResource>
		_channelResourceComponentServiceObjects;
	private static ComponentServiceObjects<ImageResource>
		_imageResourceComponentServiceObjects;
