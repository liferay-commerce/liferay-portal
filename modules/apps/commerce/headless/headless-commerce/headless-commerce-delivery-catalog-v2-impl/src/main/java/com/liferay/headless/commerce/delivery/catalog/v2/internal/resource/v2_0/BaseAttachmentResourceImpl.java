...
public abstract class BaseAttachmentResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-delivery-catalog/v2.0/channels/{id}/products/{productId}/attachments'  -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/channels/{id}/products/{productId}/attachments")
