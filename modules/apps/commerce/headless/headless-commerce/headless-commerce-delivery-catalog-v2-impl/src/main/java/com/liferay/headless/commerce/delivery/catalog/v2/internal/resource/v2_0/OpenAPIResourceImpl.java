...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Headless Commerce Delivery Catalog v2 API. A Java client JAR is available for use with the group ID 'com.liferay', artifact ID 'com.liferay.headless.commerce.delivery.catalog.v2.client', and version '1.0.0'.", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "Headless Commerce Delivery Catalog API", version = "v2.0")
)
@Path("/v2.0")
