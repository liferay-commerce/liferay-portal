...
public abstract class BaseOrderTypeChannelResourceImpl
	...
	@jakarta.ws.rs.Path("/order-type-channels/{orderTypeChannelId}")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public void deleteOrderTypeChannel(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.PathParam("orderTypeChannelId")
	...
	@jakarta.ws.rs.DELETE
	@jakarta.ws.rs.Path("/order-type-channels/batch")
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/order-types/{id}/order-type-channels")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path("/order-types/order-type-channels/batch")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
...
// LIFERAY-REST-BUILDER-HASH:-793484717