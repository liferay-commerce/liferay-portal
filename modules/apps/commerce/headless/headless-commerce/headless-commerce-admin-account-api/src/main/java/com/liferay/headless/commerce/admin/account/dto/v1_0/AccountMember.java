...
public class AccountMember implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Idempotency key for the membership; must be unique per membership within the company.",
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "External reference code of the user attached as a member. Alternative to `email` or `userId` on POST; resolved against the platform user directory and rejected when no matching user exists.",
		example = "AB-34098-789-N"
	)
...
// LIFERAY-REST-BUILDER-HASH:-444487077