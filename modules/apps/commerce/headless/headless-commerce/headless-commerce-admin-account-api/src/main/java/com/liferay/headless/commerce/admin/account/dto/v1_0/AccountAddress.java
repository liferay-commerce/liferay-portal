...
public class AccountAddress implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Country code in ISO 3166-1 alpha-2 form. Required on create; resolved against the platform's country list and rejected when no matching country exists for the company.",
		example = "US"
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Region code in ISO 3166-2 form. Required when the country has registered regions; resolved against the regions registered on the country and left blank when unresolved.",
		example = "CA"
	)
...
// LIFERAY-REST-BUILDER-HASH:-734314400