...
public class AccountOrganization implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "External reference code of the linked organization. Alternative to `organizationId` on POST; resolved against the platform organization directory and rejected when no matching organization exists.",
...
// LIFERAY-REST-BUILDER-HASH:-1263004034