...
public class Account implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Addresses owned by this account. Persisted in the same transaction when supplied on POST or PATCH; existing addresses are matched by `id` and updated when supplied, otherwise added.",
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Members (user-to-account links) on this account. Each member carries the user's account-scoped roles. Persisted in the same transaction when supplied on POST or PATCH; existing memberships are not removed.",
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Organizations linked to this account. Persisted in the same transaction when supplied on POST or PATCH; existing links are not removed.",
...
// LIFERAY-REST-BUILDER-HASH:-566181294