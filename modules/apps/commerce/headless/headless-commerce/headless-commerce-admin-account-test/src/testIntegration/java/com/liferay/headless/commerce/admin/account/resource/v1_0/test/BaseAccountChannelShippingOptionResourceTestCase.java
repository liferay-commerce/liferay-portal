...
public abstract class BaseAccountChannelShippingOptionResourceTestCase {
	...
	@Test
	public void testGetAccountByExternalReferenceCodeChannelAccountChannelShippingOptionPage()
		throws Exception {

		Long channelId =
			testGetAccountByExternalReferenceCodeChannelAccountChannelShippingOptionPage_getChannelId();
		Long irrelevantChannelId =
			testGetAccountByExternalReferenceCodeChannelAccountChannelShippingOptionPage_getIrrelevantChannelId();
		String externalReferenceCode =
			testGetAccountByExternalReferenceCodeChannelAccountChannelShippingOptionPage_getExternalReferenceCode();
		String irrelevantExternalReferenceCode =
			testGetAccountByExternalReferenceCodeChannelAccountChannelShippingOptionPage_getIrrelevantExternalReferenceCode();

		Page<AccountChannelShippingOption> page =
			accountChannelShippingOptionResource.
				getAccountByExternalReferenceCodeChannelAccountChannelShippingOptionPage(
					channelId, externalReferenceCode, Pagination.of(1, 10));
		...
		if ((irrelevantChannelId != null) &&
			...
			AccountChannelShippingOption
				irrelevantAccountChannelShippingOption =
					testGetAccountByExternalReferenceCodeChannelAccountChannelShippingOptionPage_addAccountChannelShippingOption(
						irrelevantChannelId, irrelevantExternalReferenceCode,
	...
	@Test
	public void testGetAccountByExternalReferenceCodeChannelAccountChannelShippingOptionPageWithPagination()
		throws Exception {
		...
		Page<AccountChannelShippingOption> page1 =
			accountChannelShippingOptionResource.
				getAccountByExternalReferenceCodeChannelAccountChannelShippingOptionPage(
					channelId, externalReferenceCode, Pagination.of(1, 2));
		...
		Page<AccountChannelShippingOption> page2 =
			accountChannelShippingOptionResource.
				getAccountByExternalReferenceCodeChannelAccountChannelShippingOptionPage(
					channelId, externalReferenceCode, Pagination.of(2, 2));
		...
		Page<AccountChannelShippingOption> page3 =
			accountChannelShippingOptionResource.
				getAccountByExternalReferenceCodeChannelAccountChannelShippingOptionPage(
					channelId, externalReferenceCode, Pagination.of(1, 3));
	...
	@Test
	public void testPostAccountByExternalReferenceCodeChannelAccountChannelShippingOption()
		throws Exception {
		...
		AccountChannelShippingOption postAccountChannelShippingOption =
			testPostAccountByExternalReferenceCodeChannelAccountChannelShippingOption_addAccountChannelShippingOption(
				randomAccountChannelShippingOption);
	...
	@Test
	public void testGetAccountIdChannelAccountChannelShippingOptionPage()
		throws Exception {

		Long channelId =
			testGetAccountIdChannelAccountChannelShippingOptionPage_getChannelId();
		Long irrelevantChannelId =
			testGetAccountIdChannelAccountChannelShippingOptionPage_getIrrelevantChannelId();
		Long id =
			testGetAccountIdChannelAccountChannelShippingOptionPage_getId();
		Long irrelevantId =
			testGetAccountIdChannelAccountChannelShippingOptionPage_getIrrelevantId();

		Page<AccountChannelShippingOption> page =
			accountChannelShippingOptionResource.
				getAccountIdChannelAccountChannelShippingOptionPage(
					channelId, id, Pagination.of(1, 10));

		Assert.assertEquals(0, page.getTotalCount());

		if ((irrelevantChannelId != null) && (irrelevantId != null)) {
			AccountChannelShippingOption
				irrelevantAccountChannelShippingOption =
					testGetAccountIdChannelAccountChannelShippingOptionPage_addAccountChannelShippingOption(
						irrelevantChannelId, irrelevantId,
						randomIrrelevantAccountChannelShippingOption());

			page =
				accountChannelShippingOptionResource.
					getAccountIdChannelAccountChannelShippingOptionPage(
						irrelevantChannelId, irrelevantId, Pagination.of(1, 2));
		...
		AccountChannelShippingOption accountChannelShippingOption1 =
			testGetAccountIdChannelAccountChannelShippingOptionPage_addAccountChannelShippingOption(
				channelId, id, randomAccountChannelShippingOption());
	...
	@Test
	public void testGetAccountIdChannelAccountChannelShippingOptionPageWithPagination()
		throws Exception {
		...
		Page<AccountChannelShippingOption> page1 =
			accountChannelShippingOptionResource.
				getAccountIdChannelAccountChannelShippingOptionPage(
					channelId, id, Pagination.of(1, 2));
		...
		Page<AccountChannelShippingOption> page2 =
			accountChannelShippingOptionResource.
				getAccountIdChannelAccountChannelShippingOptionPage(
					channelId, id, Pagination.of(2, 2));
		...
		Page<AccountChannelShippingOption> page3 =
			accountChannelShippingOptionResource.
				getAccountIdChannelAccountChannelShippingOptionPage(
					channelId, id, Pagination.of(1, 3));
	...
	@Test
	public void testPostAccountIdChannelAccountChannelShippingOption()
		throws Exception {
		...
		AccountChannelShippingOption postAccountChannelShippingOption =
			testPostAccountIdChannelAccountChannelShippingOption_addAccountChannelShippingOption(
				randomAccountChannelShippingOption);
