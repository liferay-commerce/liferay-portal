...
public interface SkuResource {
	...
	public HttpInvoker.HttpResponse
			putSkuByExternalReferenceCodeChangeExternalReferenceCodeNewExternalReferenceCodeHttpResponse(
				String externalReferenceCode, String newExternalReferenceCode)
		throws Exception;
	...
	public static class SkuResourceImpl implements SkuResource {
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/skus/by-externalReferenceCode/{externalReferenceCode}/change-external-reference-code/{newExternalReferenceCode}");

			httpInvoker.path("externalReferenceCode", externalReferenceCode);
			httpInvoker.path(
				"newExternalReferenceCode", newExternalReferenceCode);
