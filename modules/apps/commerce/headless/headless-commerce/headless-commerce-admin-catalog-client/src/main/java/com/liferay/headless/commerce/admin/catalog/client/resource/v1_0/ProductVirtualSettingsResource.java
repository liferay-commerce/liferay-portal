...
public interface ProductVirtualSettingsResource {
	...
	public HttpInvoker.HttpResponse
			getSkuByExternalReferenceCodeVirtualSettingsHttpResponse(
				String externalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getSkuIdVirtualSettingsHttpResponse(Long id)
		throws Exception;
	...
	public static class ProductVirtualSettingsResourceImpl
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/skus/by-externalReferenceCode/{externalReferenceCode}/virtual-settings");
		...
		public ProductVirtualSettings getSkuIdVirtualSettings(Long id)
			...
			HttpInvoker.HttpResponse httpResponse =
				getSkuIdVirtualSettingsHttpResponse(id);
		...
		public HttpInvoker.HttpResponse getSkuIdVirtualSettingsHttpResponse(
				Long id)
			throws Exception {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v1.0/skus/{id}/virtual-settings");
