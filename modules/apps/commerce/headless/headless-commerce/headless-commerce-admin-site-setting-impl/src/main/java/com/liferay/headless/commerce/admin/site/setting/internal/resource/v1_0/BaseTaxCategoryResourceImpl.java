...
public abstract class BaseTaxCategoryResourceImpl
	...
	@jakarta.ws.rs.Path("/taxCategory/{id}")
	...
	@jakarta.ws.rs.DELETE
	@jakarta.ws.rs.Path("/taxCategory/batch")
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/commerceAdminSiteSetting/{groupId}/taxCategory")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
...
// LIFERAY-REST-BUILDER-HASH:-147874650