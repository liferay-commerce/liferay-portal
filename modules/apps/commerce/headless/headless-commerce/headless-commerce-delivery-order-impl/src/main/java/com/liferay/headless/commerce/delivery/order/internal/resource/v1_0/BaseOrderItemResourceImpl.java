...
public abstract class BaseOrderItemResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-delivery-order/v1.0/order-items/{orderItemId}'  -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/order-items/{orderItemId}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public OrderItem getOrderItem(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.validation.constraints.NotNull
			@javax.ws.rs.PathParam("orderItemId")
			Long orderItemId)
		throws Exception {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-delivery-order/v1.0/orders/{orderId}/items'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Retrive order items of a Order."
	)
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/orders/{orderId}/items")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
