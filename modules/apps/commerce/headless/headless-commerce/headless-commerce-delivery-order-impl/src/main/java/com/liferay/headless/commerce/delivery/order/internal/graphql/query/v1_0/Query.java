...
public class Query {
	 ...
	 */
	@GraphQLField(description = "Retrive placed order shipping address.")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {placedOrderComments(page: ___, pageSize: ___, placedOrderId: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	public PlacedOrderCommentPage placedOrderComments(
			@GraphQLName("placedOrderId") Long placedOrderId,
			@GraphQLName("pageSize") int pageSize,
			@GraphQLName("page") int page)
		throws Exception {
	 ...
	 */
	@GraphQLField(description = "Retrive placed order items.")
	...
	public class GetPlacedOrderCommentsPageTypeExtension {

		public GetPlacedOrderCommentsPageTypeExtension(
		...
		@GraphQLField
		public PlacedOrderCommentPage comments(
				@GraphQLName("pageSize") int pageSize,
				@GraphQLName("page") int page)
			throws Exception {
			...
			return _applyComponentServiceObjects(
				...
				placedOrderCommentResource -> new PlacedOrderCommentPage(
					placedOrderCommentResource.getPlacedOrderCommentsPage(
						_placedOrder.getId(), Pagination.of(page, pageSize))));
		}
