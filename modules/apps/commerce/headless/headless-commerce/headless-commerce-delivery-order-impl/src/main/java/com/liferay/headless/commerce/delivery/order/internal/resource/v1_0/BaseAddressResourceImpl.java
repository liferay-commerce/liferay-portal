...
public abstract class BaseAddressResourceImpl implements AddressResource {
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-delivery-order/v1.0/orders/{orderId}/billing-address'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Retrive order billing address."
	)
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/orders/{orderId}/billing-address")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Address getOrderBillingAddres(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-delivery-order/v1.0/orders/{orderId}/shipping-address'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Retrive order billing address."
	)
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/orders/{orderId}/shipping-address")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Address getOrderShippingAddres(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.validation.constraints.NotNull
			@javax.ws.rs.PathParam("orderId")
			Long orderId)
