...
public abstract class BaseShippingMethodResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-delivery-order/v1.0/orders/{orderId}/shipping-methods'  -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/orders/{orderId}/shipping-methods")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Page<ShippingMethod> getOrderShippingMethodsPage(
	...
	public Page<ShippingMethod> read(
		...
		if (parameters.containsKey("orderId")) {
			return getOrderShippingMethodsPage(
