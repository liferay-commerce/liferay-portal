...
public abstract class BasePaymentMethodResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-delivery-order/v1.0/orders/{orderId}/payment-methods'  -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/orders/{orderId}/payment-methods")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Page<PaymentMethod> getOrderPaymentMethodsPage(
	...
	public Page<PaymentMethod> read(
		...
		if (parameters.containsKey("orderId")) {
			return getOrderPaymentMethodsPage(
