...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Delivery.Cart.WorkflowExceptionMapper"
	},
	service = ExceptionMapper.class
)
@Provider
public class WorkflowExceptionMapper
	extends BaseExceptionMapper<CommerceWorkflowException> {

	@Override
	protected Problem getProblem(
		CommerceWorkflowException commerceWorkflowException) {

		return new Problem(commerceWorkflowException);
	}
