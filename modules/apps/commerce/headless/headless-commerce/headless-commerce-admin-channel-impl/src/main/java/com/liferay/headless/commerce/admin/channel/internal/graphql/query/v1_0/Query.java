...
public class Query {
	...
	@GraphQLTypeExtension(AccountAddressChannel.class)
	public class GetChannelTypeExtension {

		public GetChannelTypeExtension(
			AccountAddressChannel accountAddressChannel) {

			_accountAddressChannel = accountAddressChannel;
		}
		...
		public Channel channel() throws Exception {
			return _applyComponentServiceObjects(
				...
				channelResource -> channelResource.getChannel(
					_accountAddressChannel.getChannelId()));
		}

		private AccountAddressChannel _accountAddressChannel;
