...
public abstract class BaseAccountAddressChannelResourceImpl
	...
	@jakarta.ws.rs.Path("/account-address-channels/{accountAddressChannelId}")
	...
	@jakarta.ws.rs.DELETE
	@jakarta.ws.rs.Path("/account-address-channels/batch")
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path(
		"/account-addresses/{addressId}/account-address-channels"
	)
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Page<AccountAddressChannel>
			getAccountAddressIdAccountAddressChannelsPage(
				@io.swagger.v3.oas.annotations.Parameter(hidden = true)
				@jakarta.validation.constraints.NotNull
				@jakarta.ws.rs.PathParam("addressId")
				Long addressId,
				@io.swagger.v3.oas.annotations.Parameter(hidden = true)
...
// LIFERAY-REST-BUILDER-HASH:677612875