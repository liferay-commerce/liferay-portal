...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Channel.NoSuchAddressExceptionMapper"
	},
...
public class NoSuchAddressExceptionMapper
	...
	protected Problem getProblem(
		NoSuchAddressException noSuchAddressException) {

		return new Problem(
			Response.Status.NOT_FOUND, "Account Address not found");
	}
