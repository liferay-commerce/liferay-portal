...
public class SkuOptionUtil {
	...
	public static SkuOption[] getSkuOptions(
			...
			long cpInstanceId, CPInstanceHelper cpInstanceHelper,
			String languageId, JsonHelper jsonHelper)
		throws Exception {

		JSONArray keyValuesJSONArray = jsonHelper.toJSONArray(
		...
		Map<CPDefinitionOptionRel, List<CPDefinitionOptionValueRel>>
			cpDefinitionOptionRelsMap =
				cpInstanceHelper.getCPDefinitionOptionValueRelsMap(
