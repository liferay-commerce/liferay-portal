...
public abstract class BaseProductOptionResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-delivery-catalog/v2.0/channels/{channelId}/products/{productId}/product-options'  -u 'test@liferay.com:test'
	 */
