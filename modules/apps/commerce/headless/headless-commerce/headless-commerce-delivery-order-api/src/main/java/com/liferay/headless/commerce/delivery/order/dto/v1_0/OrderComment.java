 ...
 */
@Generated("")
@GraphQLName("OrderComment")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "OrderComment")
public class OrderComment implements Serializable {

	public static OrderComment toDTO(String json) {
		return ObjectMapperUtil.readValue(OrderComment.class, json);
	}

	public static OrderComment unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(OrderComment.class, json);
	}
	...
	public boolean equals(Object object) {
		...
		OrderComment orderComment = (OrderComment)object;

		return Objects.equals(toString(), orderComment.toString());
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.headless.commerce.delivery.order.dto.v1_0.OrderComment",
		name = "x-class-name"
	)
