...
public class Order implements Serializable {
	...
	@Schema
	@Valid
	public OrderComment[] getNotes() {
		return notes;
	}

	public void setNotes(OrderComment[] notes) {
		this.notes = notes;
	}

	@JsonIgnore
	public void setNotes(
		UnsafeSupplier<OrderComment[], Exception> notesUnsafeSupplier) {
