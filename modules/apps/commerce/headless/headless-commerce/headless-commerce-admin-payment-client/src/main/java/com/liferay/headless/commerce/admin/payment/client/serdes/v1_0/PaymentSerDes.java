...
public class PaymentSerDes {
	...
	public static String toJSON(Payment payment) {
		...
		if (payment.getPaymentStatusInfo() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(String.valueOf(payment.getPaymentStatusInfo()));
		}
	...
	public static Map<String, String> toMap(Payment payment) {
		...
		if (payment.getPaymentStatusInfo() == null) {
			...
			map.put(
				"paymentStatusInfo",
				String.valueOf(payment.getPaymentStatusInfo()));
		}
