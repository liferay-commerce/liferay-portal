...
import com.liferay.headless.commerce.delivery.catalog.v2.client.dto.v2_0.Channel;
...
import com.liferay.headless.commerce.delivery.catalog.v2.client.serdes.v2_0.ChannelSerDes;
	...
	public static class ChannelResourceImpl implements ChannelResource {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-catalog/v2.0/channels");
		...
		public HttpInvoker.HttpResponse postChannelsPageExportBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-catalog/v2.0/channels/export-batch");
