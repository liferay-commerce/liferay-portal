...
public interface ProductSpecificationResource {
	...
	public HttpInvoker.HttpResponse
			getChannelIdProductProductSpecificationsPageHttpResponse(
				Long id, Long productId, Pagination pagination)
		throws Exception;
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-catalog/v2.0/channels/{id}/products/{productId}/product-specifications");
