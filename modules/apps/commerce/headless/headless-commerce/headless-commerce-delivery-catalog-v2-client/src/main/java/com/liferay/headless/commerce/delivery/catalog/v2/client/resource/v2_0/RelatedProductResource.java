...
public interface RelatedProductResource {
	...
	public Page<RelatedProduct> getChannelIdProductRelatedProductsPage(
			Long id, Long productId, String type, Pagination pagination)
		throws Exception;

	public HttpInvoker.HttpResponse
			getChannelIdProductRelatedProductsPageHttpResponse(
				Long id, Long productId, String type, Pagination pagination)
		throws Exception;
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-catalog/v2.0/channels/{id}/products/{productId}/related-products");
