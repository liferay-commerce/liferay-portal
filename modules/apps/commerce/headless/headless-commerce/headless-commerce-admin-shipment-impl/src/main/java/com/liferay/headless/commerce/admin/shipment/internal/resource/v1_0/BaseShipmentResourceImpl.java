...
public abstract class BaseShipmentResourceImpl
	...
	@io.swagger.v3.oas.annotations.Operation(
		description = "Deletes the CommerceShipment identified by shipmentId. Calls CommerceShipmentService.deleteCommerceShipment with restoreStockQuantity=false; the row is removed without re-crediting the shipped quantity back to the order items."
	)
	 ...
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Deletes the CommerceShipment identified by external reference code. Resolves the row via CommerceShipmentService.fetchCommerceShipmentByExternalReferenceCode against the current company scope and calls deleteCommerceShipment with restoreStockQuantity=false; raises NoSuchShipmentException (404) when the ERC is unknown."
	)
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	 ...
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Returns the CommerceShipment identified by shipmentId. Read-only fetch through CommerceShipmentService.getCommerceShipment; the response includes the actions HATEOAS map for the current user."
	)
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	 ...
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Returns the CommerceShipment identified by external reference code. Resolves the row via CommerceShipmentService.fetchCommerceShipmentByExternalReferenceCode against the current company scope; raises NoSuchShipmentException (404) when the ERC is unknown."
	)
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	 ...
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Lists CommerceShipment rows for the current company through Liferay's SearchUtil with status set to STATUS_ANY (all workflow states returned). Supports OData v4 filter, full-text search across the shipment's indexed fields, sort, and one-based page/pageSize pagination; the filter and sort fields are sourced from CommerceShipment's entity model."
	)
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	 ...
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Updates the CommerceShipment identified by external reference code using JSON Merge Patch (only the supplied fields are modified). Resolves the row, applies carrier, trackingNumber, trackingURL, expectedDate, shippingDate, and shippingMethodId via CommerceShipmentService.updateCommerceShipment, and replays the nested shippingAddress and shipmentItems collections when supplied. Raises NoSuchShipmentException (404) when the ERC is unknown; domain validation (inactive warehouse, malformed address) maps to 422."
	)
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	 ...
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Creates a CommerceShipment for an existing CommerceOrder identified by orderId (preferred) or orderExternalReferenceCode. Resolves the order, then calls CommerceShipmentService.addCommerceShipment cloning the order's groupId, accountId, shippingAddressId, shippingMethodId, and shippingOptionName. Applies the optional carrier, trackingNumber, trackingURL, expectedDate, and shippingDate via updateCommerceShipment; when shippingAddress is supplied the linked CommerceAddress is updated in place, and when shipmentItems is supplied every existing item is replaced. Raises NoSuchOrderException (404) when orderExternalReferenceCode is unknown; domain validation (inactive warehouse, invalid shipping address) maps to 422."
	)
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "Shipment")}
	)
	 ...
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Transitions the CommerceShipment identified by external reference code to the DELIVERED workflow state (code 3). Resolves the parent shipment via fetchCommerceShipmentByExternalReferenceCode and calls CommerceShipmentService.updateStatus with SHIPMENT_STATUS_DELIVERED; raises NoSuchShipmentException (404) when the ERC is unknown and CommerceShipmentStatusException (400) when the transition is not allowed from the current state."
	)
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	 ...
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Transitions the CommerceShipment identified by external reference code to the READY_TO_BE_SHIPPED workflow state (code 1). Resolves the parent shipment via fetchCommerceShipmentByExternalReferenceCode and calls CommerceShipmentService.updateStatus with SHIPMENT_STATUS_READY_TO_BE_SHIPPED; raises NoSuchShipmentException (404) when the ERC is unknown and CommerceShipmentStatusException (400) when the transition is not allowed from the current state."
	)
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	 ...
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Transitions the CommerceShipment identified by external reference code to the SHIPPED workflow state (code 2). Resolves the parent shipment via fetchCommerceShipmentByExternalReferenceCode and calls CommerceShipmentService.updateStatus with SHIPMENT_STATUS_SHIPPED; raises NoSuchShipmentException (404) when the ERC is unknown and CommerceShipmentStatusException (400) when the transition is not allowed from the current state."
	)
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	 ...
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Transitions the CommerceShipment identified by shipmentId to the DELIVERED workflow state (code 3). Calls CommerceShipmentService.updateStatus with SHIPMENT_STATUS_DELIVERED; raises CommerceShipmentStatusException (400) when the transition is not allowed from the current state."
	)
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	 ...
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Transitions the CommerceShipment identified by shipmentId to the READY_TO_BE_SHIPPED workflow state (code 1). Calls CommerceShipmentService.updateStatus with SHIPMENT_STATUS_READY_TO_BE_SHIPPED; raises CommerceShipmentStatusException (400) when the transition is not allowed from the current state."
	)
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	 ...
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Transitions the CommerceShipment identified by shipmentId to the SHIPPED workflow state (code 2). Calls CommerceShipmentService.updateStatus with SHIPMENT_STATUS_SHIPPED; raises CommerceShipmentStatusException (400) when the transition is not allowed from the current state."
	)
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	 ...
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Upserts the CommerceShipment identified by external reference code. When the ERC resolves, the row is updated through CommerceShipmentService.updateCommerceShipment and the nested shippingAddress and shipmentItems collections are replayed; when the ERC is unknown, the request body's orderId is used to resolve the source CommerceOrder and addCommerceShipment is invoked to seed a new shipment from the order's groupId, accountId, shippingAddressId, shippingMethodId, and shippingOptionName. Domain validation maps to 422."
	)
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
...
// LIFERAY-REST-BUILDER-HASH:553712459