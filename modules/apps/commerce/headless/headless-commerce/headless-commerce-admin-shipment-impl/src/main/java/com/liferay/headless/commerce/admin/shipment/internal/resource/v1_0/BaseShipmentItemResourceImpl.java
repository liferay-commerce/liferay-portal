...
public abstract class BaseShipmentItemResourceImpl
	...
	@jakarta.ws.rs.Path("/shipment-items/{shipmentItemId}")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public void deleteShipmentItem(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.PathParam("shipmentItemId")
			Long shipmentItemId)
		throws Exception {
	}
	...
	@jakarta.ws.rs.DELETE
	@jakarta.ws.rs.Path("/shipment-items/batch")
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/shipments/{shipmentId}/items")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
