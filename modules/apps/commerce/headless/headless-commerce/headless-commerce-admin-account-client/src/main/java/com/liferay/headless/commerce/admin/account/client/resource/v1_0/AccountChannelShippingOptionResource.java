...
public interface AccountChannelShippingOptionResource {
	...
	public HttpInvoker.HttpResponse
			getAccountByExternalReferenceCodeChannelAccountChannelShippingOptionPageHttpResponse(
				Long channelId, String externalReferenceCode,
				Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postAccountByExternalReferenceCodeChannelAccountChannelShippingOptionHttpResponse(
				Long channelId, String externalReferenceCode,
				AccountChannelShippingOption accountChannelShippingOption)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getAccountIdChannelAccountChannelShippingOptionPageHttpResponse(
				Long channelId, Long id, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			postAccountIdChannelAccountChannelShippingOptionHttpResponse(
				Long channelId, Long id,
				AccountChannelShippingOption accountChannelShippingOption)
		throws Exception;
	...
	public static class AccountChannelShippingOptionResourceImpl
		...
		public Page<AccountChannelShippingOption>
			...
			HttpInvoker.HttpResponse httpResponse =
				getAccountByExternalReferenceCodeChannelAccountChannelShippingOptionPageHttpResponse(
					channelId, externalReferenceCode, pagination);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-account/v1.0/accounts/by-externalReferenceCode/{externalReferenceCode}/channels/{channelId}/account-channel-shipping-option");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-account/v1.0/accounts/{id}/channels/{channelId}/account-channel-shipping-option");
