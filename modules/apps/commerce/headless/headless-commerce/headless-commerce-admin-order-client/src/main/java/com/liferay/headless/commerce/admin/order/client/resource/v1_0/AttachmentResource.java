...
public interface AttachmentResource {
	...
	public HttpInvoker.HttpResponse deleteOrderAttachmentHttpResponse(
			Long orderId, Long attachmentId)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getOrderAttachmentHttpResponse(
			Long orderId, Long attachmentId)
		throws Exception;

	public void getOrderAttachmentContent(Long orderId, Long attachmentId)
		throws Exception;

	public HttpInvoker.HttpResponse getOrderAttachmentContentHttpResponse(
			Long orderId, Long attachmentId)
		throws Exception;

	public Page<Attachment> getOrderAttachmentsPage(
			Long orderId, String search, String filterString,
			Pagination pagination, String sortString)
		throws Exception;

	public HttpInvoker.HttpResponse getOrderAttachmentsPageHttpResponse(
			Long orderId, String search, String filterString,
			Pagination pagination, String sortString)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getOrderByExternalReferenceCodeAttachmentsPageHttpResponse(
	...
	public HttpInvoker.HttpResponse patchOrderAttachmentHttpResponse(
			Long orderId, Long attachmentId, Attachment attachment)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			patchOrderByExternalReferenceCodeAttachmentByExternalReferenceCodeHttpResponse(
				String externalReferenceCode,
				String attachmentExternalReferenceCode, Attachment attachment)
		throws Exception;
	...
	public HttpInvoker.HttpResponse postOrderAttachmentHttpResponse(
	...
	public HttpInvoker.HttpResponse
			postOrderByExternalReferenceCodeAttachmentHttpResponse(
				String externalReferenceCode, Attachment attachment)
		throws Exception;
	...
	public static class AttachmentResourceImpl implements AttachmentResource {
		...
		public void deleteOrderAttachment(Long orderId, Long attachmentId)
			...
			HttpInvoker.HttpResponse httpResponse =
				deleteOrderAttachmentHttpResponse(orderId, attachmentId);
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-order/v1.0/orders/{orderId}/attachments/{attachmentId}");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-order/v1.0/orders/by-externalReferenceCode/{externalReferenceCode}/attachments/by-externalReferenceCode/{attachmentExternalReferenceCode}");
		...
		public Attachment getOrderAttachment(Long orderId, Long attachmentId)
			...
			HttpInvoker.HttpResponse httpResponse =
				getOrderAttachmentHttpResponse(orderId, attachmentId);
		...
		public void getOrderAttachmentContent(Long orderId, Long attachmentId)
			...
			HttpInvoker.HttpResponse httpResponse =
				getOrderAttachmentContentHttpResponse(orderId, attachmentId);
		...
		public HttpInvoker.HttpResponse getOrderAttachmentContentHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-order/v1.0/orders/{orderId}/attachments/{attachmentId}/content");
		...
		public Page<Attachment> getOrderAttachmentsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getOrderAttachmentsPageHttpResponse(
					orderId, search, filterString, pagination, sortString);
		...
		public HttpInvoker.HttpResponse getOrderAttachmentsPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-order/v1.0/orders/{orderId}/attachments");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-order/v1.0/orders/by-externalReferenceCode/{externalReferenceCode}/attachments");
		...
		public Attachment patchOrderAttachment(
			...
			HttpInvoker.HttpResponse httpResponse =
				patchOrderAttachmentHttpResponse(
		...
		public Attachment postOrderAttachment(
			...
			HttpInvoker.HttpResponse httpResponse =
				postOrderAttachmentHttpResponse(orderId, attachment);
...
// LIFERAY-REST-BUILDER-HASH:-2002341156