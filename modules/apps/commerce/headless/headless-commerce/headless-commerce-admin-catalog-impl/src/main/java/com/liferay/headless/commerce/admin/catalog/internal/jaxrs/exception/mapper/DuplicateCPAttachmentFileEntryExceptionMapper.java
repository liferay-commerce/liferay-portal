...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.DuplicateCPAttachmentFileEntryExceptionMapper"
	},
	service = ExceptionMapper.class
)
@Provider
public class DuplicateCPAttachmentFileEntryExceptionMapper
