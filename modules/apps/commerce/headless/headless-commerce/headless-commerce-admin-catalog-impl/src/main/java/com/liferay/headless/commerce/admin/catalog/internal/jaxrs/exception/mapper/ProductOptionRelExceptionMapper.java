...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.ProductOptionRelExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class ProductOptionRelExceptionMapper
	...
	protected Problem getProblem(
		...
		return new Problem(
			Response.Status.BAD_REQUEST, "Option is linked to a Product");
	}
