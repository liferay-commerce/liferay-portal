...
import com.liferay.headless.commerce.delivery.catalog.client.resource.v2_0.SkuResource;
import com.liferay.headless.commerce.delivery.catalog.client.serdes.v2_0.SkuSerDes;
...
public abstract class BaseSkuResourceTestCase {
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(
					com.liferay.headless.commerce.delivery.catalog.dto.v2_0.Sku.
						class)) {
	...
	@Inject
	private
		com.liferay.headless.commerce.delivery.catalog.resource.v2_0.SkuResource
			_skuResource;
