...
import com.liferay.headless.commerce.delivery.catalog.v2.client.dto.v2_0.WishList;
...
import com.liferay.headless.commerce.delivery.catalog.v2.client.resource.v2_0.WishListResource;
import com.liferay.headless.commerce.delivery.catalog.v2.client.serdes.v2_0.WishListSerDes;
...
public abstract class BaseWishListResourceTestCase {
	...
	@Test
	public void testGetChannelIdWishListsPage() throws Exception {
		Long id = testGetChannelIdWishListsPage_getId();
		Long irrelevantId = testGetChannelIdWishListsPage_getIrrelevantId();

		Page<WishList> page = wishListResource.getChannelIdWishListsPage(
		...
		if (irrelevantId != null) {
			WishList irrelevantWishList =
				testGetChannelIdWishListsPage_addWishList(
					irrelevantId, randomIrrelevantWishList());

			page = wishListResource.getChannelIdWishListsPage(
			...
			assertValid(
				page,
				testGetChannelIdWishListsPage_getExpectedActions(irrelevantId));
		}

		WishList wishList1 = testGetChannelIdWishListsPage_addWishList(
			id, randomWishList());

		WishList wishList2 = testGetChannelIdWishListsPage_addWishList(
			id, randomWishList());
		...
		assertEqualsIgnoringOrder(
			...
			(List<WishList>)page.getItems());
		assertValid(page, testGetChannelIdWishListsPage_getExpectedActions(id));
	...
	protected Map<String, Map<String, String>>
			testGetChannelIdWishListsPage_getExpectedActions(Long id)
		throws Exception {
	...
	@Test
	public void testGetChannelIdWishListsPageWithPagination() throws Exception {
		Long id = testGetChannelIdWishListsPage_getId();
		...
		WishList wishList3 = testGetChannelIdWishListsPage_addWishList(
			id, randomWishList());

		Page<WishList> page1 = wishListResource.getChannelIdWishListsPage(
		...
		Page<WishList> page2 = wishListResource.getChannelIdWishListsPage(
		...
		Page<WishList> page3 = wishListResource.getChannelIdWishListsPage(
	...
	protected WishList testGetChannelIdWishListsPage_addWishList(
			Long id, WishList wishList)
		throws Exception {
	...
	protected Long testGetChannelIdWishListsPage_getId() throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}

	protected Long testGetChannelIdWishListsPage_getIrrelevantId()
		throws Exception {
	...
	@Test
	public void testPostChannelIdWishList() throws Exception {
		WishList randomWishList = randomWishList();

		WishList postWishList = testPostChannelIdWishList_addWishList(
			randomWishList);
	...
	protected WishList testPostChannelIdWishList_addWishList(WishList wishList)
		throws Exception {
