...
import com.liferay.headless.commerce.delivery.catalog.v2.client.dto.v2_0.Attachment;
...
import com.liferay.headless.commerce.delivery.catalog.v2.client.resource.v2_0.AttachmentResource;
import com.liferay.headless.commerce.delivery.catalog.v2.client.serdes.v2_0.AttachmentSerDes;
...
public abstract class BaseAttachmentResourceTestCase {
	...
	@Test
	public void testGetChannelIdProductAttachmentsPage() throws Exception {
		Long id = testGetChannelIdProductAttachmentsPage_getId();
		Long irrelevantId =
			testGetChannelIdProductAttachmentsPage_getIrrelevantId();
		Long productId = testGetChannelIdProductAttachmentsPage_getProductId();
		Long irrelevantProductId =
			testGetChannelIdProductAttachmentsPage_getIrrelevantProductId();
		...
		if ((irrelevantId != null) && (irrelevantProductId != null)) {
			Attachment irrelevantAttachment =
				testGetChannelIdProductAttachmentsPage_addAttachment(
					irrelevantId, irrelevantProductId,
					randomIrrelevantAttachment());

			page = attachmentResource.getChannelIdProductAttachmentsPage(
			...
			assertValid(
				page,
				testGetChannelIdProductAttachmentsPage_getExpectedActions(
					irrelevantId, irrelevantProductId));
		}

		Attachment attachment1 =
			testGetChannelIdProductAttachmentsPage_addAttachment(
				id, productId, randomAttachment());
	...
	@Test
	public void testGetChannelIdProductAttachmentsPageWithPagination()
		throws Exception {
	...
	protected Attachment testGetChannelIdProductAttachmentsPage_addAttachment(
			Long id, Long productId, Attachment attachment)
		throws Exception {
	...
	protected Long testGetChannelIdProductAttachmentsPage_getId()
		throws Exception {
	...
	protected Long testGetChannelIdProductAttachmentsPage_getIrrelevantId()
		throws Exception {

		return null;
	}

	protected Long testGetChannelIdProductAttachmentsPage_getProductId()
		throws Exception {
