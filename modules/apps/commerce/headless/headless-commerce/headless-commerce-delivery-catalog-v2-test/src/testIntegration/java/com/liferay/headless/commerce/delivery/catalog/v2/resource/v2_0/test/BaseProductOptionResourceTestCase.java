...
import com.liferay.headless.commerce.delivery.catalog.v2.client.dto.v2_0.ProductOption;
...
import com.liferay.headless.commerce.delivery.catalog.v2.client.resource.v2_0.ProductOptionResource;
import com.liferay.headless.commerce.delivery.catalog.v2.client.serdes.v2_0.ProductOptionSerDes;
...
public abstract class BaseProductOptionResourceTestCase {
	...
	@Test
	public void testGetChannelIdProductProductOptionsPage() throws Exception {
		Long id = testGetChannelIdProductProductOptionsPage_getId();
		Long irrelevantId =
			testGetChannelIdProductProductOptionsPage_getIrrelevantId();
		Long productId =
			testGetChannelIdProductProductOptionsPage_getProductId();
		Long irrelevantProductId =
			testGetChannelIdProductProductOptionsPage_getIrrelevantProductId();
		...
		if ((irrelevantId != null) && (irrelevantProductId != null)) {
			ProductOption irrelevantProductOption =
				testGetChannelIdProductProductOptionsPage_addProductOption(
					irrelevantId, irrelevantProductId,
					randomIrrelevantProductOption());

			page = productOptionResource.getChannelIdProductProductOptionsPage(
			...
			assertValid(
				page,
				testGetChannelIdProductProductOptionsPage_getExpectedActions(
					irrelevantId, irrelevantProductId));
		}

		ProductOption productOption1 =
			testGetChannelIdProductProductOptionsPage_addProductOption(
				id, productId, randomProductOption());
	...
	@Test
	public void testGetChannelIdProductProductOptionsPageWithPagination()
		throws Exception {
	...
	protected ProductOption
			testGetChannelIdProductProductOptionsPage_addProductOption(
				Long id, Long productId, ProductOption productOption)
		throws Exception {
	...
	protected Long testGetChannelIdProductProductOptionsPage_getId()
		throws Exception {
	...
	protected Long testGetChannelIdProductProductOptionsPage_getIrrelevantId()
		throws Exception {

		return null;
	}

	protected Long testGetChannelIdProductProductOptionsPage_getProductId()
		throws Exception {
