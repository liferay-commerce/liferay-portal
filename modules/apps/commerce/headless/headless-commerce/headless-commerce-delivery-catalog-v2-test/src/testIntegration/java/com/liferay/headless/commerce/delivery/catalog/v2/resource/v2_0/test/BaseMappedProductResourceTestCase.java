...
import com.liferay.headless.commerce.delivery.catalog.v2.client.dto.v2_0.MappedProduct;
...
import com.liferay.headless.commerce.delivery.catalog.v2.client.resource.v2_0.MappedProductResource;
import com.liferay.headless.commerce.delivery.catalog.v2.client.serdes.v2_0.MappedProductSerDes;
...
public abstract class BaseMappedProductResourceTestCase {
	...
	@Test
	public void testGetChannelIdProductMappedProductsPage() throws Exception {
		Long id = testGetChannelIdProductMappedProductsPage_getId();
		Long irrelevantId =
			testGetChannelIdProductMappedProductsPage_getIrrelevantId();
		Long productId =
			testGetChannelIdProductMappedProductsPage_getProductId();
		Long irrelevantProductId =
			testGetChannelIdProductMappedProductsPage_getIrrelevantProductId();
		...
		if ((irrelevantId != null) && (irrelevantProductId != null)) {
			MappedProduct irrelevantMappedProduct =
				testGetChannelIdProductMappedProductsPage_addMappedProduct(
					irrelevantId, irrelevantProductId,
					randomIrrelevantMappedProduct());

			page = mappedProductResource.getChannelIdProductMappedProductsPage(
			...
			assertValid(
				page,
				testGetChannelIdProductMappedProductsPage_getExpectedActions(
					irrelevantId, irrelevantProductId));
		}

		MappedProduct mappedProduct1 =
			testGetChannelIdProductMappedProductsPage_addMappedProduct(
				id, productId, randomMappedProduct());
	...
	@Test
	public void testGetChannelIdProductMappedProductsPageWithPagination()
		throws Exception {
	...
	@Test
	public void testGetChannelIdProductMappedProductsPageWithSortDateTime()
		throws Exception {

		testGetChannelIdProductMappedProductsPageWithSort(
	...
	@Test
	public void testGetChannelIdProductMappedProductsPageWithSortDouble()
		throws Exception {
	...
	@Test
	public void testGetChannelIdProductMappedProductsPageWithSortInteger()
		throws Exception {
	...
	@Test
	public void testGetChannelIdProductMappedProductsPageWithSortString()
		throws Exception {
	...
	protected void testGetChannelIdProductMappedProductsPageWithSort(
		...
		mappedProduct1 =
			testGetChannelIdProductMappedProductsPage_addMappedProduct(
				id, productId, mappedProduct1);

		mappedProduct2 =
			testGetChannelIdProductMappedProductsPage_addMappedProduct(
				id, productId, mappedProduct2);
	...
	protected MappedProduct
			testGetChannelIdProductMappedProductsPage_addMappedProduct(
				Long id, Long productId, MappedProduct mappedProduct)
		throws Exception {
	...
	protected Long testGetChannelIdProductMappedProductsPage_getId()
		throws Exception {
	...
	protected Long testGetChannelIdProductMappedProductsPage_getIrrelevantId()
		throws Exception {

		return null;
	}

	protected Long testGetChannelIdProductMappedProductsPage_getProductId()
		throws Exception {
