...
import com.liferay.headless.commerce.delivery.catalog.v2.client.dto.v2_0.Pin;
...
import com.liferay.headless.commerce.delivery.catalog.v2.client.resource.v2_0.PinResource;
import com.liferay.headless.commerce.delivery.catalog.v2.client.serdes.v2_0.PinSerDes;
...
public abstract class BasePinResourceTestCase {
	...
	@Test
	public void testGetChannelIdProductPinsPage() throws Exception {
		Long id = testGetChannelIdProductPinsPage_getId();
		Long irrelevantId = testGetChannelIdProductPinsPage_getIrrelevantId();
		Long productId = testGetChannelIdProductPinsPage_getProductId();
		Long irrelevantProductId =
			testGetChannelIdProductPinsPage_getIrrelevantProductId();

		Page<Pin> page = pinResource.getChannelIdProductPinsPage(
			id, productId, null, null, Pagination.of(1, 10), null);

		Assert.assertEquals(0, page.getTotalCount());

		if ((irrelevantId != null) && (irrelevantProductId != null)) {
			Pin irrelevantPin = testGetChannelIdProductPinsPage_addPin(
				irrelevantId, irrelevantProductId, randomIrrelevantPin());

			page = pinResource.getChannelIdProductPinsPage(
				irrelevantId, irrelevantProductId, null, null,
			...
			assertValid(
				page,
				testGetChannelIdProductPinsPage_getExpectedActions(
					irrelevantId, irrelevantProductId));
		}

		Pin pin1 = testGetChannelIdProductPinsPage_addPin(
			id, productId, randomPin());

		Pin pin2 = testGetChannelIdProductPinsPage_addPin(
			id, productId, randomPin());
		...
		assertValid(
			page,
			testGetChannelIdProductPinsPage_getExpectedActions(id, productId));
	}
	...
	@Test
	public void testGetChannelIdProductPinsPageWithPagination()
		throws Exception {
		...
		Pin pin3 = testGetChannelIdProductPinsPage_addPin(
			id, productId, randomPin());

		Page<Pin> page1 = pinResource.getChannelIdProductPinsPage(
			id, productId, null, null, Pagination.of(1, 2), null);

		List<Pin> pins1 = (List<Pin>)page1.getItems();

		Assert.assertEquals(pins1.toString(), 2, pins1.size());

		Page<Pin> page2 = pinResource.getChannelIdProductPinsPage(
			id, productId, null, null, Pagination.of(2, 2), null);
		...
		Page<Pin> page3 = pinResource.getChannelIdProductPinsPage(
			id, productId, null, null, Pagination.of(1, 3), null);
	...
	@Test
	public void testGetChannelIdProductPinsPageWithSortDateTime()
		throws Exception {

		testGetChannelIdProductPinsPageWithSort(
	...
	@Test
	public void testGetChannelIdProductPinsPageWithSortDouble()
		throws Exception {
	...
	@Test
	public void testGetChannelIdProductPinsPageWithSortInteger()
		throws Exception {
	...
	@Test
	public void testGetChannelIdProductPinsPageWithSortString()
		throws Exception {
	...
	protected void testGetChannelIdProductPinsPageWithSort(
		...
		pin1 = testGetChannelIdProductPinsPage_addPin(id, productId, pin1);

		pin2 = testGetChannelIdProductPinsPage_addPin(id, productId, pin2);

		for (EntityField entityField : entityFields) {
			Page<Pin> ascPage = pinResource.getChannelIdProductPinsPage(
				id, productId, null, null, Pagination.of(1, 2),
				entityField.getName() + ":asc");

			assertEquals(
				Arrays.asList(pin1, pin2), (List<Pin>)ascPage.getItems());

			Page<Pin> descPage = pinResource.getChannelIdProductPinsPage(
				id, productId, null, null, Pagination.of(1, 2),
	...
	protected Pin testGetChannelIdProductPinsPage_addPin(
			Long id, Long productId, Pin pin)
		throws Exception {
	...
	protected Long testGetChannelIdProductPinsPage_getId() throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}

	protected Long testGetChannelIdProductPinsPage_getIrrelevantId()
		throws Exception {

		return null;
	}

	protected Long testGetChannelIdProductPinsPage_getProductId()
		throws Exception {
	...
	protected Long testGetChannelIdProductPinsPage_getIrrelevantProductId()
		throws Exception {
	...
	@Inject
	private
		com.liferay.headless.commerce.delivery.catalog.v2.resource.v2_0.
			PinResource _pinResource;
