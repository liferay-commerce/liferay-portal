...
import com.liferay.headless.commerce.delivery.catalog.v2.client.dto.v2_0.RelatedProduct;
...
import com.liferay.headless.commerce.delivery.catalog.v2.client.resource.v2_0.RelatedProductResource;
import com.liferay.headless.commerce.delivery.catalog.v2.client.serdes.v2_0.RelatedProductSerDes;
...
public abstract class BaseRelatedProductResourceTestCase {
	...
	@Test
	public void testGetChannelIdProductRelatedProductsPage() throws Exception {
		Long id = testGetChannelIdProductRelatedProductsPage_getId();
		Long irrelevantId =
			testGetChannelIdProductRelatedProductsPage_getIrrelevantId();
		Long productId =
			testGetChannelIdProductRelatedProductsPage_getProductId();
		Long irrelevantProductId =
			testGetChannelIdProductRelatedProductsPage_getIrrelevantProductId();

		Page<RelatedProduct> page =
			relatedProductResource.getChannelIdProductRelatedProductsPage(
				id, productId, RandomTestUtil.randomString(),
				Pagination.of(1, 10));
		...
		if ((irrelevantId != null) && (irrelevantProductId != null)) {
			RelatedProduct irrelevantRelatedProduct =
				testGetChannelIdProductRelatedProductsPage_addRelatedProduct(
					irrelevantId, irrelevantProductId,
					randomIrrelevantRelatedProduct());

			page =
				relatedProductResource.getChannelIdProductRelatedProductsPage(
					irrelevantId, irrelevantProductId, null,
					Pagination.of(1, 2));
			...
			assertValid(
				page,
				testGetChannelIdProductRelatedProductsPage_getExpectedActions(
					irrelevantId, irrelevantProductId));
		}

		RelatedProduct relatedProduct1 =
			testGetChannelIdProductRelatedProductsPage_addRelatedProduct(
				id, productId, randomRelatedProduct());

		RelatedProduct relatedProduct2 =
			testGetChannelIdProductRelatedProductsPage_addRelatedProduct(
				id, productId, randomRelatedProduct());

		page = relatedProductResource.getChannelIdProductRelatedProductsPage(
	...
	@Test
	public void testGetChannelIdProductRelatedProductsPageWithPagination()
		throws Exception {
	...
	protected RelatedProduct
			testGetChannelIdProductRelatedProductsPage_addRelatedProduct(
				Long id, Long productId, RelatedProduct relatedProduct)
		throws Exception {
	...
	protected Long testGetChannelIdProductRelatedProductsPage_getId()
		throws Exception {
	...
	protected Long testGetChannelIdProductRelatedProductsPage_getIrrelevantId()
		throws Exception {

		return null;
	}

	protected Long testGetChannelIdProductRelatedProductsPage_getProductId()
		throws Exception {
