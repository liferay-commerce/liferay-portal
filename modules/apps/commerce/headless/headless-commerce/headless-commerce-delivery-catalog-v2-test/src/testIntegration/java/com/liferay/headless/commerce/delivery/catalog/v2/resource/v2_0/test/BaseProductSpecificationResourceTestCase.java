...
import com.liferay.headless.commerce.delivery.catalog.v2.client.dto.v2_0.ProductSpecification;
...
import com.liferay.headless.commerce.delivery.catalog.v2.client.resource.v2_0.ProductSpecificationResource;
import com.liferay.headless.commerce.delivery.catalog.v2.client.serdes.v2_0.ProductSpecificationSerDes;
...
public abstract class BaseProductSpecificationResourceTestCase {
	...
	@Test
	public void testGetChannelIdProductProductSpecificationsPage()
		throws Exception {

		Long id = testGetChannelIdProductProductSpecificationsPage_getId();
		Long irrelevantId =
			testGetChannelIdProductProductSpecificationsPage_getIrrelevantId();
		Long productId =
			testGetChannelIdProductProductSpecificationsPage_getProductId();
		Long irrelevantProductId =
			testGetChannelIdProductProductSpecificationsPage_getIrrelevantProductId();
		...
		if ((irrelevantId != null) && (irrelevantProductId != null)) {
			ProductSpecification irrelevantProductSpecification =
				testGetChannelIdProductProductSpecificationsPage_addProductSpecification(
			...
			assertValid(
				page,
				testGetChannelIdProductProductSpecificationsPage_getExpectedActions(
					irrelevantId, irrelevantProductId));
		}

		ProductSpecification productSpecification1 =
			testGetChannelIdProductProductSpecificationsPage_addProductSpecification(
				id, productId, randomProductSpecification());
	...
	@Test
	public void testGetChannelIdProductProductSpecificationsPageWithPagination()
		throws Exception {
	...
	protected Long testGetChannelIdProductProductSpecificationsPage_getId()
		throws Exception {
