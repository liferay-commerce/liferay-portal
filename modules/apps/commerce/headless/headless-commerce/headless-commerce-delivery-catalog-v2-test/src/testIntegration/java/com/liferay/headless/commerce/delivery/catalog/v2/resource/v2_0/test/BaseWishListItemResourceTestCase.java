...
import com.liferay.headless.commerce.delivery.catalog.v2.client.dto.v2_0.WishListItem;
...
import com.liferay.headless.commerce.delivery.catalog.v2.client.resource.v2_0.WishListItemResource;
import com.liferay.headless.commerce.delivery.catalog.v2.client.serdes.v2_0.WishListItemSerDes;
...
public abstract class BaseWishListItemResourceTestCase {
	...
	@Test
	public void testGetWishlistIdWishListItemsPage() throws Exception {
		Long id = testGetWishlistIdWishListItemsPage_getId();
		Long irrelevantId =
			testGetWishlistIdWishListItemsPage_getIrrelevantId();
		...
		if (irrelevantId != null) {
			WishListItem irrelevantWishListItem =
				testGetWishlistIdWishListItemsPage_addWishListItem(
					irrelevantId, randomIrrelevantWishListItem());

			page = wishListItemResource.getWishlistIdWishListItemsPage(
			...
			assertValid(
				page,
				testGetWishlistIdWishListItemsPage_getExpectedActions(
					irrelevantId));
		}

		WishListItem wishListItem1 =
			testGetWishlistIdWishListItemsPage_addWishListItem(
				id, randomWishListItem());
		...
		assertEqualsIgnoringOrder(
			...
			(List<WishListItem>)page.getItems());
		assertValid(
			page, testGetWishlistIdWishListItemsPage_getExpectedActions(id));
	...
	protected Map<String, Map<String, String>>
			testGetWishlistIdWishListItemsPage_getExpectedActions(Long id)
		throws Exception {
	...
	@Test
	public void testGetWishlistIdWishListItemsPageWithPagination()
		throws Exception {
	...
	protected WishListItem testGetWishlistIdWishListItemsPage_addWishListItem(
			Long id, WishListItem wishListItem)
		throws Exception {
	...
	protected Long testGetWishlistIdWishListItemsPage_getId() throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}

	protected Long testGetWishlistIdWishListItemsPage_getIrrelevantId()
		throws Exception {
	...
	@Test
	public void testPostWishlistIdWishListItem() throws Exception {
		WishListItem randomWishListItem = randomWishListItem();

		WishListItem postWishListItem =
			testPostWishlistIdWishListItem_addWishListItem(randomWishListItem);

		assertEquals(randomWishListItem, postWishListItem);
		assertValid(postWishListItem);
	}

	protected WishListItem testPostWishlistIdWishListItem_addWishListItem(
			WishListItem wishListItem)
		throws Exception {
