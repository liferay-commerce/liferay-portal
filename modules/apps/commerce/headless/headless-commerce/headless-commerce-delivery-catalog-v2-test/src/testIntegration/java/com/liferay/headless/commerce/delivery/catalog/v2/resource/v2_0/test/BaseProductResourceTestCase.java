...
import com.liferay.headless.commerce.delivery.catalog.v2.client.dto.v2_0.Product;
...
import com.liferay.headless.commerce.delivery.catalog.v2.client.resource.v2_0.ProductResource;
import com.liferay.headless.commerce.delivery.catalog.v2.client.serdes.v2_0.ProductSerDes;
...
public abstract class BaseProductResourceTestCase {
	...
	@Test
	public void testGetChannelIdProductsPage() throws Exception {
		Long id = testGetChannelIdProductsPage_getId();
		Long irrelevantId = testGetChannelIdProductsPage_getIrrelevantId();

		Page<Product> page = productResource.getChannelIdProductsPage(
			id, null, null, null, Pagination.of(1, 10), null);

		Assert.assertEquals(0, page.getTotalCount());

		if (irrelevantId != null) {
			Product irrelevantProduct = testGetChannelIdProductsPage_addProduct(
				irrelevantId, randomIrrelevantProduct());

			page = productResource.getChannelIdProductsPage(
				irrelevantId, null, null, null, Pagination.of(1, 2), null);
			...
			assertValid(
				page,
				testGetChannelIdProductsPage_getExpectedActions(irrelevantId));
		}

		Product product1 = testGetChannelIdProductsPage_addProduct(
			id, randomProduct());

		Product product2 = testGetChannelIdProductsPage_addProduct(
			id, randomProduct());
		...
		assertValid(page, testGetChannelIdProductsPage_getExpectedActions(id));
	}

	protected Map<String, Map<String, String>>
			testGetChannelIdProductsPage_getExpectedActions(Long id)
		throws Exception {
	...
	@Test
	public void testGetChannelIdProductsPageWithFilterDateTimeEquals()
		throws Exception {
		...
		product1 = testGetChannelIdProductsPage_addProduct(id, product1);
	...
	@Test
	public void testGetChannelIdProductsPageWithFilterDoubleEquals()
		throws Exception {
		...
		for (EntityField entityField : entityFields) {
			Page<Product> page = productResource.getChannelIdProductsPage(
				id, null, null, getFilterString(entityField, "eq", product1),
				Pagination.of(1, 2), null);
	...
	@Test
	public void testGetChannelIdProductsPageWithFilterStringEquals()
		throws Exception {
	...
	@Test
	public void testGetChannelIdProductsPageWithPagination() throws Exception {
		Long id = testGetChannelIdProductsPage_getId();
		...
		Product product3 = testGetChannelIdProductsPage_addProduct(
			id, randomProduct());

		Page<Product> page1 = productResource.getChannelIdProductsPage(
			id, null, null, null, Pagination.of(1, 2), null);

		List<Product> products1 = (List<Product>)page1.getItems();

		Assert.assertEquals(products1.toString(), 2, products1.size());

		Page<Product> page2 = productResource.getChannelIdProductsPage(
			id, null, null, null, Pagination.of(2, 2), null);
		...
		Page<Product> page3 = productResource.getChannelIdProductsPage(
			id, null, null, null, Pagination.of(1, 3), null);
	...
	@Test
	public void testGetChannelIdProductsPageWithSortDateTime()
		throws Exception {

		testGetChannelIdProductsPageWithSort(
			EntityField.Type.DATE_TIME,
	...
	@Test
	public void testGetChannelIdProductsPageWithSortDouble() throws Exception {
		testGetChannelIdProductsPageWithSort(
			EntityField.Type.DOUBLE,
			(entityField, product1, product2) -> {
	...
	@Test
	public void testGetChannelIdProductsPageWithSortInteger() throws Exception {
		testGetChannelIdProductsPageWithSort(
	...
	@Test
	public void testGetChannelIdProductsPageWithSortString() throws Exception {
		testGetChannelIdProductsPageWithSort(
			EntityField.Type.STRING,
			(entityField, product1, product2) -> {
	...
	protected void testGetChannelIdProductsPageWithSort(
		...
		product2 = testGetChannelIdProductsPage_addProduct(id, product2);

		for (EntityField entityField : entityFields) {
			Page<Product> ascPage = productResource.getChannelIdProductsPage(
				id, null, null, null, Pagination.of(1, 2),
			...
			Page<Product> descPage = productResource.getChannelIdProductsPage(
				id, null, null, null, Pagination.of(1, 2),
	...
	protected Product testGetChannelIdProductsPage_addProduct(
	...
	protected Long testGetChannelIdProductsPage_getId() throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}

	protected Long testGetChannelIdProductsPage_getIrrelevantId()
		throws Exception {
	...
	@Test
	public void testGetChannelIdProduct() throws Exception {
		Product postProduct = testGetChannelIdProduct_addProduct();

		Product getProduct = productResource.getChannelIdProduct(
			testGetChannelIdProduct_getId(postProduct), postProduct.getId(),
			null);
	...
	protected Long testGetChannelIdProduct_getId(Product product)
		throws Exception {

		return product.getId();
	}

	protected Product testGetChannelIdProduct_addProduct() throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}

	@Test
	public void testGraphQLGetChannelIdProduct() throws Exception {
		Product product = testGraphQLGetChannelIdProduct_addProduct();
					...
					JSONUtil.getValueAsString(
						invokeGraphQLQuery(
							new GraphQLField(
								...
								new HashMap<String, Object>() {
									{
										put(
											"id",
											testGraphQLGetChannelIdProduct_getId(
												product));
								...
								getGraphQLFields())),
						"JSONObject/data", "Object/channelIdProduct"))));
	}

	protected Long testGraphQLGetChannelIdProduct_getId(Product product)
		throws Exception {
	...
	@Test
	public void testGraphQLGetChannelIdProductNotFound() throws Exception {
	...
	protected Product testGraphQLGetChannelIdProduct_addProduct()
		throws Exception {
