...
import com.liferay.headless.commerce.delivery.catalog.v2.client.dto.v2_0.Sku;
...
import com.liferay.headless.commerce.delivery.catalog.v2.client.resource.v2_0.SkuResource;
import com.liferay.headless.commerce.delivery.catalog.v2.client.serdes.v2_0.SkuSerDes;
...
public abstract class BaseSkuResourceTestCase {
	...
	@Test
	public void testGetChannelIdProductSkusPage() throws Exception {
		Long id = testGetChannelIdProductSkusPage_getId();
		Long irrelevantId = testGetChannelIdProductSkusPage_getIrrelevantId();
		Long productId = testGetChannelIdProductSkusPage_getProductId();
		Long irrelevantProductId =
			testGetChannelIdProductSkusPage_getIrrelevantProductId();

		Page<Sku> page = skuResource.getChannelIdProductSkusPage(
			id, productId, null, Pagination.of(1, 10));

		Assert.assertEquals(0, page.getTotalCount());

		if ((irrelevantId != null) && (irrelevantProductId != null)) {
			Sku irrelevantSku = testGetChannelIdProductSkusPage_addSku(
				irrelevantId, irrelevantProductId, randomIrrelevantSku());

			page = skuResource.getChannelIdProductSkusPage(
			...
			assertValid(
				page,
				testGetChannelIdProductSkusPage_getExpectedActions(
					irrelevantId, irrelevantProductId));
		}

		Sku sku1 = testGetChannelIdProductSkusPage_addSku(
			id, productId, randomSku());

		Sku sku2 = testGetChannelIdProductSkusPage_addSku(
			id, productId, randomSku());
		...
		assertValid(
			page,
			testGetChannelIdProductSkusPage_getExpectedActions(id, productId));
	}
	...
	@Test
	public void testGetChannelIdProductSkusPageWithPagination()
		throws Exception {
		...
		Sku sku3 = testGetChannelIdProductSkusPage_addSku(
			id, productId, randomSku());

		Page<Sku> page1 = skuResource.getChannelIdProductSkusPage(
		...
		Page<Sku> page2 = skuResource.getChannelIdProductSkusPage(
		...
		Page<Sku> page3 = skuResource.getChannelIdProductSkusPage(
	...
	protected Sku testGetChannelIdProductSkusPage_addSku(
			Long id, Long productId, Sku sku)
		throws Exception {
	...
	protected Long testGetChannelIdProductSkusPage_getId() throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}

	protected Long testGetChannelIdProductSkusPage_getIrrelevantId()
		throws Exception {

		return null;
	}

	protected Long testGetChannelIdProductSkusPage_getProductId()
		throws Exception {
	...
	protected Long testGetChannelIdProductSkusPage_getIrrelevantProductId()
		throws Exception {
	...
	@Test
	public void testPostChannelIdProductSku() throws Exception {
		Sku randomSku = randomSku();

		Sku postSku = testPostChannelIdProductSku_addSku(randomSku);

		assertEquals(randomSku, postSku);
		assertValid(postSku);
	}

	protected Sku testPostChannelIdProductSku_addSku(Sku sku) throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}
