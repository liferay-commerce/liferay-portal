...
import com.liferay.headless.commerce.delivery.catalog.v2.client.dto.v2_0.Category;
...
import com.liferay.headless.commerce.delivery.catalog.v2.client.resource.v2_0.CategoryResource;
import com.liferay.headless.commerce.delivery.catalog.v2.client.serdes.v2_0.CategorySerDes;
...
public abstract class BaseCategoryResourceTestCase {
	...
	@Test
	public void testGetChannelIdProductCategoriesPage() throws Exception {
		Long id = testGetChannelIdProductCategoriesPage_getId();
		Long irrelevantId =
			testGetChannelIdProductCategoriesPage_getIrrelevantId();
		Long productId = testGetChannelIdProductCategoriesPage_getProductId();
		Long irrelevantProductId =
			testGetChannelIdProductCategoriesPage_getIrrelevantProductId();

		Page<Category> page =
			categoryResource.getChannelIdProductCategoriesPage(
				id, productId, Pagination.of(1, 10));

		Assert.assertEquals(0, page.getTotalCount());

		if ((irrelevantId != null) && (irrelevantProductId != null)) {
			Category irrelevantCategory =
				testGetChannelIdProductCategoriesPage_addCategory(
					irrelevantId, irrelevantProductId,
					randomIrrelevantCategory());

			page = categoryResource.getChannelIdProductCategoriesPage(
				irrelevantId, irrelevantProductId, Pagination.of(1, 2));
			...
			assertValid(
				page,
				testGetChannelIdProductCategoriesPage_getExpectedActions(
					irrelevantId, irrelevantProductId));
		}

		Category category1 = testGetChannelIdProductCategoriesPage_addCategory(
			id, productId, randomCategory());

		Category category2 = testGetChannelIdProductCategoriesPage_addCategory(
			id, productId, randomCategory());
	...
	@Test
	public void testGetChannelIdProductCategoriesPageWithPagination()
		throws Exception {
		...
		Category category3 = testGetChannelIdProductCategoriesPage_addCategory(
			id, productId, randomCategory());

		Page<Category> page1 =
			categoryResource.getChannelIdProductCategoriesPage(
				id, productId, Pagination.of(1, 2));
		...
		Page<Category> page2 =
			categoryResource.getChannelIdProductCategoriesPage(
				id, productId, Pagination.of(2, 2));
		...
		Page<Category> page3 =
			categoryResource.getChannelIdProductCategoriesPage(
				id, productId, Pagination.of(1, 3));
	...
	protected Category testGetChannelIdProductCategoriesPage_addCategory(
			Long id, Long productId, Category category)
		throws Exception {
	...
	protected Long testGetChannelIdProductCategoriesPage_getId()
		throws Exception {
	...
	protected Long testGetChannelIdProductCategoriesPage_getIrrelevantId()
		throws Exception {

		return null;
	}

	protected Long testGetChannelIdProductCategoriesPage_getProductId()
		throws Exception {
