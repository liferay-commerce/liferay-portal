...
import com.liferay.headless.commerce.delivery.catalog.v2.client.dto.v2_0.LinkedProduct;
...
import com.liferay.headless.commerce.delivery.catalog.v2.client.resource.v2_0.LinkedProductResource;
import com.liferay.headless.commerce.delivery.catalog.v2.client.serdes.v2_0.LinkedProductSerDes;
...
public abstract class BaseLinkedProductResourceTestCase {
	...
	@Test
	public void testGetChannelIdProductLinkedProductsPage() throws Exception {
		Long id = testGetChannelIdProductLinkedProductsPage_getId();
		Long irrelevantId =
			testGetChannelIdProductLinkedProductsPage_getIrrelevantId();
		Long productId =
			testGetChannelIdProductLinkedProductsPage_getProductId();
		Long irrelevantProductId =
			testGetChannelIdProductLinkedProductsPage_getIrrelevantProductId();
		...
		if ((irrelevantId != null) && (irrelevantProductId != null)) {
			LinkedProduct irrelevantLinkedProduct =
				testGetChannelIdProductLinkedProductsPage_addLinkedProduct(
					irrelevantId, irrelevantProductId,
					randomIrrelevantLinkedProduct());

			page = linkedProductResource.getChannelIdProductLinkedProductsPage(
			...
			assertValid(
				page,
				testGetChannelIdProductLinkedProductsPage_getExpectedActions(
					irrelevantId, irrelevantProductId));
		}

		LinkedProduct linkedProduct1 =
			testGetChannelIdProductLinkedProductsPage_addLinkedProduct(
				id, productId, randomLinkedProduct());
	...
	@Test
	public void testGetChannelIdProductLinkedProductsPageWithPagination()
		throws Exception {
	...
	protected LinkedProduct
			testGetChannelIdProductLinkedProductsPage_addLinkedProduct(
				Long id, Long productId, LinkedProduct linkedProduct)
		throws Exception {
	...
	protected Long testGetChannelIdProductLinkedProductsPage_getId()
		throws Exception {
	...
	protected Long testGetChannelIdProductLinkedProductsPage_getIrrelevantId()
		throws Exception {

		return null;
	}

	protected Long testGetChannelIdProductLinkedProductsPage_getProductId()
		throws Exception {
