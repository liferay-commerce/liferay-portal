...
public class Channel implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "ISO 4217 currency code applied to every monetary amount handled by this channel; required on create. On update, an unrecognized code is silently ignored and the current value is preserved, so only currencies configured for the company take effect.",
		example = "USD"
	)
...
// LIFERAY-REST-BUILDER-HASH:1173855567