...
public abstract class BasePlacedOrderCommentResourceTestCase {
	...
	@Test
	public void testGetPlacedOrderCommentsPage() throws Exception {
		Long placedOrderId = testGetPlacedOrderCommentsPage_getPlacedOrderId();
		Long irrelevantPlacedOrderId =
			testGetPlacedOrderCommentsPage_getIrrelevantPlacedOrderId();

		Page<PlacedOrderComment> page =
			placedOrderCommentResource.getPlacedOrderCommentsPage(
		...
		if (irrelevantPlacedOrderId != null) {
			PlacedOrderComment irrelevantPlacedOrderComment =
				testGetPlacedOrderCommentsPage_addPlacedOrderComment(
					irrelevantPlacedOrderId,
					randomIrrelevantPlacedOrderComment());

			page = placedOrderCommentResource.getPlacedOrderCommentsPage(
	...
	@Test
	public void testGetPlacedOrderCommentsPageWithPagination()
		throws Exception {
	...
	protected Long testGetPlacedOrderCommentsPage_getPlacedOrderId()
		throws Exception {
	...
	protected Long testGetPlacedOrderCommentsPage_getIrrelevantPlacedOrderId()
		throws Exception {
	...
	@Test
	public void testGraphQLGetPlacedOrderCommentsPage() throws Exception {
		Long placedOrderId = testGetPlacedOrderCommentsPage_getPlacedOrderId();
		...
		JSONObject placedOrderCommentsJSONObject =
			JSONUtil.getValueAsJSONObject(
				invokeGraphQLQuery(graphQLField), "JSONObject/data",
				"JSONObject/placedOrderComments");

		Assert.assertEquals(0, placedOrderCommentsJSONObject.get("totalCount"));

		PlacedOrderComment placedOrderComment1 =
			testGraphQLGetPlacedOrderCommentsPage_addPlacedOrderComment();
		PlacedOrderComment placedOrderComment2 =
			testGraphQLGetPlacedOrderCommentsPage_addPlacedOrderComment();

		placedOrderCommentsJSONObject = JSONUtil.getValueAsJSONObject(
			invokeGraphQLQuery(graphQLField), "JSONObject/data",
			"JSONObject/placedOrderComments");

		Assert.assertEquals(
			2, placedOrderCommentsJSONObject.getLong("totalCount"));

		assertEqualsIgnoringOrder(
			Arrays.asList(placedOrderComment1, placedOrderComment2),
			Arrays.asList(
				PlacedOrderCommentSerDes.toDTOs(
					placedOrderCommentsJSONObject.getString("items"))));
	}
