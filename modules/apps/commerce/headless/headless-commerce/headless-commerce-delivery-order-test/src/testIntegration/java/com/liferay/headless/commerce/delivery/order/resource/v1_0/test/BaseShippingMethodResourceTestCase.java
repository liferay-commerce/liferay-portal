...
import com.liferay.headless.commerce.delivery.order.client.resource.v1_0.ShippingMethodResource;
...
public abstract class BaseShippingMethodResourceTestCase {
	...
	@Test
	public void testGetOrderShippingMethodsPage() throws Exception {
		Long orderId = testGetOrderShippingMethodsPage_getOrderId();
		Long irrelevantOrderId =
			testGetOrderShippingMethodsPage_getIrrelevantOrderId();
		...
		if (irrelevantOrderId != null) {
			ShippingMethod irrelevantShippingMethod =
				testGetOrderShippingMethodsPage_addShippingMethod(
					irrelevantOrderId, randomIrrelevantShippingMethod());

			page = shippingMethodResource.getOrderShippingMethodsPage(
				irrelevantOrderId);
		...
		ShippingMethod shippingMethod1 =
			testGetOrderShippingMethodsPage_addShippingMethod(
				orderId, randomShippingMethod());

		ShippingMethod shippingMethod2 =
			testGetOrderShippingMethodsPage_addShippingMethod(
				orderId, randomShippingMethod());

		page = shippingMethodResource.getOrderShippingMethodsPage(orderId);
	...
	protected ShippingMethod testGetOrderShippingMethodsPage_addShippingMethod(
			Long orderId, ShippingMethod shippingMethod)
		throws Exception {
	...
	protected Long testGetOrderShippingMethodsPage_getOrderId()
		throws Exception {
	...
	protected Long testGetOrderShippingMethodsPage_getIrrelevantOrderId()
		throws Exception {
