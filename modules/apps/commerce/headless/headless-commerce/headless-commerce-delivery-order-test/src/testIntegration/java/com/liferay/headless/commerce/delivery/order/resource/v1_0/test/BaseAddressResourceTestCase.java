...
import com.liferay.headless.commerce.delivery.order.client.resource.v1_0.AddressResource;
import com.liferay.headless.commerce.delivery.order.client.serdes.v1_0.AddressSerDes;
...
public abstract class BaseAddressResourceTestCase {
	...
	@Test
	public void testGetOrderBillingAddres() throws Exception {
		Address postAddress = testGetOrderBillingAddres_addAddress();

		Address getAddress = addressResource.getOrderBillingAddres(
			testGetOrderBillingAddres_getOrderId());
	...
	@Test
	public void testGraphQLGetOrderBillingAddres() throws Exception {
		Address address = testGraphQLGetOrderBillingAddres_addAddress();
								...
								new HashMap<String, Object>() {
									{
										put(
											"orderId",
											testGraphQLGetOrderBillingAddres_getOrderId());
									}
								},
								getGraphQLFields())),
						"JSONObject/data", "Object/orderBillingAddres"))));
	}
	...
	@Test
	public void testGraphQLGetOrderBillingAddresNotFound() throws Exception {
	...
	protected Address testGraphQLGetOrderBillingAddres_addAddress()
		throws Exception {
	...
	@Test
	public void testGetOrderShippingAddres() throws Exception {
		Address postAddress = testGetOrderShippingAddres_addAddress();

		Address getAddress = addressResource.getOrderShippingAddres(
			testGetOrderShippingAddres_getOrderId());
	...
	@Test
	public void testGraphQLGetOrderShippingAddres() throws Exception {
		Address address = testGraphQLGetOrderShippingAddres_addAddress();
								...
								new HashMap<String, Object>() {
									{
										put(
											"orderId",
											testGraphQLGetOrderShippingAddres_getOrderId());
									}
								},
								getGraphQLFields())),
						"JSONObject/data", "Object/orderShippingAddres"))));
	}
	...
	@Test
	public void testGraphQLGetOrderShippingAddresNotFound() throws Exception {
		Long irrelevantOrderId = RandomTestUtil.randomLong();
	...
	protected Address testGraphQLGetOrderShippingAddres_addAddress()
		throws Exception {
