...
import com.liferay.headless.commerce.delivery.order.client.dto.v1_0.PaymentMethod;
...
import com.liferay.headless.commerce.delivery.order.client.resource.v1_0.PaymentMethodResource;
import com.liferay.headless.commerce.delivery.order.client.serdes.v1_0.PaymentMethodSerDes;
...
public abstract class BasePaymentMethodResourceTestCase {
	...
	@Test
	public void testGetOrderPaymentMethodsPage() throws Exception {
		Long orderId = testGetOrderPaymentMethodsPage_getOrderId();
		Long irrelevantOrderId =
			testGetOrderPaymentMethodsPage_getIrrelevantOrderId();
		...
		if (irrelevantOrderId != null) {
			PaymentMethod irrelevantPaymentMethod =
				testGetOrderPaymentMethodsPage_addPaymentMethod(
					irrelevantOrderId, randomIrrelevantPaymentMethod());

			page = paymentMethodResource.getOrderPaymentMethodsPage(
				irrelevantOrderId);
		...
		PaymentMethod paymentMethod1 =
			testGetOrderPaymentMethodsPage_addPaymentMethod(
				orderId, randomPaymentMethod());

		PaymentMethod paymentMethod2 =
			testGetOrderPaymentMethodsPage_addPaymentMethod(
				orderId, randomPaymentMethod());

		page = paymentMethodResource.getOrderPaymentMethodsPage(orderId);
	...
	protected PaymentMethod testGetOrderPaymentMethodsPage_addPaymentMethod(
	...
	protected Long testGetOrderPaymentMethodsPage_getOrderId()
		throws Exception {
	...
	protected Long testGetOrderPaymentMethodsPage_getIrrelevantOrderId()
		throws Exception {
