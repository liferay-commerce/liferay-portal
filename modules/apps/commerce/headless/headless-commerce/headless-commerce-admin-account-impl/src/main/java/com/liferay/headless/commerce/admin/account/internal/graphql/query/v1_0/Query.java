...
public class Query {
	 ...
	 */
	@GraphQLField(
		description = "Reads an Account by its internal ID. Returns the Account DTO with nested addresses, members, and organizations. Deprecated. Use `GET /o/headless-admin-user/v1.0/accounts/{accountId}` from the headless-admin-user module instead."
	)
	 ...
	 */
	@GraphQLField(
		description = "Reads an Account by its external reference code. Returns the Account DTO with nested addresses, members, and organizations. Deprecated. Use `GET /o/headless-admin-user/v1.0/accounts/by-external-reference-code/{externalReferenceCode}` from the headless-admin-user module instead."
	)
	 ...
	 */
	@GraphQLField(
		description = "Lists Accounts with paging, search, filter, and sort. Filterable and sortable fields (sourced from AccountEntityModel) -- dateCreated, dateModified, externalReferenceCode, name, status, taxIdNumber, and type. Search corpus -- the indexed name and description fields on AccountEntry. Deprecated. Use `GET /o/headless-admin-user/v1.0/accounts` from the headless-admin-user module instead."
	)
	 ...
	 */
	@GraphQLField(
		description = "Reads an account address by its internal ID. Returns the AccountAddress DTO."
	)
	 ...
	 */
	@GraphQLField(
		description = "Reads an account address by its external reference code. Resolves the CommerceAddress by ERC and returns the AccountAddress DTO."
	)
	 ...
	 */
	@GraphQLField(
		description = "Lists addresses for the Account identified by external reference code. Paginates CommerceAddresses for the account."
	)
	 ...
	 */
	@GraphQLField(
		description = "Lists addresses for the Account identified by internal ID. Paginates CommerceAddresses for the account."
	)
	 ...
	 */
	@GraphQLField(
		description = "Lists the per-account channel shipping options for the Account identified by external reference code. Paginates CommerceShippingOptionAccountEntryRels for the account."
	)
	 ...
	 */
	@GraphQLField(
		description = "Reads a per-account channel shipping option by its internal ID. Returns the AccountChannelShippingOption DTO. Returns 404 when no entry exists."
	)
	 ...
	 */
	@GraphQLField(
		description = "Lists the per-account channel shipping options for the Account identified by internal ID. Paginates CommerceShippingOptionAccountEntryRels for the account."
	)
	public AccountChannelShippingOptionPage
	 ...
	 */
	@GraphQLField(
		description = "Reads a single AccountMember, addressed by Account external reference code and User internal ID."
	)
	 ...
	 */
	@GraphQLField(
		description = "Lists the AccountGroups the Account belongs to, addressed by Account external reference code. Returns the AdminAccountGroup pages joined through AccountGroupRel. Deprecated. Use `GET /o/headless-admin-user/v1.0/accounts/by-external-reference-code/{accountExternalReferenceCode}/account-groups` from the headless-admin-user module instead."
	)
	 ...
	 */
	@GraphQLField(
		description = "Reads an AccountGroup by its internal ID. Returns the AdminAccountGroup DTO. Deprecated. Use `GET /o/headless-admin-user/v1.0/account-groups/{accountGroupId}` from the headless-admin-user module instead."
	)
	 ...
	 */
	@GraphQLField(
		description = "Reads an AccountGroup by its external reference code. Returns the AdminAccountGroup DTO. Deprecated. Use `GET /o/headless-admin-user/v1.0/account-groups/by-external-reference-code/{externalReferenceCode}` from the headless-admin-user module instead."
	)
	 ...
	 */
	@GraphQLField(
		description = "Lists AccountGroups with paging, search, filter, and sort. Filterable and sortable field -- name (sourced from AccountGroupEntityModel). Search corpus -- the indexed name field on AccountGroup. Deprecated. Use `GET /o/headless-admin-user/v1.0/account-groups` from the headless-admin-user module instead."
	)
	 ...
	 */
	@GraphQLField(
		description = "Lists the AccountGroups the Account belongs to, addressed by Account internal ID. Returns the AdminAccountGroup pages joined through AccountGroupRel. Deprecated. Use `GET /o/headless-admin-user/v1.0/accounts/{accountId}/account-groups` from the headless-admin-user module instead."
	)
...
// LIFERAY-REST-BUILDER-HASH:1779359962