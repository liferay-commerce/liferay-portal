			...
			new HashMap<String, ObjectValuePair<Class<?>, String>>() {
				{
					...
					put(
						"mutation#createAccountByExternalReferenceCodeChannelAccountChannelShippingOption",
						new ObjectValuePair<>(
							AccountChannelShippingOptionResourceImpl.class,
							"postAccountByExternalReferenceCodeChannelAccountChannelShippingOption"));
					put(
						"mutation#createAccountIdChannelAccountChannelShippingOption",
						new ObjectValuePair<>(
							AccountChannelShippingOptionResourceImpl.class,
					...
					put(
						"query#accountByExternalReferenceCodeChannelAccountChannelShippingOption",
						new ObjectValuePair<>(
							AccountChannelShippingOptionResourceImpl.class,
							"getAccountByExternalReferenceCodeChannelAccountChannelShippingOptionPage"));
					put(
						"query#accountIdChannelAccountChannelShippingOption",
						new ObjectValuePair<>(
							AccountChannelShippingOptionResourceImpl.class,
