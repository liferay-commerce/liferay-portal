...
public class Mutation {
	...
	@GraphQLField(
		description = "Deletes an Account by its internal ID. Calls AccountEntryService.deleteAccountEntry. Cascades to addresses, memberships, and channel overrides per the underlying service contract. Deprecated. Use `DELETE /o/headless-admin-user/v1.0/accounts/{accountId}` from the headless-admin-user module instead."
	)
	...
	@GraphQLField(
		description = "Deletes an Account by its external reference code. Resolves to the internal ID and calls AccountEntryService.deleteAccountEntry. Cascades to addresses, memberships, and channel overrides per the underlying service contract. Deprecated. Use `DELETE /o/headless-admin-user/v1.0/accounts/by-external-reference-code/{externalReferenceCode}` from the headless-admin-user module instead."
	)
	...
	@GraphQLField(
		description = "Uploads or replaces the logo of the Account identified by external reference code. The body is a multipart form upload with a single binary file field named logo."
	)
	@GraphQLName(
		description = "Uploads or replaces the logo of the Account identified by external reference code. The body is a multipart form upload with a single binary file field named logo.",
	...
	@GraphQLField(
		description = "Links an Account to an AccountGroup. The AccountGroup is identified by its external reference code; the Account is identified either by ID or by ERC inside the request body. The link is implemented as an AccountGroupRel between the two entities."
	)
	...
	@GraphQLField(
		description = "Uploads or replaces the logo of the Account identified by internal ID. The body is a multipart form upload with a single binary file field named logo."
	)
	@GraphQLName(
		description = "Uploads or replaces the logo of the Account identified by internal ID. The body is a multipart form upload with a single binary file field named logo.",
	...
	@GraphQLField(
		description = "Deletes an account address by its internal ID. Calls CommerceAddressService.deleteCommerceAddress and returns 204."
	)
	...
	@GraphQLField(
		description = "Deletes an account address by its external reference code. Resolves the CommerceAddress by ERC and calls CommerceAddressService.deleteCommerceAddress. Returns 404 when no address exists with the supplied ERC."
	)
	...
	@GraphQLField(
		description = "Partially updates an account address by its internal ID. JSON Merge Patch semantics; only the supplied fields are modified. Side effect -- when defaultBilling or defaultShipping is set to true the previously default address on the same account is cleared."
	)
	...
	@GraphQLField(
		description = "Partially updates an account address by its external reference code. JSON Merge Patch semantics; only the supplied fields are modified. Side effect -- when defaultBilling or defaultShipping is set to true the previously default address on the same account is cleared."
	)
	...
	@GraphQLField(
		description = "Creates an account address under the Account identified by internal ID. Side effect -- when defaultBilling or defaultShipping is true the previously default address on the same account is cleared."
	)
	...
	@GraphQLField(
		description = "Replaces an account address by its internal ID. Every supplied field overwrites the persisted value; omitted fields are reset to their defaults. Side effect -- when defaultBilling or defaultShipping is set to true the previously default address on the same account is cleared."
	)
	...
	@GraphQLField(
		description = "Deletes the per-account channel shipping option identified by its internal ID. Calls CommerceShippingOptionAccountEntryRelService.deleteCommerceShippingOptionAccountEntryRel and returns 204."
	)
	...
	@GraphQLField(
		description = "Partially updates a per-account channel shipping option by its internal ID. JSON Merge Patch semantics; updates the channel binding, shipping method key, and shipping option key via CommerceShippingOptionAccountEntryRelService."
	)
	...
	@GraphQLField(
		description = "Creates or updates a per-account channel shipping option under the Account identified by external reference code. Validates the supplied shipping method key, fixed option key, and channel binding before persisting the CommerceShippingOptionAccountEntryRel."
	)
	...
	@GraphQLField(
		description = "Creates or updates a per-account channel shipping option under the Account identified by internal ID. Validates the supplied shipping method key, fixed option key, and channel binding before persisting the CommerceShippingOptionAccountEntryRel."
	)
	public AccountChannelShippingOption
	...
	@GraphQLField(
		description = "Removes a member from the Account, addressed by Account external reference code and User internal ID. Deletes the AccountEntryUserRel."
	)
	...
	@GraphQLField(
		description = "Removes a member from the Account, addressed by Account internal ID and User internal ID. Deletes the AccountEntryUserRel. Deprecated. Use `DELETE /o/headless-admin-user/v1.0/accounts/{accountId}/user-accounts/{userAccountId}` from the headless-admin-user module instead."
	)
	...
	@GraphQLField(
		description = "Updates the AccountRoles of a member, addressed by Account external reference code and User internal ID. Side effect -- the supplied accountRoles fully replace the user's previous account-scoped role set; roles not present in the body are removed."
	)
	...
	@GraphQLField(
		description = "Updates the AccountRoles of a member, addressed by Account internal ID and User internal ID. Side effect -- the supplied accountRoles fully replace the user's previous account-scoped role set; roles not present in the body are removed."
	)
	...
	@GraphQLField(
		description = "Adds an existing user as a member of the Account identified by external reference code. The user is referenced by userId or userExternalReferenceCode in the body; the supplied accountRoles become the user's account-scoped roles."
	)
	...
	@GraphQLField(
		description = "Adds an existing user as a member of the Account identified by internal ID. The user is referenced by userId or userExternalReferenceCode in the body; the supplied accountRoles become the user's account-scoped roles."
	)
	...
	@GraphQLField(
		description = "Deletes an AccountGroup by its internal ID. Calls AccountGroupService.deleteAccountGroup. Deprecated. Use `DELETE /o/headless-admin-user/v1.0/account-groups/{accountGroupId}` from the headless-admin-user module instead."
	)
	...
	@GraphQLField(
		description = "Deletes an AccountGroup by its external reference code. Resolves to the internal ID and calls AccountGroupService.deleteAccountGroup. Deprecated. Use `DELETE /o/headless-admin-user/v1.0/account-groups/by-external-reference-code/{externalReferenceCode}` from the headless-admin-user module instead."
	)
...
// LIFERAY-REST-BUILDER-HASH:-1465624632