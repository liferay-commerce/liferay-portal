...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Account.AccountEntryExternalReferenceCodeExceptionMapper"
	},
...
public class AccountEntryExternalReferenceCodeExceptionMapper
	...
	public String getErrorDescription() {
		return "Invalid account external reference code";
	}
