...
public abstract class BaseAccountChannelShippingOptionResourceImpl
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PATCH' 'http://localhost:8080/o/headless-commerce-admin-account/v1.0/account-channel-shipping-options/{id}' -d $'{"accountExternalReferenceCode": ___, "accountId": ___, "channelId": ___, "id": ___, "shippingMethodKey": ___, "shippingOptionKey": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-admin-account/v1.0/accounts/by-externalReferenceCode/{externalReferenceCode}/channels/{channelId}/account-channel-shipping-option'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path(
		"/accounts/by-externalReferenceCode/{externalReferenceCode}/channels/{channelId}/account-channel-shipping-option"
	)
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-admin-account/v1.0/accounts/by-externalReferenceCode/{externalReferenceCode}/channels/{channelId}/account-channel-shipping-option' -d $'{"accountExternalReferenceCode": ___, "accountId": ___, "channelId": ___, "id": ___, "shippingMethodKey": ___, "shippingOptionKey": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-admin-account/v1.0/accounts/{id}/channels/{channelId}/account-channel-shipping-option'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path(
		"/accounts/{id}/channels/{channelId}/account-channel-shipping-option"
	)
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Page<AccountChannelShippingOption>
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-admin-account/v1.0/accounts/{id}/channels/{channelId}/account-channel-shipping-option' -d $'{"accountExternalReferenceCode": ___, "accountId": ___, "channelId": ___, "id": ___, "shippingMethodKey": ___, "shippingOptionKey": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
