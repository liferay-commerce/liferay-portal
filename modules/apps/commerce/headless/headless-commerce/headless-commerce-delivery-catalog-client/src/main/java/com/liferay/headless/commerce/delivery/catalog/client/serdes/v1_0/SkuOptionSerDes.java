...
public class SkuOptionSerDes {
	...
	public static String toJSON(SkuOption skuOption) {
		...
		if (skuOption.getSkuOptionValueName() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(_escape(skuOption.getSkuOptionValueName()));
	...
	public static Map<String, String> toMap(SkuOption skuOption) {
		...
		if (skuOption.getSkuOptionValueName() == null) {
			map.put("skuOptionValueName", null);
		}
		else {
			map.put(
				"skuOptionValueName",
				String.valueOf(skuOption.getSkuOptionValueName()));
		}
			...
			if (Objects.equals(jsonParserFieldName, "key")) {
				...
				if (jsonParserFieldValue != null) {
					skuOption.setSkuOptionValueKey(
						...
						jsonParserFieldName, "skuOptionValueName")) {

				if (jsonParserFieldValue != null) {
					skuOption.setSkuOptionValueName(
						(String)jsonParserFieldValue);
				}
			}
