...
package com.liferay.headless.commerce.delivery.catalog.client.resource.v2_0;
	...
	public static class AttachmentResourceImpl implements AttachmentResource {
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-commerce-delivery-catalog/v2.0/channels/{channelId}/products/{productId}/attachments");
		...
		public HttpInvoker.HttpResponse getChannelProductImagesPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-commerce-delivery-catalog/v2.0/channels/{channelId}/products/{productId}/images");
