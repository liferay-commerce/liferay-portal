...
public interface AddressResource {
	...
	public HttpInvoker.HttpResponse getOrderBillingAddresHttpResponse(
			Long orderId)
		throws Exception;

	public Address getOrderShippingAddres(Long orderId) throws Exception;

	public HttpInvoker.HttpResponse getOrderShippingAddresHttpResponse(
			Long orderId)
		throws Exception;
	...
	public static class AddressResourceImpl implements AddressResource {
		...
		public Address getOrderBillingAddres(Long orderId) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				getOrderBillingAddresHttpResponse(orderId);
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-order/v1.0/orders/{orderId}/billing-address");
		...
		public Address getOrderShippingAddres(Long orderId) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				getOrderShippingAddresHttpResponse(orderId);
		...
		public HttpInvoker.HttpResponse getOrderShippingAddresHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-order/v1.0/orders/{orderId}/shipping-address");
