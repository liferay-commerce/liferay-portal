...
public interface ShippingMethodResource {
	...
	public Page<ShippingMethod> getOrderShippingMethodsPage(Long orderId)
		throws Exception;

	public HttpInvoker.HttpResponse getOrderShippingMethodsPageHttpResponse(
			Long orderId)
		throws Exception;
	...
	public static class ShippingMethodResourceImpl
		...
		public Page<ShippingMethod> getOrderShippingMethodsPage(Long orderId)
			...
			HttpInvoker.HttpResponse httpResponse =
				getOrderShippingMethodsPageHttpResponse(orderId);
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-order/v1.0/orders/{orderId}/shipping-methods");
