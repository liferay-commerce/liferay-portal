 ...
 */
@Generated("")
public class OrderComment implements Cloneable, Serializable {

	public static OrderComment toDTO(String json) {
		return OrderCommentSerDes.toDTO(json);
	}
	...
	@Override
	public OrderComment clone() throws CloneNotSupportedException {
		return (OrderComment)super.clone();
	}
	...
	public String toString() {
		return OrderCommentSerDes.toJSON(this);
	}
