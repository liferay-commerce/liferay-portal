...
public interface PlacedOrderCommentResource {
	...
	public HttpInvoker.HttpResponse getPlacedOrderCommentsPageHttpResponse(
			Long placedOrderId, Pagination pagination)
		throws Exception;
	...
	public static class PlacedOrderCommentResourceImpl
		...
		public Page<PlacedOrderComment> getPlacedOrderCommentsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getPlacedOrderCommentsPageHttpResponse(
		...
		public HttpInvoker.HttpResponse getPlacedOrderCommentsPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-order/v1.0/placed-orders/{placedOrderId}/comments");
