...
public interface OrderItemResource {
	...
	public HttpInvoker.HttpResponse getOrderItemHttpResponse(Long orderItemId)
		throws Exception;

	public Page<OrderItem> getOrderItemsPage(
			Long orderId, Long skuId, Pagination pagination)
		throws Exception;
	...
	public static class OrderItemResourceImpl implements OrderItemResource {
		...
		public HttpInvoker.HttpResponse getOrderItemHttpResponse(
				Long orderItemId)
			throws Exception {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-order/v1.0/order-items/{orderItemId}");

			httpInvoker.path("orderItemId", orderItemId);
		...
		public Page<OrderItem> getOrderItemsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getOrderItemsPageHttpResponse(orderId, skuId, pagination);
		...
		public HttpInvoker.HttpResponse getOrderItemsPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-delivery-order/v1.0/orders/{orderId}/items");
