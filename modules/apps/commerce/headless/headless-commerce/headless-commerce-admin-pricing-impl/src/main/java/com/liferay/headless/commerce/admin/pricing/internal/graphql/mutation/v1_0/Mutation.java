...
public class Mutation {
	...
	@GraphQLField(
		description = "Deletes a single CommerceDiscountCommerceAccountGroupRel by internal ID. Calls CommerceDiscountCommerceAccountGroupRelService.deleteCommerceDiscountCommerceAccountGroupRel."
	)
	...
	@GraphQLField(
		description = "Attaches an AccountGroup to a CommerceDiscount addressed by externalReferenceCode. Same create pipeline as postDiscountIdDiscountAccountGroup with ERC-based discount resolution."
	)
	...
	@GraphQLField(
		description = "Attaches an AccountGroup to a CommerceDiscount addressed by internal ID. Calls CommerceDiscountCommerceAccountGroupRelService.addCommerceDiscountCommerceAccountGroupRel. Validation -- DuplicateCommerceDiscountAccountGroupRelException -> 409 Conflict when the (discount, accountGroup) pair already exists."
	)
	...
	@GraphQLField(
		description = "Deletes a single CommerceDiscountRel (AssetCategory binding) by internal ID. Calls CommerceDiscountRelService.deleteCommerceDiscountRel."
	)
	...
	@GraphQLField(
		description = "Attaches an AssetCategory to a CommerceDiscount addressed by externalReferenceCode. Same create pipeline as postDiscountIdDiscountCategory with ERC-based discount resolution."
	)
	...
	@GraphQLField(
		description = "Attaches an AssetCategory to a CommerceDiscount addressed by internal ID. Calls CommerceDiscountRelService.addCommerceDiscountRel with the AssetCategory class name. The category is resolved by ID or externalReferenceCode from the supplied DTO."
	)
	...
	@GraphQLField(
		description = "Deletes a single CommerceDiscountRule by internal ID. Calls CommerceDiscountRuleService.deleteCommerceDiscountRule."
	)
	...
	@GraphQLField(
		description = "Partially updates a CommerceDiscountRule by internal ID. JSON Merge Patch over type and typeSettings via CommerceDiscountRuleService.updateCommerceDiscountRule."
	)
	...
	@GraphQLField(
		description = "Creates a CommerceDiscountRule under a CommerceDiscount addressed by externalReferenceCode. Same create pipeline as postDiscountIdDiscountRule with ERC-based discount resolution."
	)
	...
	@GraphQLField(
		description = "Creates a CommerceDiscountRule under a CommerceDiscount addressed by internal ID. Calls CommerceDiscountRuleService.addCommerceDiscountRule with the supplied type (validator type, for example `cart-total`) and typeSettings JSON. Validation -- DiscountRuleTypeException -> 400 Bad Request when the type is unknown."
	)
	...
	@GraphQLField(
		description = "Deletes a CommercePriceList by internal ID. Calls CommercePriceListService.deleteCommercePriceList. Side effects -- cascades the deletion of all CommercePriceEntry, CommerceTierPriceEntry, and account/account-group/channel/order-type rel rows pointing at the list."
	)
	...
	@GraphQLField(
		description = "Deletes a CommercePriceList addressed by externalReferenceCode. Same cascade semantics; 404 when ERC unknown."
	)
	...
	@GraphQLField(
		description = "Partially updates a CommercePriceList by internal ID. JSON Merge Patch over the supplied fields via CommercePriceListService.updateCommercePriceList, then cascades any supplied nested collections."
	)
	...
	@GraphQLField(
		description = "Partially updates a CommercePriceList addressed by externalReferenceCode. JSON Merge Patch semantics; 404 when ERC unknown."
	)
	...
	@GraphQLField(
		description = "Creates or updates a CommercePriceList via upsert-by-ERC. Calls CommercePriceListService.addOrUpdateCommercePriceList with the supplied DTO and cascades the nested priceEntries and priceListAccountGroups collections. Validation -- PriceListDisplayDateException, PriceListExpirationDateException, PriceListMinPriceValueException, PriceListMaxPriceValueException, and RequiredBasePriceListException -> 400 Bad Request."
	)
	...
	@GraphQLField(
		description = "Creates or replaces a CommercePriceList addressed by externalReferenceCode. Same upsert pipeline as postPriceList -- delegates to CommercePriceListService.addOrUpdateCommercePriceList."
	)
	...
	@GraphQLField(
		description = "Deletes a single CommercePriceListCommerceAccountGroupRel by internal ID. Calls CommercePriceListCommerceAccountGroupRelService.deleteCommercePriceListCommerceAccountGroupRel."
	)
	...
	@GraphQLField(
		description = "Attaches an AccountGroup to a CommercePriceList addressed by externalReferenceCode. Same create pipeline as postPriceListIdPriceListAccountGroup with ERC-based price-list resolution."
	)
	...
	@GraphQLField(
		description = "Attaches an AccountGroup to a CommercePriceList addressed by internal ID. Calls CommercePriceListCommerceAccountGroupRelService.addCommercePriceListCommerceAccountGroupRel; the `order` integer in the request body sets the resolution priority. Validation -- DuplicatePriceListAccountGroupRelException -> 409 Conflict when the (priceList, accountGroup) pair already exists."
	)
	...
	@GraphQLField(
		description = "Deletes a CommerceTierPriceEntry by internal ID. Calls CommerceTierPriceEntryService.deleteCommerceTierPriceEntry."
	)
	...
	@GraphQLField(
		description = "Deletes a CommerceTierPriceEntry addressed by externalReferenceCode. Same delete pipeline; 404 when ERC unknown."
	)
	...
	@GraphQLField(
		description = "Partially updates a CommerceTierPriceEntry by internal ID. JSON Merge Patch over price, promoPrice, and minimumQuantity via CommerceTierPriceEntryService.updateCommerceTierPriceEntry."
	)
	...
	@GraphQLField(
		description = "Partially updates a CommerceTierPriceEntry addressed by externalReferenceCode. JSON Merge Patch semantics; 404 when ERC unknown."
	)
	...
	@GraphQLField(
		description = "Creates a CommerceTierPriceEntry under the parent CommercePriceEntry by externalReferenceCode. Same create pipeline as postPriceEntryIdTierPrice with ERC-based parent resolution."
	)
	...
	@GraphQLField(
		description = "Creates a CommerceTierPriceEntry under the parent CommercePriceEntry by internal ID. Calls TierPriceUtil.addOrUpdateCommerceTierPriceEntry -> CommerceTierPriceEntryService; the request body's minimumQuantity maps to the backend minQuantity BigDecimal. Validation -- DuplicateCommerceTierPriceEntryException -> 409 Conflict when the (priceEntry, minimumQuantity) pair already exists; TierPriceMinimumQuantityException -> 400 Bad Request."
	)
...
// LIFERAY-REST-BUILDER-HASH:909565583