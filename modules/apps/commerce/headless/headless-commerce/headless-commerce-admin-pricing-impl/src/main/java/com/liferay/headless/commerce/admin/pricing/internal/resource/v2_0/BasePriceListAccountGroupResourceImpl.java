...
public abstract class BasePriceListAccountGroupResourceImpl
	...
	@jakarta.ws.rs.Path("/price-list-account-groups/{priceListAccountGroupId}")
	...
	@jakarta.ws.rs.DELETE
	@jakarta.ws.rs.Path("/price-list-account-groups/batch")
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/price-lists/{id}/price-list-account-groups")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@io.swagger.v3.oas.annotations.tags.Tags(value = {})
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path("/price-lists/price-list-account-groups/batch")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
...
// LIFERAY-REST-BUILDER-HASH:1608729614