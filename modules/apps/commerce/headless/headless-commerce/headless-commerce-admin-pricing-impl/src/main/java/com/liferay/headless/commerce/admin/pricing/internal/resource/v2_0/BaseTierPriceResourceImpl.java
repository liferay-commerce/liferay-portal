...
public abstract class BaseTierPriceResourceImpl
	...
	@jakarta.ws.rs.Path("/tier-prices/{id}")
	...
	@jakarta.ws.rs.DELETE
	@jakarta.ws.rs.Path("/tier-prices/batch")
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/price-entries/{priceEntryId}/tier-prices")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path("/price-entries/{priceEntryId}/tier-prices/batch")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
...
// LIFERAY-REST-BUILDER-HASH:-1047550568