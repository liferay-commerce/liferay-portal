...
public abstract class BaseDiscountAccountGroupResourceImpl
	...
	@jakarta.ws.rs.Path("/discount-account-groups/{discountAccountGroupId}")
	...
	@jakarta.ws.rs.DELETE
	@jakarta.ws.rs.Path("/discount-account-groups/batch")
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/discounts/{id}/discount-account-groups")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path("/discounts/discount-account-groups/batch")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
...
// LIFERAY-REST-BUILDER-HASH:1840220048