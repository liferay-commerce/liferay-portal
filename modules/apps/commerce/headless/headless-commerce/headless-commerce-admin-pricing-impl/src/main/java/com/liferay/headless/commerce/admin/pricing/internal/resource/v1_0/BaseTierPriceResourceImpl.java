...
public abstract class BaseTierPriceResourceImpl
	...
	@jakarta.ws.rs.Path("/tierPrices/{id}")
	...
	@jakarta.ws.rs.DELETE
	@jakarta.ws.rs.Path("/tierPrices/batch")
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/priceEntries/{id}/tierPrices")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path("/priceEntries/tierPrices/batch")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
...
// LIFERAY-REST-BUILDER-HASH:-1396028755