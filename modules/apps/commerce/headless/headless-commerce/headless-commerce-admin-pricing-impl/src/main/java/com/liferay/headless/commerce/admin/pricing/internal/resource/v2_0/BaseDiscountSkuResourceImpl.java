...
public abstract class BaseDiscountSkuResourceImpl
	...
	@jakarta.ws.rs.Path("/discount-skus/{discountSkuId}")
	...
	@jakarta.ws.rs.DELETE
	@jakarta.ws.rs.Path("/discount-skus/batch")
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/discounts/{id}/discount-skus")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path("/discounts/discount-skus/batch")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
...
// LIFERAY-REST-BUILDER-HASH:-1904634319