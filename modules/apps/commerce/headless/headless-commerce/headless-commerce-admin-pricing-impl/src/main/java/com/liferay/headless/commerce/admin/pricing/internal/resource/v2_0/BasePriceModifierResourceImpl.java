...
public abstract class BasePriceModifierResourceImpl
	...
	@jakarta.ws.rs.Path("/price-modifiers/{id}")
	...
	@jakarta.ws.rs.DELETE
	@jakarta.ws.rs.Path("/price-modifiers/batch")
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/price-lists/{id}/price-modifiers")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path("/price-lists/price-modifiers/batch")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
	...
	public void delete(
		...
		UnsafeFunction<PriceModifier, PriceModifier, Exception>
			priceModifierUnsafeFunction = priceModifier -> {
				...
				else if (priceModifier.getExternalReferenceCode() != null) {
					deletePriceModifierByExternalReferenceCode(
						priceModifier.getExternalReferenceCode());
...
// LIFERAY-REST-BUILDER-HASH:1189415696