...
public abstract class BaseAccountAddressChannelResourceTestCase {
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		accountAddressChannel.setChannelExternalReferenceCode(regex);
		...
		Assert.assertEquals(
			regex, accountAddressChannel.getChannelExternalReferenceCode());
	}
	...
	protected void assertValid(AccountAddressChannel accountAddressChannel)
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals(
				...
				if (accountAddressChannel.getChannelExternalReferenceCode() ==
						null) {
	...
	protected boolean equals(
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("channelId", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						accountAddressChannel1.getChannelId(),
						accountAddressChannel2.getChannelId())) {
