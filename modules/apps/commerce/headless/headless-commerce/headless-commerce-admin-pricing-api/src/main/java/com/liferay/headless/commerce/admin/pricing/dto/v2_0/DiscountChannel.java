...
@Generated("")
@GraphQLName(
	description = "Channel binding that restricts a discount's eligibility to a specific CommerceChannel. Backed by CommerceChannelRel with the CommerceDiscount class name.",
...
public class DiscountChannel implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "String value of `channelExternalReferenceCode`.",
...
// LIFERAY-REST-BUILDER-HASH:191370192