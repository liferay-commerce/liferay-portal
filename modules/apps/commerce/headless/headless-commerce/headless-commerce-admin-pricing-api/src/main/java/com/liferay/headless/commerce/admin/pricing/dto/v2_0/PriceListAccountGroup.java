...
@Generated("")
@GraphQLName(
	description = "Account-group binding that restricts a price list's eligibility to a specific AccountGroup, with an `order` integer that controls the resolution priority. Backed by CommercePriceListCommerceAccountGroupRel.",
...
// LIFERAY-REST-BUILDER-HASH:1728188136