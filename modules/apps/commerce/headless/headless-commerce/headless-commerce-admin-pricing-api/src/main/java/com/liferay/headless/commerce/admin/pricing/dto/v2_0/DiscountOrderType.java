...
@Generated("")
@GraphQLName(
	description = "CommerceOrderType binding that restricts a discount's eligibility to a specific order type. Backed by CommerceDiscountCommerceOrderTypeRel.",
...
public class DiscountOrderType implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "String value of `orderTypeExternalReferenceCode`.",
...
// LIFERAY-REST-BUILDER-HASH:-1572375684