...
@Generated("")
@GraphQLName(
	description = "Read-only projection of a CommerceChannel referenced by a discount or price-list channel binding. Carries the channel id, name, ERC, type, default currencyCode, and the underlying siteGroupId.",
	value = "Channel"
)
