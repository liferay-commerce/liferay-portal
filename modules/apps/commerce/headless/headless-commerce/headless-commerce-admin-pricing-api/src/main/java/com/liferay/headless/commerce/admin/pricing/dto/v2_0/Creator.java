...
@Generated("")
@GraphQLName(
	description = "User account that created the entity. Properties follow the [creator](https://schema.org/creator) specification; the batch engine uses `externalReferenceCode` and `id` to keep the original creator on import.",
	value = "Creator"
)
...
public class Creator implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.commerce.admin.pricing.dto.v2_0.Creator",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-2053718631