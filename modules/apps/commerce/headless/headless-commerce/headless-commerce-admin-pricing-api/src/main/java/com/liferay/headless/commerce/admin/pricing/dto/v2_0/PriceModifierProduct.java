...
@Generated("")
@GraphQLName(
	description = "CPDefinition binding that restricts a price modifier to a specific product. Backed by CommercePriceModifierRel with the CPDefinition class name.",
...
public class PriceModifierProduct implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "String value of `productExternalReferenceCode`.",
...
// LIFERAY-REST-BUILDER-HASH:1778826900