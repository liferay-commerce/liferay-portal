...
@Generated("")
@GraphQLName(
	description = "AssetCategory binding that restricts a discount to products tagged with a specific category. Backed by CommerceDiscountRel with the AssetCategory class name.",
...
// LIFERAY-REST-BUILDER-HASH:-1125691844