...
@Generated("")
@GraphQLName(
	description = "Read-only projection of a CommerceAccountGroup referenced by a discount or price-list account-group binding. Carries the account-group id and display name.",
...
// LIFERAY-REST-BUILDER-HASH:-341272509