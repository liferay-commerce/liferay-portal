...
@Generated("")
@GraphQLName(
	description = "Read-only projection of a CommerceAccount referenced by a discount or price-list account binding. Carries the account id, optional logo id, and display name; the full record lives in headless-commerce-admin-account.",
	value = "Account"
)
...
// LIFERAY-REST-BUILDER-HASH:-1476296908