...
@Generated("")
@GraphQLName(
	description = "CommerceProductGroup binding that restricts a price modifier to products inside a product group. Backed by CommercePriceModifierRel with the CommercePricingClass class name.",
...
public class PriceModifierProductGroup implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "String value of `productGroupExternalReferenceCode`.",
...
// LIFERAY-REST-BUILDER-HASH:481194902