...
@Generated("")
@GraphQLName(
	description = "Quantity-break override on a price entry. Binds a minimumQuantity threshold to an override price; the runtime resolves the highest-quantity tier whose minimumQuantity is at most the cart line quantity. Backed by CommerceTierPriceEntry.",
	value = "TierPrice"
)
