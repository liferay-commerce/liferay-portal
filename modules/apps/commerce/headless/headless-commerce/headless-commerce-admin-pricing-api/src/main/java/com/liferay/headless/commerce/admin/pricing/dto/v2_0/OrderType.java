...
@Generated("")
@GraphQLName(
	description = "Read-only projection of a CommerceOrderType referenced by a discount or price-list order-type binding. Carries the order type id, name, and display order.",
	value = "OrderType"
)
...
// LIFERAY-REST-BUILDER-HASH:320623483