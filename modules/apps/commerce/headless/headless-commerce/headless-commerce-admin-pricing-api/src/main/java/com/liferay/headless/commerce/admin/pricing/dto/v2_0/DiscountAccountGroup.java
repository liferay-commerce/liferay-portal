...
@Generated("")
@GraphQLName(
	description = "Account-group binding that restricts a discount's eligibility to a specific AccountGroup. Backed by CommerceDiscountCommerceAccountGroupRel.",
