...
@Generated("")
@GraphQLName(
	description = "Add-on price calculation layered on a price list. Carries a target (categories, products, or product-groups), a modifierAmount or modifierPercentage, a modifierType (absolute or percentage), a limitationType, and a priority. Backed by CommercePriceModifier.",
	value = "PriceModifier"
)
