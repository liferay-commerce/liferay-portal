...
@Generated("")
@GraphQLName(
	description = "Account binding that restricts a price list's eligibility to a specific Account. Backed by CommercePriceListAccountRel.",
...
public class PriceListAccount implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "String value of `accountExternalReferenceCode`.",
...
// LIFERAY-REST-BUILDER-HASH:-1462451866