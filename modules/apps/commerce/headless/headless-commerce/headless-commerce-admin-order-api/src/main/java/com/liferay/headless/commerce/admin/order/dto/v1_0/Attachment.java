...
public class Attachment implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Fully qualified download URL for the file. Read-only; addresses the attachment content endpoint of this API, so it is reachable with the same authentication as every other operation.",
		example = "https://example.com/o/headless-commerce-admin-order/v1.0/orders/30130/attachments/30131/content"
	)
...
// LIFERAY-REST-BUILDER-HASH:-1938319409