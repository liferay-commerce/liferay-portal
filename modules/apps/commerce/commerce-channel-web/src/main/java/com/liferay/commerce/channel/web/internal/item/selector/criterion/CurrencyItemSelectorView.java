...
import com.liferay.commerce.channel.web.internal.search.CurrencyItemSelectorChecker;
...
public class CurrencyItemSelectorView
	implements InfoItemSelectorView,
			   ItemSelectorView<CurrencyItemSelectorCriterion> {
	...
	@Override
	public Class<CurrencyItemSelectorCriterion>
		getItemSelectorCriterionClass() {

		return CurrencyItemSelectorCriterion.class;
	}
	...
	public void renderHTML(
			...
			CurrencyItemSelectorCriterion currencyItemSelectorCriterion,
			PortletURL portletURL, String itemSelectedEventName, boolean search)
		throws IOException, ServletException {

		_itemSelectorViewDescriptorRenderer.renderHTML(
			servletRequest, servletResponse, currencyItemSelectorCriterion,
	...
	@Reference
	private ItemSelectorViewDescriptorRenderer<CurrencyItemSelectorCriterion>
	...
	private class CommerceCurrencyItemSelectorViewDescriptor
		...
		public SearchContainer<CommerceCurrency> getSearchContainer()
			...
			entriesSearchContainer.setRowChecker(
				new CurrencyItemSelectorChecker(
					_renderResponse,
