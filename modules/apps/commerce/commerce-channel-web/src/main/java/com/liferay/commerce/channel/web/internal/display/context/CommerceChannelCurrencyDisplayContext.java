...
import com.liferay.commerce.channel.web.internal.item.selector.criterion.CurrencyItemSelectorCriterion;
 ...
 * @author Fabio Monaco
 */
public class CommerceChannelCurrencyDisplayContext {

	public CommerceChannelCurrencyDisplayContext(
		...
		return HashMapBuilder.<String, Object>put(
			...
			() -> {
				...
				ItemSelectorCriterion itemSelectorCriterion =
					new CurrencyItemSelectorCriterion();
				...
				return PortletURLBuilder.create(
					...
					StringUtil.merge(_getCheckedCurrencyIds(commerceChannelId))
				).setParameter(
	...
	private long[] _getCheckedCurrencyIds(long commerceChannelId)
		throws PortalException {

		return TransformUtil.transformToLongArray(
			_commerceChannelRelService.getCommerceChannelCurrencies(
