...
public class CommerceChannelCurrencyFDSActionProvider
	...
	public List<DropdownItem> getDropdownItems(
		...
		return DropdownItemListBuilder.add(
			() -> _commerceChannelModelResourcePermission.contains(
				...
				channelCurrency.getChannelId(), ActionKeys.UPDATE),
			dropdownItem -> {
				dropdownItem.setHref(
					_getCommerceChannelCurrencyDeleteURL(
						channelCurrency.getChannelRelId(), httpServletRequest));
	...
	private PortletURL _getCommerceChannelCurrencyDeleteURL(
		...
		return PortletURLBuilder.create(
			...
			"/commerce_channels/edit_commerce_channel_currency"
		).setCMD(
			Constants.DELETE
		).setRedirect(
			ParamUtil.getString(
