		...
		<div class="form-group-item">
			...
			<div class="btn-group button-holder">
				<liferay-ui:icon
					...
					message='<%= (Validator.isNull(commerceAccountEntryDisplay.getDefaultCommercePaymentMethodKey()) || (commercePaymentMethodRegistry.getCommercePaymentMethod(commerceAccountEntryDisplay.getDefaultCommercePaymentMethodKey()) == null)) ? "set-default-payment-method" : "change" %>'
					method="get"
					url="javascript:;"
				/>
