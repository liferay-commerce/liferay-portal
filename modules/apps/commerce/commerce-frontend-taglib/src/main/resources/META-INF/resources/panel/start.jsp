...
=======
<div class="<%= HtmlUtil.escapeAttribute(cardCssClasses) %>">
...
=======
	<div class="collapse<%= collapsed ? StringPool.BLANK : StringPool.SPACE + "show" %>" id="<%= HtmlUtil.escapeAttribute(randomNamespace) %>collapse">
		<div class="<%= HtmlUtil.escapeAttribute(bodyCssClasses) %>">
>>>>>>> COMMERCE-5017 Improve output handling
